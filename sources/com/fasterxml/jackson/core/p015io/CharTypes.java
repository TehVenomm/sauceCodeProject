...
public final class CharTypes {
    ...
    /* renamed from: HB */
    private static final byte[] f406HB;

    /* renamed from: HC */
    private static final char[] f407HC = "0123456789ABCDEF".toCharArray();
    ...
    static {
        int length = f407HC.length;
        f406HB = new byte[length];
        for (int i = 0; i < length; i++) {
            f406HB[i] = (byte) f407HC[i];
        }
        ...
        for (int i3 = 128; i3 < 256; i3++) {
            int i4 = (i3 & 224) == 192 ? 2 : (i3 & DisplaySupport.SCREEN_DENSITY_HIGH) == 224 ? 3 : (i3 & 248) == 240 ? 4 : -1;
            iArr2[i3] = i4;
        }
        ...
        for (int i = 0; i < length2; i++) {
            ...
            if (charAt >= length || iArr[charAt] == 0) {
                ...
                if (i2 < 0) {
                    ...
                    sb.append('0');
                    sb.append('0');
                    sb.append(f407HC[charAt >> 4]);
                    sb.append(f407HC[charAt & 15]);
                } else {
                    sb.append((char) i2);
                }
            }
    ...
    public static char[] copyHexChars() {
        return (char[]) f407HC.clone();
    }

    public static byte[] copyHexBytes() {
        return (byte[]) f406HB.clone();
    }
}
