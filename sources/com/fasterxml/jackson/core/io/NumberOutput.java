...
public final class NumberOutput {
    ...
    private static final String[] sSmallIntStrs = new String[]{AppEventsConstants.EVENT_PARAM_VALUE_NO, AppEventsConstants.EVENT_PARAM_VALUE_YES, "2", "3", "4", "5", "6", "7", "8", "9", SamsungAppsBillingService.ITEM_TYPE_ALL};
    ...
    static {
        ...
        for (int i5 = 0; i5 < GamesStatusCodes.STATUS_SNAPSHOT_NOT_FOUND; i5++) {
