...
public class UTF8StreamJsonParser extends ParserBase {
    ...
    private final JsonToken _parseNumber2(char[] cArr, int i, boolean z, int i2) throws IOException {
        ...
        if (i5 == 46 || i5 == Quests.SELECT_COMPLETED_UNCLAIMED || i5 == 69) {
        ...
        while (i6 < i4) {
            ...
            if (i8 > TransportMediator.KEYCODE_MEDIA_PAUSE) {
                ...
                if ((i8 & 224) == 192) {
                    i8 &= 31;
                    i9 = 1;
                } else if ((i8 & DisplaySupport.SCREEN_DENSITY_HIGH) == 224) {
                    i8 &= 15;
                    i9 = 2;
                } else if ((i8 & 248) == DisplaySupport.SCREEN_DENSITY_HIGH) {
                    i8 &= 7;
                    i9 = 3;
                } else {
    ...
    protected int _decodeCharForError(int i) throws IOException {
        ...
        if ((i2 & 224) == 192) {
            ...
            i3 = i2 & 15;
            i2 = 2;
        } else if ((i2 & 248) == DisplaySupport.SCREEN_DENSITY_HIGH) {
            i3 = i2 & 7;
            obj = 3;
        } else {
