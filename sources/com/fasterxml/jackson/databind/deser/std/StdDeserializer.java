        ...
        if (currentToken == JsonToken.VALUE_STRING) {
            ...
            try {
                ...
                if (length > 9) {
                    ...
                    throw deserializationContext.weirdStringException(trim, this._valueClass, "Overflow: numeric value (" + trim + ") out of range of int (" + Integer.MIN_VALUE + " - " + Strategy.TTL_SECONDS_INFINITE + ")");
                } else if (length != 0) {
            ...
            case 6:
                ...
                try {
                    ...
                    if (length > 9) {
                        ...
                        throw deserializationContext.weirdStringException(trim, this._valueClass, "Overflow: numeric value (" + trim + ") out of range of Integer (" + Integer.MIN_VALUE + " - " + Strategy.TTL_SECONDS_INFINITE + ")");
                    } else if (length == 0) {
