...
public abstract class DeserializationContext extends DatabindContext implements Serializable {
    ...
    public JsonMappingException reportMappingException(String str, Object... objArr) throws JsonMappingException {
        if (objArr.length > 0) {
    ...
    public <T> T reportWeirdNumberException(Number number, Class<?> cls, String str, Object... objArr) throws JsonMappingException {
        if (objArr.length > 0) {
            str = String.format(str, objArr);
        }
    ...
    public <T> T reportWeirdKeyException(Class<?> cls, String str, String str2, Object... objArr) throws JsonMappingException {
        if (objArr.length > 0) {
            str2 = String.format(str2, objArr);
        }
    ...
    public <T> T reportWrongTokenException(JsonParser jsonParser, JsonToken jsonToken, String str, Object... objArr) throws JsonMappingException {
        if (objArr.length > 0) {
            str = String.format(str, objArr);
        }
    ...
    public <T> T reportUnknownTypeException(JavaType javaType, String str, String str2) throws JsonMappingException {
        throw unknownTypeException(javaType, str, str2);
    }

    public <T> T reportEndOfInputException(Class<?> cls) throws JsonMappingException {
