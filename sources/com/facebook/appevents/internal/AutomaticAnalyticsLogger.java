...
public class AutomaticAnalyticsLogger {
    ...
    private static PurchaseLoggingParameters getPurchaseLoggingParameters(String str, String str2) {
        try {
            ...
            bundle.putCharSequence(Constants.IAP_PRODUCT_ID, jSONObject.getString(AmazonAppstoreBillingService.JSON_KEY_PRODUCT_ID));
            bundle.putCharSequence(Constants.IAP_PURCHASE_TIME, jSONObject.getString("purchaseTime"));
            bundle.putCharSequence(Constants.IAP_PURCHASE_TOKEN, jSONObject.getString(AmazonAppstoreBillingService.JSON_KEY_RECEIPT_PURCHASE_TOKEN));
