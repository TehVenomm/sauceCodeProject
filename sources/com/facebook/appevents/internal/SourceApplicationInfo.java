...
class SourceApplicationInfo {
    ...
    public static SourceApplicationInfo getStoredSourceApplicatioInfo() {
        ...
        return !defaultSharedPreferences.contains(CALL_APPLICATION_PACKAGE_KEY) ? null : new SourceApplicationInfo(defaultSharedPreferences.getString(CALL_APPLICATION_PACKAGE_KEY, null), defaultSharedPreferences.getBoolean(OPENED_BY_APP_LINK_KEY, false));
    }
