...
public class ActivityLifecycleTracker {
    ...
    static final class C03821 implements ActivityLifecycleCallbacks {
        C03821() {
        }
    ...
    private static void onActivityPaused(Activity activity) {
        ...
        singleThreadExecutor.execute(new Runnable() {
            ...
            public void run() {
                ...
                if (ActivityLifecycleTracker.foregroundActivityCount.get() <= 0) {
                    ActivityLifecycleTracker.currentFuture = ActivityLifecycleTracker.singleThreadExecutor.schedule(new C03851(), (long) ActivityLifecycleTracker.getSessionTimeoutInSeconds(), TimeUnit.SECONDS);
                }
    ...
    public static void startTracking(Application application, String str) {
        if (tracking.compareAndSet(false, true)) {
            appId = str;
            application.registerActivityLifecycleCallbacks(new C03821());
        }
    }
}
