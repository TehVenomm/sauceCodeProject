            ...
            FacebookSdk.getExecutor().execute(new Runnable() {
                public void run() {
                    ...
                    if (newPostRequest != null) {
                        ...
                        ActivityLifecycleTracker.isAppIndexingEnabled = Boolean.valueOf(jSONObject != null && jSONObject.optBoolean(Constants.APP_INDEXING_ENABLED, false));
        ...
        singleThreadExecutor.execute(new Runnable() {
            public void run() {
                ...
                if (ActivityLifecycleTracker.foregroundActivityCount.get() <= 0) {
                    ...
                    synchronized (ActivityLifecycleTracker.currentFutureLock) {
                        ActivityLifecycleTracker.currentFuture = ActivityLifecycleTracker.singleThreadExecutor.schedule(r2, (long) ActivityLifecycleTracker.getSessionTimeoutInSeconds(), TimeUnit.SECONDS);
                    }
                }
