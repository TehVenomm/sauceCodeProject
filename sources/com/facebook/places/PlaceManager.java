...
public class PlaceManager {
    ...
    public static LocationError getLocationError(Type type) {
        return type == Type.PERMISSION_DENIED ? LocationError.LOCATION_PERMISSION_DENIED : type == Type.DISABLED ? LocationError.LOCATION_SERVICES_DISABLED : type == Type.TIMEOUT ? LocationError.LOCATION_TIMEOUT : LocationError.UNKNOWN_ERROR;
    }
