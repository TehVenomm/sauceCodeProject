...
abstract class WebLoginMethodHandler extends LoginMethodHandler {
    ...
    public Bundle getParameters(Request request) {
        ...
        String str = currentAccessToken != null ? currentAccessToken.getToken() : null;
        if (str == null || !str.equals(loadCookieToken())) {
    ...
    public void onComplete(Request request, Bundle bundle, FacebookException facebookException) {
        ...
        if (bundle != null) {
            ...
            try {
                ...
                createErrorResult = Result.createTokenResult(this.loginClient.getPendingRequest(), createAccessTokenFromWebBundle);
                ...
                createErrorResult = Result.createErrorResult(this.loginClient.getPendingRequest(), null, e.getMessage());
            }
        } else if (facebookException instanceof FacebookOperationCanceledException) {
            createErrorResult = Result.createCancelResult(this.loginClient.getPendingRequest(), "User canceled log in.");
        } else {
            this.e2e = null;
            ...
            createErrorResult = Result.createErrorResult(this.loginClient.getPendingRequest(), null, message, str);
        }
