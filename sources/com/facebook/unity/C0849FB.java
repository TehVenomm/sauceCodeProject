...
public class C0849FB {
    ...
    public static void AppInvite(String str) {
        ...
        Intent intent2 = new Intent(getUnityActivity(), AppInviteDialogActivity.class);
        intent2.putExtra(AppInviteDialogActivity.DIALOG_PARAMS, UnityParams.parse(str).getStringParams());
    ...
    public static void FetchDeferredAppLinkData(String str) {
        ...
        AppLinkData.fetchDeferredAppLinkData(getUnityActivity(), new CompletionHandler() {
            public void onDeferredAppLinkDataFetched(AppLinkData appLinkData) {
                C0849FB.addAppLinkToMessage(unityMessage, appLinkData);
                unityMessage.send();
            }
        });
    }
    ...
    public static void Init(String str) {
        ...
        final String metadataApplicationId = parse.hasString("appId").booleanValue() ? parse.getString("appId") : Utility.getMetadataApplicationId(getUnityActivity());
        ...
        FacebookSdk.sdkInitialize((Context) getUnityActivity(), (InitializeCallback) new InitializeCallback() {
            public void onInitialized() {
                ...
                if (FacebookSdk.getAutoLogAppEventsEnabled()) {
                    C0849FB.ActivateApp(metadataApplicationId);
                }
                unityMessage.send();
            }
        });
