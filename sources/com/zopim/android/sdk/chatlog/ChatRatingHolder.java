...
final class ChatRatingHolder extends ViewHolder {
    ...
    /* renamed from: a */
    OnClickListener f719a = new C0847o(this);
    /* renamed from: b */
    OnClickListener f720b = new C0848p(this);
    /* renamed from: c */
    OnClickListener f721c = new C0849q(this);
    /* renamed from: d */
    OnClickListener f722d = new C0850r(this);
    /* renamed from: f */
    ...
    public ChatRatingHolder(View view, Listener listener) {
        super(view);
        this.f723f = (RadioGroup) view.findViewById(C0784R.id.rating_button_group);
        this.f724g = (RadioButton) view.findViewById(C0784R.id.positive_button);
        this.f725h = (RadioButton) view.findViewById(C0784R.id.negative_button);
        this.f726i = view.findViewById(C0784R.id.add_comment_button);
        this.f727j = view.findViewById(C0784R.id.edit_comment_button);
        this.f729l = (TextView) view.findViewById(C0784R.id.comment_message);
    ...
    /* renamed from: a */
    public void m661a(C0852t c0852t) {
        boolean z = true;
        if (c0852t == null) {
        ...
        this.f730m = c0852t;
        switch (C0851s.f830a[c0852t.f831a.ordinal()]) {
            case 1:
        ...
        if (c0852t.f832b == null || c0852t.f832b.isEmpty()) {
            z = false;
        }
        if (z) {
            ...
            this.f729l.setText(c0852t.f832b);
            return;
        }
