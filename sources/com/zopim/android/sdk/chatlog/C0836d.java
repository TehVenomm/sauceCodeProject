...
class C0836d implements OnClickListener {
    /* renamed from: a */
    final /* synthetic */ AgentMessageHolder f804a;

    C0836d(AgentMessageHolder agentMessageHolder) {
    ...
    public void onClick(View view) {
        try {
            ...
            Toast.makeText(this.f804a.itemView.getContext(), C0784R.string.attachment_open_error_message, 0).show();
        }
    }
}
