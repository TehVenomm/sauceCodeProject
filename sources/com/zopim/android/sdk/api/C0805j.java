...
final class C0805j implements HttpRequest {
    /* renamed from: b */
    private static final String f638b = C0805j.class.getSimpleName();
    /* renamed from: c */
    private C0799u<File> f639c;
    ...
    private void m586b(java.net.URL r10, java.io.File r11) {
        ...
        r4 = com.zopim.android.sdk.api.C0806k.f640a;	 Catch:{ Exception -> 0x01ac, all -> 0x020b }
    ...
    L_0x0118:
        r4 = r9.f639c;	 Catch:{ all -> 0x021c }
        r4.mo4228a(r0);	 Catch:{ all -> 0x021c }
    L_0x011d:
    ...
    L_0x0176:
        r1 = r9.f639c;	 Catch:{ Exception -> 0x00d7, all -> 0x0216 }
        r1.mo4229a(r11);	 Catch:{ Exception -> 0x00d7, all -> 0x0216 }
        r2 = r3;
        goto L_0x003e;
    L_0x017e:
    ...
    L_0x01a5:
        r3 = r9.f639c;	 Catch:{ Exception -> 0x01ac, all -> 0x020b }
        r3.mo4228a(r1);	 Catch:{ Exception -> 0x01ac, all -> 0x020b }
        goto L_0x003d;
    L_0x01ac:
        r1 = move-exception;
        r3 = r2;
    ...
    /* renamed from: a */
    public void m587a(C0799u<File> c0799u) {
        this.f639c = c0799u;
    }
