...
final class C0821x extends C0797a {
    /* renamed from: b */
    private static final String f675b = C0821x.class.getSimpleName();
    /* renamed from: c */
    ...
    class C0820a implements Runnable {
        /* renamed from: a */
        final /* synthetic */ C0821x f673a;
        /* renamed from: b */
        private final WebView f674b;

        C0820a(C0821x c0821x, WebView webView) {
            this.f673a = c0821x;
            this.f674b = webView;
        }
    ...
    private synchronized void m630a(String str) {
        this.f677a.post(new C0822y(this, str));
    }
    ...
    /* renamed from: a */
    void mo4232a(String str, String str2, String str3, String str4) {
        if (str2 != null) {
    ...
    public void endChat() {
        ...
        this.f677a.postDelayed(new C0820a(this, this.f678d), f676c);
        this.f677a.post(new C0823z(this));
    }
