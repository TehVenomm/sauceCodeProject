...
import com.zopim.android.sdk.api.C0808l.C0807a;
...
final class C0815s implements HttpRequest {
    /* renamed from: b */
    private static final String f666b = C0815s.class.getSimpleName();
    /* renamed from: d */
    private static final String f667d = Long.toHexString(System.currentTimeMillis());
    /* renamed from: c */
    private String f668c = HttpRequest.METHOD_POST;
    /* renamed from: e */
    private C0799u<Void> f669e;
    /* renamed from: f */
        ...
        try {
                ...
                try {
                    ...
                    try {
                        ...
                        try {
                            ...
                            a = new C0807a().m596a(Kind.UNEXPECTED).m597a(th2.getMessage()).m599b(url.toExternalForm()).m598a();
                            if (this.f669e != null) {
                                this.f669e.m576b(a);
                            }
            ...
            try {
                ...
                switch (C0816t.f671a[Status.getStatus(min).ordinal()]) {
                    ...
                    case 3:
                    case 4:
                        ErrorResponse a2 = new C0807a().m596a(Kind.HTTP).m595a(min).m599b(url.toExternalForm()).m600c(httpsURLConnection3.getResponseMessage()).m598a();
                        if (this.f669e != null) {
                            this.f669e.m576b(a2);
                            break;
                        }
    ...
    /* renamed from: a */
    public void m625a(C0799u<Void> c0799u) {
        this.f669e = c0799u;
    }
