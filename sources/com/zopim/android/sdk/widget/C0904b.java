...
class C0904b implements Runnable {
    /* renamed from: a */
    ...
    C0904b(ChatWidgetService chatWidgetService, int i, int i2) {
    ...
    public void run() {
        if (ViewCompat.isAttachedToWindow(this.f932c.mWidgetView)) {
            switch (C0910h.f940a[this.f932c.mWidgetView.getAnchor().ordinal()]) {
                case 1:
            ...
            this.f932c.mWidgetAnimatorTask = new C0901a(this.f932c, this.f932c.mHorizontalMargin, this.f932c.mVerticalMargin);
