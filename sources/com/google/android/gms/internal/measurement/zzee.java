...
public abstract class zzee extends zzdm {
            ...
            if (!zzee.zzaec || zzdi.zzrv() || zztg() < 5) {
                while ((i & -128) != 0) {
                    try {
                        ...
                        this.position = i2 + 1;
                        bArr[i2] = (byte) ((byte) ((i & Notifications.NOTIFICATION_TYPES_ALL) | 128));
                        i >>>= 7;
                    } catch (IndexOutOfBoundsException e) {
            ...
            if (!zzee.zzaec || zztg() < 10) {
                while ((j & -128) != 0) {
                    try {
                        ...
                        int i = this.position;
                        this.position = i + 1;
                        bArr[i] = (byte) ((byte) ((((int) j) & Notifications.NOTIFICATION_TYPES_ALL) | 128));
                        j >>>= 7;
                    } catch (IndexOutOfBoundsException e) {
                        throw new zzb(String.format("Pos: %d, limit: %d, len: %d", new Object[]{Integer.valueOf(this.position), Integer.valueOf(this.limit), Integer.valueOf(1)}), e);
                    }
    ...
    static final class zzd extends zzee {
        ...
        public final void write(byte[] bArr, int i, int i2) throws IOException {
            if (bArr != null && i >= 0 && i2 >= 0 && bArr.length - i2 >= i && this.zzael - ((long) i2) >= this.zzaen) {
                zzhv.zza(bArr, (long) i, this.zzaen, (long) i2);
                this.zzaen += (long) i2;
            } else if (bArr == null) {
        ...
        public final void zzbf(int i) throws IOException {
            ...
            while (this.zzaen < this.zzael) {
                ...
                long j4 = this.zzaen;
                this.zzaen = j4 + 1;
                zzhv.zza(j4, (byte) ((i & Notifications.NOTIFICATION_TYPES_ALL) | 128));
                i >>>= 7;
            }
            throw new zzb(String.format("Pos: %d, limit: %d, len: %d", new Object[]{Long.valueOf(this.zzaen), Long.valueOf(this.zzael), Integer.valueOf(1)}));
        }
        ...
        public final void zzbn(long j) throws IOException {
            ...
            while (this.zzaen < this.zzael) {
                ...
                long j5 = this.zzaen;
                this.zzaen = j5 + 1;
                zzhv.zza(j5, (byte) ((((int) j) & Notifications.NOTIFICATION_TYPES_ALL) | 128));
                j >>>= 7;
            }
            throw new zzb(String.format("Pos: %d, limit: %d, len: %d", new Object[]{Long.valueOf(this.zzaen), Long.valueOf(this.zzael), Integer.valueOf(1)}));
        }
        ...
        public final void zzdr(String str) throws IOException {
            ...
            try {
                ...
                if (zzbk2 == zzbk) {
                    ...
                    zzbf(position);
                    this.zzaen = ((long) position) + this.zzaen;
                    return;
                }
                ...
                zzbw(this.zzaen);
                zzhy.zza(str, this.zzaei);
                this.zzaen = ((long) zza) + this.zzaen;
            } catch (zzib e) {
                this.zzaen = j;
                zzbw(this.zzaen);
                zza(str, e);
    ...
    public static int zza(int i, zzfn zzfn) {
        int zzbi = zzbi(i);
        int zzuk = zzfn.zzuk();
        return zzbi + zzuk + zzbk(zzuk);
    }

    public static int zza(zzfn zzfn) {
        int zzuk = zzfn.zzuk();
        return zzuk + zzbk(zzuk);
    }
