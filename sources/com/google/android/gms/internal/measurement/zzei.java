...
final class zzei implements zzim {
    ...
    public static zzei zza(zzee zzee) {
        return zzee.zzaed != null ? zzee.zzaed : new zzei(zzee);
    }
    ...
    public final void zzb(int i, List<zzdp> list) throws IOException {
        ...
        while (true) {
            int i3 = i2;
            if (i3 < list.size()) {
                this.zzadn.zza(i, (zzdp) list.get(i3));
                i2 = i3 + 1;
            } else {
                return;
            }
    ...
    public final void zzb(int i, List<Integer> list, boolean z) throws IOException {
        ...
        if (z) {
            ...
            while (i4 < list.size()) {
                i4++;
                i3 = zzee.zzbm(((Integer) list.get(i4)).intValue()) + i3;
            }
            this.zzadn.zzbf(i3);
            while (i2 < list.size()) {
    ...
    public final void zzc(int i, List<Long> list, boolean z) throws IOException {
        ...
        if (z) {
            ...
            while (i4 < list.size()) {
                i4++;
                i3 = zzee.zzbq(((Long) list.get(i4)).longValue()) + i3;
            }
            this.zzadn.zzbf(i3);
            while (i2 < list.size()) {
    ...
    public final void zzh(int i, List<Integer> list, boolean z) throws IOException {
        ...
        if (z) {
            ...
            while (i4 < list.size()) {
                i4++;
                i3 = zzee.zzbo(((Integer) list.get(i4)).intValue()) + i3;
            }
            this.zzadn.zzbf(i3);
            while (i2 < list.size()) {
                this.zzadn.zzbe(((Integer) list.get(i2)).intValue());
    ...
    public final void zzj(int i, List<Integer> list, boolean z) throws IOException {
        ...
        if (z) {
            ...
            while (i4 < list.size()) {
                i4++;
                i3 = zzee.zzbk(((Integer) list.get(i4)).intValue()) + i3;
            }
            this.zzadn.zzbf(i3);
            while (i2 < list.size()) {
    ...
    public final void zzl(int i, List<Long> list, boolean z) throws IOException {
        ...
        if (z) {
            ...
            while (i4 < list.size()) {
                i4++;
                i3 = zzee.zzbu(((Long) list.get(i4)).longValue()) + i3;
            }
            this.zzadn.zzbf(i3);
            while (i2 < list.size()) {
                this.zzadn.zzbp(((Long) list.get(i2)).longValue());
    ...
    public final void zzn(int i, List<Long> list, boolean z) throws IOException {
        ...
        if (z) {
            ...
            while (i4 < list.size()) {
                i4++;
                i3 = zzee.zzbs(((Long) list.get(i4)).longValue()) + i3;
            }
            this.zzadn.zzbf(i3);
            while (i2 < list.size()) {
