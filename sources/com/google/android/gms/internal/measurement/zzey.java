...
public abstract class zzey<MessageType extends zzey<MessageType, BuilderType>, BuilderType extends zza<MessageType, BuilderType>> extends zzdf<MessageType, BuilderType> {
    ...
    public static class zza<MessageType extends zzey<MessageType, BuilderType>, BuilderType extends zza<MessageType, BuilderType>> extends zzdh<MessageType, BuilderType> {
        ...
        private final BuilderType zzb(byte[] bArr, int i, int i2, zzel zzel) throws zzfi {
            ...
            try {
                byte[] bArr2 = bArr;
                zzgt.zzvy().zzw(this.zzahx).zza(this.zzahx, bArr2, 0, i2 + 0, new zzdk(zzel));
                return this;
            } catch (zzfi e) {
                throw e;
    ...
    public static final class zzc<T extends zzey<T, ?>> extends zzdg<T> {
    ...
    public static final class zze<ContainingType extends zzgi, Type> extends zzek<ContainingType, Type> {
    }
