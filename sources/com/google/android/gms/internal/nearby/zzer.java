...
public final class zzer extends AbstractSafeParcelable {
    ...
    @Field(getter = "getEndpointId", mo13990id = 1)
    private String zzca;
    @Field(getter = "getEndpointName", mo13990id = 3)
    private String zzq;
    @Field(getter = "getServiceId", mo13990id = 2)
    private String zzu;
    @Nullable
    @Field(getter = "getBluetoothDevice", mo13990id = 4)
    ...
    @Constructor
    zzer(@Param(mo13993id = 1) String str, @Param(mo13993id = 2) String str2, @Param(mo13993id = 3) String str3, @Nullable @Param(mo13993id = 4) BluetoothDevice bluetoothDevice) {
        this.zzca = str;
        this.zzu = str2;
        this.zzq = str3;
