...
public final class zzev extends AbstractSafeParcelable {
    ...
    private String zzat;
    @Field(getter = "getPayload", mo13990id = 2)
    private zzfh zzdk;
    @Field(getter = "getIsReliable", mo13990id = 3)
    ...
    @Constructor
    zzev(@Param(mo13993id = 1) String str, @Param(mo13993id = 2) zzfh zzfh, @Param(mo13993id = 3) boolean z) {
        this.zzat = str;
        this.zzdk = zzfh;
        this.zzdl = z;
    }
