...
public final class zzeh extends AbstractSafeParcelable {
    ...
    @Field(getter = "getRemoteEndpointId", mo13990id = 1)
    private String zzat;
    @Nullable
    @Field(getter = "getHandshakeData", mo13990id = 5)
    private byte[] zzau;
    @Field(getter = "getRemoteEndpointName", mo13990id = 2)
    private String zzdj;
    @Field(getter = "getAuthenticationToken", mo13990id = 3)
    private String zzr;
    @Field(getter = "getIsIncomingConnection", mo13990id = 4)
    private boolean zzs;
    ...
    @Constructor
    zzeh(@Param(mo13993id = 1) String str, @Param(mo13993id = 2) String str2, @Param(mo13993id = 3) String str3, @Param(mo13993id = 4) boolean z, @Nullable @Param(mo13993id = 5) byte[] bArr) {
        this.zzat = str;
        this.zzdj = str2;
        this.zzr = str3;
        this.zzs = z;
