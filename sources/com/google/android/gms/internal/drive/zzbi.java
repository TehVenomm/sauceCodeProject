...
public final class zzbi implements DriveContents {
    ...
    private final PendingResult<Status> zza(GoogleApiClient googleApiClient, @Nullable MetadataChangeSet metadataChangeSet, @Nullable zzn zzn) {
        zzn zzn2 = zzn == null ? (zzn) new zzp().build() : zzn;
        if (this.zzeq.getMode() == 268435456) {
            throw new IllegalStateException("Cannot commit contents opened with MODE_READ_ONLY");
        } else if (!ExecutionOptions.zza(zzn2.zzm()) || this.zzeq.zza()) {
            zzn2.zza(googleApiClient);
            if (this.closed) {
                ...
                zzi();
                return googleApiClient.execute(new zzbk(this, googleApiClient, metadataChangeSet, zzn2));
            }
        } else {
