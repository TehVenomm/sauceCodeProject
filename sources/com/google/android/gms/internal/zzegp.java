            ...
            for (Method name2 : cls.getMethods()) {
                ...
                if (name3.startsWith("set")) {
                    ...
                    try {
                        ...
                        if (((Boolean) cls.getMethod(name3.length() != 0 ? "has".concat(name3) : new String("has"), new Class[0]).invoke(obj, new Object[0])).booleanValue()) {
                            try {
                                name3 = String.valueOf(substring);
                                zza(substring, cls.getMethod(name3.length() != 0 ? "get".concat(name3) : new String("get"), new Class[0]).invoke(obj, new Object[0]), stringBuffer, stringBuffer2);
