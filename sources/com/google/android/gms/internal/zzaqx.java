...
public final class zzaqx implements WorkAccountApi {
    private static final Status zzdya = new Status(13);

    public final PendingResult<AddAccountResult> addWorkAccount(GoogleApiClient googleApiClient, String str) {
        return googleApiClient.zze(new zzaqz(this, WorkAccount.API, googleApiClient, str));
    }

    public final PendingResult<Result> removeWorkAccount(GoogleApiClient googleApiClient, Account account) {
        return googleApiClient.zze(new zzarb(this, WorkAccount.API, googleApiClient, account));
    }
    ...
    public final PendingResult<Result> setWorkAuthenticatorEnabledWithResult(GoogleApiClient googleApiClient, boolean z) {
        return googleApiClient.zze(new zzaqy(this, WorkAccount.API, googleApiClient, z));
    }
}
