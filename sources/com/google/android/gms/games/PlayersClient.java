...
public class PlayersClient extends zzt {
    ...
    public Task<AnnotatedData<PlayerBuffer>> loadMoreRecentlyPlayedWithPlayers(@IntRange(from = 1, mo60to = 25) int i) {
    ...
    public Task<AnnotatedData<PlayerBuffer>> loadRecentlyPlayedWithPlayers(@IntRange(from = 1, mo60to = 25) int i, boolean z) {
