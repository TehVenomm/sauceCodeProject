...
public final class Games {
    ...
    public static final class GamesOptions implements GoogleSignInOptionsExtension, HasGoogleSignInAccountOptions, Optional {
        ...
        public final boolean equals(Object obj) {
            if (obj != this) {
                ...
                } else if (!this.zzbb.equals(gamesOptions.zzbb)) {
                    return false;
                }
        ...
        public final int hashCode() {
            int i = 1;
            int i2 = 0;
            int i3 = this.zzar ? 1 : 0;
            int i4 = this.zzas ? 1 : 0;
            int i5 = this.zzat;
            int i6 = this.zzau ? 1 : 0;
            int i7 = this.zzav;
            int hashCode = this.zzaw == null ? 0 : this.zzaw.hashCode();
            int hashCode2 = this.zzax.hashCode();
            int i8 = this.zzay ? 1 : 0;
            int i9 = this.zzaz ? 1 : 0;
            if (!this.zzba) {
                i = 0;
            }
            int hashCode3 = this.zzbb == null ? 0 : this.zzbb.hashCode();
            if (this.zzbc != null) {
                i2 = this.zzbc.hashCode();
            }
            return ((((((((((((((((((((((i3 + 527) * 31) + i4) * 31) + i5) * 31) + i6) * 31) + i7) * 31) + hashCode) * 31) + hashCode2) * 31) + i8) * 31) + i9) * 31) + i) * 31) + hashCode3) * 31) + i2;
        }
    ...
    private static class zzb extends AbstractClientBuilder<com.google.android.gms.games.internal.zze, GamesOptions> {
        private zzb() {
        }
        ...
        public /* synthetic */ Client buildClient(Context context, Looper looper, ClientSettings clientSettings, Object obj, ConnectionCallbacks connectionCallbacks, OnConnectionFailedListener onConnectionFailedListener) {
            GamesOptions gamesOptions = (GamesOptions) obj;
            return new com.google.android.gms.games.internal.zze(context, looper, clientSettings, gamesOptions == null ? new Builder((zzi) null).build() : gamesOptions, connectionCallbacks, onConnectionFailedListener);
        }
