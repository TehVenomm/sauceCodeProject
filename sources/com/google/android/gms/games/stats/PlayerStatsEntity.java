...
public class PlayerStatsEntity extends zzd implements PlayerStats {
    ...
    @Field(getter = "getAverageSessionLength", mo13990id = 1)
    private final float zzsi;
    @Field(getter = "getChurnProbability", mo13990id = 2)
    private final float zzsj;
    @Field(getter = "getDaysSinceLastPlayed", mo13990id = 3)
    private final int zzsk;
    @Field(getter = "getNumberOfPurchases", mo13990id = 4)
    private final int zzsl;
    @Field(getter = "getNumberOfSessions", mo13990id = 5)
    private final int zzsm;
    @Field(getter = "getSessionPercentile", mo13990id = 6)
    private final float zzsn;
    @Field(getter = "getSpendPercentile", mo13990id = 7)
    private final float zzso;
    @Field(getter = "getRawValues", mo13990id = 8)
    private final Bundle zzsp;
    @Field(getter = "getSpendProbability", mo13990id = 9)
    private final float zzsq;
    @Field(getter = "getHighSpenderProbability", mo13990id = 10)
    private final float zzsr;
    @Field(getter = "getTotalSpendNext28Days", mo13990id = 11)
    private final float zzss;

    @Constructor
    PlayerStatsEntity(@Param(mo13993id = 1) float f, @Param(mo13993id = 2) float f2, @Param(mo13993id = 3) int i, @Param(mo13993id = 4) int i2, @Param(mo13993id = 5) int i3, @Param(mo13993id = 6) float f3, @Param(mo13993id = 7) float f4, @Param(mo13993id = 8) Bundle bundle, @Param(mo13993id = 9) float f5, @Param(mo13993id = 10) float f6, @Param(mo13993id = 11) float f7) {
        this.zzsi = f;
        this.zzsj = f2;
        this.zzsk = i;
        this.zzsl = i2;
