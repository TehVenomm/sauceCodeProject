...
public final class SnapshotEntity extends zzd implements Snapshot {
    ...
    @Field(getter = "getMetadata", mo13990id = 1)
    private final SnapshotMetadataEntity zzrr;
    @Field(getter = "getSnapshotContents", mo13990id = 3)
    private final SnapshotContentsEntity zzrs;

    @Constructor
    public SnapshotEntity(@Param(mo13993id = 1) SnapshotMetadata snapshotMetadata, @Param(mo13993id = 3) SnapshotContentsEntity snapshotContentsEntity) {
