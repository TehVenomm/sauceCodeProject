...
public final class AppContentActionEntity extends zzd implements zza {
    ...
    @Field(getter = "getExtras", mo13990id = 3)
    private final Bundle extras;
    @Field(getter = "getType", mo13990id = 6)
    private final String type;
    @Field(getter = "getConditions", mo13990id = 1)
    private final ArrayList<AppContentConditionEntity> zzfp;
    @Field(getter = "getContentDescription", mo13990id = 2)
    private final String zzfq;
    @Field(getter = "getId", mo13990id = 7)
    private final String zzfr;
    @Field(getter = "getAnnotation", mo13990id = 8)
    private final AppContentAnnotationEntity zzfs;
    @Field(getter = "getOverflowText", mo13990id = 9)
    private final String zzft;

    @Constructor
    AppContentActionEntity(@Param(mo13993id = 1) ArrayList<AppContentConditionEntity> arrayList, @Param(mo13993id = 2) String str, @Param(mo13993id = 3) Bundle bundle, @Param(mo13993id = 6) String str2, @Param(mo13993id = 7) String str3, @Param(mo13993id = 8) AppContentAnnotationEntity appContentAnnotationEntity, @Param(mo13993id = 9) String str4) {
