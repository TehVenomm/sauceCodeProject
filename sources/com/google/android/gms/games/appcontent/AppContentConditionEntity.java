...
public final class AppContentConditionEntity extends zzd implements zzg {
    ...
    @Field(getter = "getDefaultValue", mo13990id = 1)
    private final String zzgf;
    @Field(getter = "getExpectedValue", mo13990id = 2)
    private final String zzgg;
    @Field(getter = "getPredicate", mo13990id = 3)
    private final String zzgh;
    @Field(getter = "getPredicateParameters", mo13990id = 4)
    private final Bundle zzgi;

    @Constructor
    AppContentConditionEntity(@Param(mo13993id = 1) String str, @Param(mo13993id = 2) String str2, @Param(mo13993id = 3) String str3, @Param(mo13993id = 4) Bundle bundle) {
        this.zzgf = str;
        this.zzgg = str2;
        this.zzgh = str3;
        this.zzgi = bundle;
