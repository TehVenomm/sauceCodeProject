...
public final class AppContentSectionEntity extends zzd implements zzi {
    ...
    @Field(getter = "getExtras", mo13990id = 5)
    private final Bundle extras;
    @Field(getter = "getType", mo13990id = 8)
    private final String type;
    @Field(getter = "getTitle", mo13990id = 7)
    private final String zzcd;
    @Field(getter = "getContentDescription", mo13990id = 4)
    private final String zzfq;
    @Field(getter = "getId", mo13990id = 9)
    private final String zzfr;
    @Field(getter = "getActions", mo13990id = 1)
    private final ArrayList<AppContentActionEntity> zzga;
    @Field(getter = "getAnnotations", mo13990id = 14)
    private final ArrayList<AppContentAnnotationEntity> zzgb;
    @Field(getter = "getSubtitle", mo13990id = 6)
    private final String zzgd;
    @Field(getter = "getCards", mo13990id = 3)
    private final ArrayList<AppContentCardEntity> zzgj;
    @Field(getter = "getCardType", mo13990id = 10)
    private final String zzgk;

    @Constructor
    AppContentSectionEntity(@Param(mo13993id = 1) ArrayList<AppContentActionEntity> arrayList, @Param(mo13993id = 3) ArrayList<AppContentCardEntity> arrayList2, @Param(mo13993id = 4) String str, @Param(mo13993id = 5) Bundle bundle, @Param(mo13993id = 6) String str2, @Param(mo13993id = 7) String str3, @Param(mo13993id = 8) String str4, @Param(mo13993id = 9) String str5, @Param(mo13993id = 10) String str6, @Param(mo13993id = 14) ArrayList<AppContentAnnotationEntity> arrayList3) {
        this.zzga = arrayList;
