...
public class zze extends GmsClient<zzbu> {
        ...
        public final GameRequestBuffer getRequests(int i) {
            ...
            switch (i) {
                ...
                case 2:
                    ...
                    break;
                default:
                    zzbd.m430e("RequestType", "Unknown request type: " + i);
                    str = "UNKNOWN_TYPE";
                    break;
            }
    ...
    private static final class zzao extends zza {
        ...
        public final void zza(int i, int i2, String str) {
            if (this.zzio != null) {
                this.zzio.notifyListener(zze.zza((zzap<T>) new zzaj<T>(i, i2, str)));
            }
        }
    }
    ...
    private static class zzat<T> extends zza {
    ...
    private static final class zzau extends zza {
        ...
        public final void onP2PConnected(String str) {
            if (this.zziu != null) {
                this.zziu.notifyListener(zze.zza((zzap<T>) new zzas<T>(str)));
            }
        }

        public final void onP2PDisconnected(String str) {
            if (this.zziu != null) {
                this.zziu.notifyListener(zze.zza((zzap<T>) new zzat<T>(str)));
            }
        }

        public final void onRealTimeMessageReceived(RealTimeMessage realTimeMessage) {
            if (this.zziv != null) {
                this.zziv.notifyListener(zze.zza((zzap<T>) new zzau<T>(realTimeMessage)));
            }
        }

        public final void zza(DataHolder dataHolder, String[] strArr) {
            if (this.zziu != null) {
                this.zziu.notifyListener(zze.zza(dataHolder, strArr, zzao.zzix));
            }
        }

        public final void zzb(DataHolder dataHolder, String[] strArr) {
            if (this.zziu != null) {
                this.zziu.notifyListener(zze.zza(dataHolder, strArr, zzap.zzix));
            }
        }

        public final void zzc(DataHolder dataHolder, String[] strArr) {
            if (this.zziu != null) {
                this.zziu.notifyListener(zze.zza(dataHolder, strArr, zzaq.zzix));
            }
        }

        public final void zzd(DataHolder dataHolder, String[] strArr) {
            if (this.zziu != null) {
                this.zziu.notifyListener(zze.zza(dataHolder, strArr, zzar.zzix));
            }
        }

        public final void zze(DataHolder dataHolder, String[] strArr) {
            if (this.zziu != null) {
                this.zziu.notifyListener(zze.zza(dataHolder, strArr, zzbb.zzix));
            }
        }

        public final void zzf(DataHolder dataHolder, String[] strArr) {
            if (this.zziu != null) {
                this.zziu.notifyListener(zze.zza(dataHolder, strArr, zzbc.zzix));
            }
        }
        ...
        public final void zzu(DataHolder dataHolder) {
            if (this.zziu != null) {
                this.zziu.notifyListener(zze.zza(dataHolder, zzax.zzja));
            }
        }

        public final void zzv(DataHolder dataHolder) {
            if (this.zziu != null) {
                this.zziu.notifyListener(zze.zza(dataHolder, zzay.zzja));
            }
        }
        ...
        public final void zzx(DataHolder dataHolder) {
            if (this.zziu != null) {
                this.zziu.notifyListener(zze.zza(dataHolder, zzaz.zzja));
            }
        }

        public final void zzy(DataHolder dataHolder) {
            if (this.zziu != null) {
                this.zziu.notifyListener(zze.zza(dataHolder, zzba.zzja));
            }
        }
    }
    ...
    private static class zzbd extends zzl {
    ...
    private static final class C1830zze implements CaptureCapabilitiesResult {
        private final Status zzhl;
        private final VideoCapabilities zzho;

        C1830zze(Status status, VideoCapabilities videoCapabilities) {
            this.zzhl = status;
    ...
    private final class zzk extends zzeh {
        zzk() {
        ...
        public final void zzf(String str, int i) {
            try {
                ...
                zzbd.m430e("GamesClientImpl", new StringBuilder(String.valueOf(str).length() + 89).append("Unable to increment event ").append(str).append(" by ").append(i).append(" because the games client is no longer connected").toString());
    ...
    private static class zzl extends DataHolderResult {
    ...
    private static class zzu<T> extends zza {
    ...
    public static void zza(RemoteException remoteException) {
        zzbd.m434w("GamesClientImpl", "service died", remoteException);
    }
    ...
    public static void zza(SecurityException securityException) {
        zzbd.m431e("GamesClientImpl", "Is player signed out?", securityException);
    }
    ...
    public void disconnect() {
        ...
        if (isConnected()) {
            try {
                ...
                zzbd.m433w("GamesClientImpl", "Failed to notify client disconnect.");
            }
        }
        super.disconnect();
    }
    ...
    public final String zza(boolean z) throws RemoteException {
        return this.zzgq != null ? this.zzgq.getPlayerId() : ((zzbu) getService()).zzck();
    }
    ...
    public final void zza(ResultHolder<UpdateAchievementResult> resultHolder, String str, int i) throws RemoteException {
        try {
            ((zzbu) getService()).zza((zzbq) resultHolder == null ? null : new zzb(resultHolder), str, i, this.zzgs.zzcp(), this.zzgs.zzco());
        } catch (SecurityException e) {
            zza(resultHolder, e);
        }
    }
    ...
    public final void zza(ResultHolder<SubmitScoreResult> resultHolder, String str, long j, String str2) throws RemoteException {
        try {
            ((zzbu) getService()).zza((zzbq) resultHolder == null ? null : new zzaa(resultHolder), str, j, str2);
        } catch (SecurityException e) {
            zza(resultHolder, e);
        }
    }
