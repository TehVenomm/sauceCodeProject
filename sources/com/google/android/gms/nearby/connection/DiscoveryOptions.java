...
public final class DiscoveryOptions extends AbstractSafeParcelable {
    ...
    public Strategy zzh;
    /* access modifiers changed from: private */
    @Field(defaultValue = "true", getter = "getEnableBluetooth", mo13990id = 3)
    public boolean zzk;
    /* access modifiers changed from: private */
    @Field(defaultValue = "true", getter = "getEnableBle", mo13990id = 4)
    public boolean zzl;
    /* access modifiers changed from: private */
    @Field(defaultValue = "false", getter = "getForwardUnrecognizedBluetoothDevices", mo13990id = 2)
    public boolean zzw;
    ...
    @Constructor
    DiscoveryOptions(@Param(mo13993id = 1) Strategy strategy, @Param(mo13993id = 2) boolean z, @Param(mo13993id = 3) boolean z2, @Param(mo13993id = 4) boolean z3) {
        this.zzw = false;
        this.zzk = true;
        this.zzl = true;
        this.zzh = strategy;
