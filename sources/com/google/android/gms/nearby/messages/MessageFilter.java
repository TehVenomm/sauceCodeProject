...
public class MessageFilter extends AbstractSafeParcelable {
    ...
    @Field(getter = "getMessageTypes", mo13990id = 1)
    private final List<zzad> zzey;
    @Field(getter = "getDeviceFilters", mo13990id = 2)
    private final List<zzgu> zzez;
    @Field(getter = "getIncludeAllMyTypes", mo13990id = 3)
    private final boolean zzfa;
    @Field(getter = "getBleFilters", mo13990id = 4)
    private final List<zzgp> zzfb;
    @Field(getter = "getNumRawAudioBytes", mo13990id = 5)
    ...
    public static final class Builder {
        ...
        public final MessageFilter build() {
            ...
            return new MessageFilter((List) new ArrayList(this.zzfd), (List) this.zzez, this.zzfa, (List) new ArrayList(this.zzfe), this.zzfc);
        }
    ...
    @Constructor
    MessageFilter(@Param(mo13993id = 1000) int i, @Param(mo13993id = 1) List<zzad> list, @Param(mo13993id = 2) List<zzgu> list2, @Param(mo13993id = 3) boolean z, @Param(mo13993id = 4) List<zzgp> list3, @Param(mo13993id = 5) int i2) {
        this.zzex = i;
    ...
    public boolean equals(Object obj) {
        if (this != obj) {
            ...
            if (this.zzfa != messageFilter.zzfa || !Objects.equal(this.zzey, messageFilter.zzey) || !Objects.equal(this.zzez, messageFilter.zzez) || !Objects.equal(this.zzfb, messageFilter.zzfb)) {
                return false;
            }
        }
        return true;
