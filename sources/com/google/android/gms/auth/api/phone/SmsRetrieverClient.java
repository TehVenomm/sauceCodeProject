...
public abstract class SmsRetrieverClient extends GoogleApi<NoOptions> implements SmsRetrieverApi {
    private static final Api<NoOptions> API = new Api("SmsRetriever.API", zzdwr, zzdwq);
    private static final zzf<zzath> zzdwq = new zzf();
    private static final zza<zzath, NoOptions> zzdwr = new zza();
