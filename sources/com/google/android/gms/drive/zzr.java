...
public final class zzr extends AbstractSafeParcelable {
    ...
    @Field(getter = "getAccountType", mo13990id = 3)
    private int accountType;
    @Nullable
    @Field(getter = "getAccountIdentifier", mo13990id = 2)
    private String zzbe;
    @Nullable
    @Field(getter = "getAccountDisplayName", mo13990id = 4)
    private String zzbf;
    @Nullable
    @Field(getter = "getPhotoLink", mo13990id = 5)
    private String zzbg;
    @Field(getter = "getRole", mo13990id = 6)
    private int zzbh;
    @Field(getter = "isLinkRequiredForAccess", mo13990id = 7)
    private boolean zzbi;

    @Constructor
    public zzr(@Nullable @Param(mo13993id = 2) String str, @Param(mo13993id = 3) int i, @Nullable @Param(mo13993id = 4) String str2, @Nullable @Param(mo13993id = 5) String str3, @Param(mo13993id = 6) int i2, @Param(mo13993id = 7) boolean z) {
        this.zzbe = str;
        this.accountType = i;
        this.zzbf = str2;
        this.zzbg = str3;
