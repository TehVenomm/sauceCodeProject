...
public abstract class FastJsonResponse {
    ...
    public static class Field<I, O> extends AbstractSafeParcelable {
        ...
        @com.google.android.gms.common.internal.safeparcel.SafeParcelable.Field(getter = "getTypeIn", mo13990id = 2)
        protected final int zapq;
        @com.google.android.gms.common.internal.safeparcel.SafeParcelable.Field(getter = "isTypeInArray", mo13990id = 3)
        protected final boolean zapr;
        @com.google.android.gms.common.internal.safeparcel.SafeParcelable.Field(getter = "getTypeOut", mo13990id = 4)
        protected final int zaps;
        @com.google.android.gms.common.internal.safeparcel.SafeParcelable.Field(getter = "isTypeOutArray", mo13990id = 5)
        protected final boolean zapt;
        @com.google.android.gms.common.internal.safeparcel.SafeParcelable.Field(getter = "getOutputFieldName", mo13990id = 6)
        protected final String zapu;
        @com.google.android.gms.common.internal.safeparcel.SafeParcelable.Field(getter = "getSafeParcelableFieldId", mo13990id = 7)
        protected final int zapv;
        protected final Class<? extends FastJsonResponse> zapw;
        @com.google.android.gms.common.internal.safeparcel.SafeParcelable.Field(getter = "getConcreteTypeName", mo13990id = 8)
        private final String zapx;
        private zak zapy;
        /* access modifiers changed from: private */
        @com.google.android.gms.common.internal.safeparcel.SafeParcelable.Field(getter = "getWrappedConverter", mo13990id = 9, type = "com.google.android.gms.common.server.converter.ConverterWrapper")
        public FieldConverter<I, O> zapz;

        @Constructor
        Field(@Param(mo13993id = 1) int i, @Param(mo13993id = 2) int i2, @Param(mo13993id = 3) boolean z, @Param(mo13993id = 4) int i3, @Param(mo13993id = 5) boolean z2, @Param(mo13993id = 6) String str, @Param(mo13993id = 7) int i4, @Param(mo13993id = 8) String str2, @Param(mo13993id = 9) zaa zaa) {
            this.zale = i;
            this.zapq = i2;
            this.zapr = z;
            this.zaps = i3;
