...
public final class zak extends AbstractSafeParcelable {
    ...
    @SafeParcelable.Field(getter = "getSerializedDictionary", mo13990id = 2)
    private final ArrayList<zal> zaqv;
    @SafeParcelable.Field(getter = "getRootClassName", mo13990id = 3)
    private final String zaqw;

    @Constructor
    zak(@Param(mo13993id = 1) int i, @Param(mo13993id = 2) ArrayList<zal> arrayList, @Param(mo13993id = 3) String str) {
        this.zale = i;
        this.zaqv = null;
