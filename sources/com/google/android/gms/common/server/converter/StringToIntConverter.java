...
public final class StringToIntConverter extends AbstractSafeParcelable implements FieldConverter<String, Integer> {
    ...
    @Field(getter = "getSerializedMap", mo13990id = 2)
    ...
    public static final class zaa extends AbstractSafeParcelable {
        ...
        @Constructor
        zaa(@Param(mo13993id = 1) int i, @Param(mo13993id = 2) String str, @Param(mo13993id = 3) int i2) {
            this.versionCode = i;
            this.zapo = str;
            this.zapp = i2;
        }
    ...
    @Constructor
    StringToIntConverter(@Param(mo13993id = 1) int i, @Param(mo13993id = 2) ArrayList<zaa> arrayList) {
        this.zale = i;
        this.zapl = new HashMap<>();
        this.zapm = new SparseArray<>();
        this.zapn = null;
