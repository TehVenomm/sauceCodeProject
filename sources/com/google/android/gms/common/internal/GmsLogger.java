...
public final class GmsLogger {
    ...
    @KeepForSdk
    /* renamed from: d */
    public final void mo13926d(String str, String str2) {
        if (canLog(3)) {
            Log.d(str, zzh(str2));
        }
    }
    ...
    @KeepForSdk
    /* renamed from: d */
    public final void mo13927d(String str, String str2, Throwable th) {
        if (canLog(3)) {
    ...
    @KeepForSdk
    /* renamed from: e */
    public final void mo13928e(String str, String str2) {
        if (canLog(6)) {
            Log.e(str, zzh(str2));
        }
    }
    ...
    @KeepForSdk
    /* renamed from: e */
    public final void mo13929e(String str, String str2, Throwable th) {
        if (canLog(6)) {
    ...
    @KeepForSdk
    /* renamed from: i */
    public final void mo13931i(String str, String str2) {
        if (canLog(4)) {
            Log.i(str, zzh(str2));
        }
    }
    ...
    @KeepForSdk
    /* renamed from: i */
    public final void mo13932i(String str, String str2, Throwable th) {
        if (canLog(4)) {
    ...
    @KeepForSdk
    /* renamed from: v */
    public final void mo13935v(String str, String str2) {
        if (canLog(2)) {
            Log.v(str, zzh(str2));
        }
    }
    ...
    @KeepForSdk
    /* renamed from: v */
    public final void mo13936v(String str, String str2, Throwable th) {
        if (canLog(2)) {
    ...
    @KeepForSdk
    /* renamed from: w */
    public final void mo13937w(String str, String str2) {
        if (canLog(5)) {
            Log.w(str, zzh(str2));
        }
    }
    ...
    @KeepForSdk
    /* renamed from: w */
    public final void mo13938w(String str, String str2, Throwable th) {
        if (canLog(5)) {
