...
public class SignInButtonConfig extends AbstractSafeParcelable {
    ...
    @Field(getter = "getScopes", mo13990id = 4)
    @Deprecated
    private final Scope[] zanx;
    @Field(getter = "getButtonSize", mo13990id = 2)
    private final int zapc;
    @Field(getter = "getColorScheme", mo13990id = 3)
    private final int zapd;

    @Constructor
    SignInButtonConfig(@Param(mo13993id = 1) int i, @Param(mo13993id = 2) int i2, @Param(mo13993id = 3) int i3, @Param(mo13993id = 4) Scope[] scopeArr) {
        this.zale = i;
        this.zapc = i2;
        this.zapd = i3;
        this.zanx = scopeArr;
