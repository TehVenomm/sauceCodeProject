    ...
    public static abstract class Stub extends Binder implements IGmsServiceBroker {
        ...
        public boolean onTransact(int i, Parcel parcel, Parcel parcel2, int i2) throws RemoteException {
            ...
            if (readStrongBinder == null) {
                ...
                zzl = queryLocalInterface instanceof IGmsCallbacks ? (IGmsCallbacks) queryLocalInterface : new zzl(readStrongBinder);
            }
            if (i == 46) {
                getService(zzl, parcel.readInt() != 0 ? (GetServiceRequest) GetServiceRequest.CREATOR.createFromParcel(parcel) : null);
