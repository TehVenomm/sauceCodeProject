...
public class GetServiceRequest extends AbstractSafeParcelable {
    ...
    @Constructor
    GetServiceRequest(@Param(mo13993id = 1) int i, @Param(mo13993id = 2) int i2, @Param(mo13993id = 3) int i3, @Param(mo13993id = 4) String str, @Param(mo13993id = 5) IBinder iBinder, @Param(mo13993id = 6) Scope[] scopeArr, @Param(mo13993id = 7) Bundle bundle, @Param(mo13993id = 8) Account account, @Param(mo13993id = 10) Feature[] featureArr, @Param(mo13993id = 11) Feature[] featureArr2, @Param(mo13993id = 12) boolean z) {
        this.version = i;
        this.zzdg = i2;
        this.zzdh = i3;
