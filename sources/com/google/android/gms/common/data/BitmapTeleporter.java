...
public class BitmapTeleporter extends AbstractSafeParcelable implements ReflectedParcelable {
    ...
    @Constructor
    BitmapTeleporter(@Param(mo13993id = 1) int i, @Param(mo13993id = 2) ParcelFileDescriptor parcelFileDescriptor, @Param(mo13993id = 3) int i2) {
        this.zale = i;
    ...
    private final FileOutputStream zabz() {
        ...
        try {
            ...
            try {
                ...
                this.zalf = ParcelFileDescriptor.open(createTempFile, DriveFile.MODE_READ_ONLY);
