...
public final class LinkedTreeMap<K, V> extends AbstractMap<K, V> implements Serializable {
    ...
    private static final Comparator<Comparable> NATURAL_ORDER = new C06841();
    ...
    static final class C06841 implements Comparator<Comparable> {
        C06841() {
        }
    ...
    class EntrySet extends AbstractSet<Entry<K, V>> {
        ...
        class C06851 extends LinkedTreeMapIterator<Entry<K, V>> {
            C06851() {
                super();
            }
    ...
    final class KeySet extends AbstractSet<K> {
        ...
        class C06861 extends LinkedTreeMapIterator<K> {
            C06861() {
                super();
            }
