...
final class zza {
    ...
    private final Notification zza(CharSequence charSequence, String str, int i, Integer num, Uri uri, PendingIntent pendingIntent, PendingIntent pendingIntent2, String str2) {
        ...
        if (str2 != null) {
            ...
            if (this.zzhqj == null) {
                ...
                try {
                    this.zzhqj.invoke(smallIcon, new Object[]{str2});
                } catch (Throwable e) {
    ...
    @Nullable
    static Uri zzad(@NonNull Bundle bundle) {
    ...
    static String zzae(Bundle bundle) {
    ...
    private final Bundle zzasg() {
        ...
        this.zzfqi = applicationInfo.metaData;
        return this.zzfqi;
    }
    ...
    static zza zzep(Context context) {
        synchronized (zza.class) {
            try {
                if (zzmjt == null) {
                    zzmjt = new zza(context);
                }
                zza zza = zzmjt;
                return zza;
            } finally {
    ...
    static Object[] zzi(Bundle bundle, String str) {
        ...
        try {
            ...
            Log.w("FirebaseMessaging", new StringBuilder((String.valueOf(valueOf2).length() + 41) + String.valueOf(zze).length()).append("Malformed ").append(valueOf2).append(": ").append(zze).append("  Default value will be used.").toString());
            return null;
        }
    }
    ...
    private final String zzj(Bundle bundle, String str) {
        ...
        if (identifier == 0) {
            ...
            String valueOf2 = String.valueOf("_loc_key");
            valueOf2 = (valueOf2.length() != 0 ? valueOf.concat(valueOf2) : new String(valueOf)).substring(6);
            Log.w("FirebaseMessaging", new StringBuilder((String.valueOf(valueOf2).length() + 49) + String.valueOf(zzh).length()).append(valueOf2).append(" resource not found: ").append(zzh).append(" Default value will be used.").toString());
            return null;
        }
    ...
    private final Integer zzqc(String str) {
        Integer num = null;
        ...
        int i = zzasg().getInt("com.google.firebase.messaging.default_notification_color", 0);
        if (i == 0) {
            return num;
        }
        try {
    ...
    @TargetApi(26)
    private final String zzqd(String str) {
        if (!zzp.isAtLeastO()) {
            return null;
        }
        ...
        try {
            if (this.zzhqk == null) {
                this.zzhqk = notificationManager.getClass().getMethod("getNotificationChannel", new Class[]{String.class});
            }
            if (!TextUtils.isEmpty(str)) {
                if (this.zzhqk.invoke(notificationManager, new Object[]{str}) != null) {
                    return str;
                }
            ...
            Object string = zzasg().getString("com.google.firebase.messaging.default_notification_channel_id");
            if (TextUtils.isEmpty(string)) {
                Log.w("FirebaseMessaging", "Missing Default Notification Channel metadata in AndroidManifest. Default value will be used.");
            } else {
                if (this.zzhqk.invoke(notificationManager, new Object[]{string}) != null) {
                    return string;
                }
                Log.w("FirebaseMessaging", "Notification Channel set in AndroidManifest.xml has not been created by the app. Default value will be used.");
            }
            if (this.zzhqk.invoke(notificationManager, new Object[]{"fcm_fallback_notification_channel"}) == null) {
                Object newInstance = Class.forName("android.app.NotificationChannel").getConstructor(new Class[]{String.class, CharSequence.class, Integer.TYPE}).newInstance(new Object[]{"fcm_fallback_notification_channel", this.mContext.getString(C0603R.string.fcm_fallback_notification_channel_label), Integer.valueOf(3)});
    ...
    private final PendingIntent zzs(Bundle bundle) {
        Intent intent;
        Object zze = zze(bundle, "gcm.n.click_action");
        Intent intent2;
        if (TextUtils.isEmpty(zze)) {
            Uri zzad = zzad(bundle);
            if (zzad != null) {
                intent2 = new Intent("android.intent.action.VIEW");
                intent2.setPackage(this.mContext.getPackageName());
                intent2.setData(zzad);
                intent = intent2;
            } else {
        ...
        return PendingIntent.getActivity(this.mContext, this.zzmju.incrementAndGet(), intent, 1073741824);
    }

    final boolean zzr(Bundle bundle) {
        ...
        if (!((KeyguardManager) this.mContext.getSystemService("keyguard")).inKeyguardRestrictedInputMode()) {
            ...
            List<RunningAppProcessInfo> runningAppProcesses = ((ActivityManager) this.mContext.getSystemService(LocalNotificationAlarmReceiver.EXTRA_ACTIVITY)).getRunningAppProcesses();
                    ...
                    if (runningAppProcessInfo.pid == myPid) {
                        ...
                        if (!TextUtils.isEmpty(zze)) {
                            ...
                            if (TextUtils.isEmpty(zze)) {
                                ...
                                uri = Uri.parse(new StringBuilder(((String.valueOf("android.resource://").length() + 5) + String.valueOf(packageName).length()) + String.valueOf(zze).length()).append("android.resource://").append(packageName).append("/raw/").append(zze).toString());
                            }
                            zzs = zzs(bundle);
                            if (FirebaseMessagingService.zzaf(bundle)) {
                                pendingIntent = null;
                                parcelable = zzs;
                            } else {
                                intent = new Intent("com.google.firebase.messaging.NOTIFICATION_OPEN");
                                zza(intent, bundle);
                                intent.putExtra("pending_intent", zzs);
                                zzb = zzq.zzb(this.mContext, this.zzmju.incrementAndGet(), intent, 1073741824);
                                intent2 = new Intent("com.google.firebase.messaging.NOTIFICATION_DISMISS");
                                zza(intent2, bundle);
                                pendingIntent = zzq.zzb(this.mContext, this.zzmju.incrementAndGet(), intent2, 1073741824);
                            }
                            if (zzp.isAtLeastO() || this.mContext.getApplicationInfo().targetSdkVersion <= 25) {
                                ...
                                if (zzqc != null) {
                                    smallIcon.setColor(zzqc.intValue());
                                }
                                if (uri != null) {
                                    smallIcon.setSound(uri);
                                }
                                ...
                                build = zza(zzj, zzj2, identifier, zzqc, uri, zzb, pendingIntent, zzqd(zze(bundle, "gcm.n.android_channel_id")));
                            }
                        ...
                        i = zzasg().getInt("com.google.firebase.messaging.default_notification_icon", 0);
                        if (i == 0) {
