...
import p017io.fabric.sdk.android.services.events.EventsStorageListener;
...
class AnswersEventsHandler implements EventsStorageListener {
    ...
    private void executeAsync(Runnable runnable) {
        try {
            ...
            Fabric.getLogger().mo20972e(Answers.TAG, "Failed to submit events task", e);
        }
    }
    ...
    private void executeSync(Runnable runnable) {
        try {
            ...
            Fabric.getLogger().mo20972e(Answers.TAG, "Failed to run events task", e);
        }
    }
        ...
        executeAsync(new Runnable() {
            public void run() {
                try {
                    ...
                    Fabric.getLogger().mo20972e(Answers.TAG, "Failed to disable events", e);
                }
            }
        });
    }
        ...
        executeAsync(new Runnable() {
            public void run() {
                try {
                    ...
                    Fabric.getLogger().mo20972e(Answers.TAG, "Failed to enable events", e);
                }
            }
        });
    }
        ...
        executeAsync(new Runnable() {
            public void run() {
                try {
                    ...
                    Fabric.getLogger().mo20972e(Answers.TAG, "Failed to flush events", e);
                }
            }
        });
    }
        ...
        executeAsync(new Runnable() {
            public void run() {
                try {
                    ...
                    Fabric.getLogger().mo20972e(Answers.TAG, "Failed to send events files", e);
                }
            }
        });
    }
        ...
        C04756 r0 = new Runnable() {
            public void run() {
                try {
                    ...
                    Fabric.getLogger().mo20972e(Answers.TAG, "Failed to process event", e);
                }
            }
        };
        if (z) {
        ...
        executeAsync(new Runnable() {
            public void run() {
                try {
                    ...
                    Fabric.getLogger().mo20972e(Answers.TAG, "Failed to set analytics settings data", e);
                }
            }
        });
    }
