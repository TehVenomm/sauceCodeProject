...
public final class C0770n implements C0759i {
    /* renamed from: a */
    ...
    /* renamed from: a */
    public final void mo4203a(Activity activity, final Runnable runnable) {
        if (activity != null) {
            ...
            try {
                ...
                if (C0770n.m506a(activityInfo) || C0770n.m506a(applicationInfo)) {
                    runnable.run();
                    return;
                }
            } catch (Exception e) {
            ...
            try {
                ...
                for (String str : packageInfo.requestedPermissions) {
                    try {
                        ...
                        C0768m.Log(5, "Failed to get permission info for " + str + ", manifest likely missing custom permission declaration");
                        C0768m.Log(5, "Permission " + str + " ignored");
                    }
                }
                ...
                Fragment c07691 = new Fragment(this) {
                    /* renamed from: d */
                    final /* synthetic */ C0770n f529d;

                    public final void onRequestPermissionsResult(int i, String[] strArr, int[] iArr) {
                        if (i == 15881) {
                            int i2 = 0;
                            while (i2 < strArr.length && i2 < iArr.length) {
                                C0768m.Log(4, strArr[i2] + (iArr[i2] == 0 ? " granted" : " denied"));
                                i2++;
                            }
                ...
                FragmentTransaction beginTransaction = fragmentManager.beginTransaction();
                beginTransaction.add(0, c07691);
                beginTransaction.commit();
            } catch (Exception e3) {
                C0768m.Log(6, "Unable to query for permission: " + e3.getMessage());
            }
        }
    }
}
