...
public final class C0771o {
    ...
    public C0771o(Activity activity) {
        ...
        try {
            ...
            C0768m.Log(6, "Unable to retreive meta data for activity '" + componentName + "'");
        }
    ...
    public final boolean m509a() {
        return this.f530a.getBoolean(C0771o.m508a("ForwardNativeEventsToDalvik"));
    }
}
