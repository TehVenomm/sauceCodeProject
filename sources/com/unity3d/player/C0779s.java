...
public final class C0779s extends Dialog implements TextWatcher, OnClickListener {
    /* renamed from: c */
    ...
    final class C07761 implements OnFocusChangeListener {
        /* renamed from: a */
        final /* synthetic */ C0779s f556a;

        C07761(C0779s c0779s) {
            this.f556a = c0779s;
        }
    ...
    final class C07783 implements OnEditorActionListener {
        /* renamed from: a */
        final /* synthetic */ C0779s f558a;

        C07783(C0779s c0779s) {
            this.f558a = c0779s;
        }
    ...
    public C0779s(Context context, UnityPlayer unityPlayer, String str, int i, boolean z, boolean z2, boolean z3, String str2) {
        super(context);
        this.f562a = context;
        ...
        editText.setOnFocusChangeListener(new C07761(this));
    }
    ...
    private void m530a(EditText editText, String str, int i, boolean z, boolean z2, boolean z3, String str2) {
        ...
        editText.setInputType(C0779s.m527a(i, z, z2, z3));
    ...
    protected final View createSoftInputView() {
        ...
        View c07772 = new EditText(this, this.f562a) {
            /* renamed from: a */
            final /* synthetic */ C0779s f557a;
        ...
        c07772.setLayoutParams(layoutParams);
        c07772.setTextColor(f559c);
        c07772.setId(1057292289);
        relativeLayout.addView(c07772);
        c07772 = new Button(this.f562a);
        c07772.setText(this.f562a.getResources().getIdentifier("ok", "string", AbstractSpiCall.ANDROID_CLIENT_TYPE));
        layoutParams = new RelativeLayout.LayoutParams(-2, -2);
        layoutParams.addRule(15);
        layoutParams.addRule(11);
        c07772.setLayoutParams(layoutParams);
        c07772.setId(1057292290);
        c07772.setBackgroundColor(0);
        c07772.setTextColor(f559c);
        relativeLayout.addView(c07772);
        ((EditText) relativeLayout.findViewById(1057292289)).setOnEditorActionListener(new C07783(this));
