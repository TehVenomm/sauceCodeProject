...
final class C0748a {
    ...
    interface C0744a {
        void onCameraFrame(C0748a c0748a, byte[] bArr);
    }

    /* renamed from: com.unity3d.player.a$2 */
    final class C07472 extends C0746b {
        /* renamed from: a */
        Camera f486a = this.f487b.f488a;
        /* renamed from: b */
        final /* synthetic */ C0748a f487b;

        C07472(C0748a c0748a) {
            this.f487b = c0748a;
            super(3);
        }
        ...
        public final void surfaceCreated(SurfaceHolder surfaceHolder) {
            synchronized (this.f487b.f494g) {
                ...
                try {
                    ...
                    C0768m.Log(6, "Unable to initialize webcam data stream: " + e.getMessage());
                }
            }
        }
    ...
    public C0748a(int i, int i2, int i3, int i4) {
        this.f495h = i;
        this.f496i = C0748a.m463a(i2, ImageUtil.SCALE_DOWN_SIZE);
        this.f497j = C0748a.m463a(i3, ImageUtil.THUMBNAIL_MAX_SIZE);
        this.f498k = C0748a.m463a(i4, 24);
    }
    ...
    /* renamed from: b */
    private void m466b(final C0744a c0744a) {
        synchronized (this.f494g) {
            ...
            PreviewCallback c07451 = new PreviewCallback(this) {
                /* renamed from: a */
                long f480a = 0;
                /* renamed from: c */
                final /* synthetic */ C0748a f482c;

                public final void onPreviewFrame(byte[] bArr, Camera camera) {
                    if (this.f482c.f488a == camera) {
                        c0744a.onCameraFrame(this.f482c, bArr);
                    }
                }
            };
            ...
            this.f488a.addCallbackBuffer(new byte[i]);
            this.f488a.setPreviewCallbackWithBuffer(c07451);
        }
    }
    ...
    /* renamed from: a */
    public final void m471a(com.unity3d.player.C0748a.C0744a r4) {
        /*
        r3 = this;
        r1 = r3.f494g;
        monitor-enter(r1);
    ...
    L_0x000a:
        r0 = com.unity3d.player.C0774q.f535a;	 Catch:{ all -> 0x0031 }
        if (r0 == 0) goto L_0x001f;
    L_0x000e:
        r0 = com.unity3d.player.C0774q.f543i;	 Catch:{ all -> 0x0031 }
