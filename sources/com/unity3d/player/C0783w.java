...
public final class C0783w extends FrameLayout implements OnBufferingUpdateListener, OnCompletionListener, OnPreparedListener, OnVideoSizeChangedListener, Callback, MediaPlayerControl {
    /* renamed from: a */
    ...
    final class C07821 implements Runnable {
        /* renamed from: a */
        final /* synthetic */ C0783w f575a;

        C07821(C0783w c0783w) {
            this.f575a = c0783w;
        }
    ...
    protected C0783w(UnityPlayer unityPlayer, Context context, String str, int i, int i2, int i3, boolean z, long j, long j2) {
        super(context);
        ...
        this.f586k = j2;
        if (f576a) {
            C0783w.m555a("fileName: " + this.f581f);
        }
        if (f576a) {
            C0783w.m555a("backgroundColor: " + i);
        }
        if (f576a) {
            C0783w.m555a("controlMode: " + this.f582g);
        }
        if (f576a) {
            C0783w.m555a("scalingMode: " + this.f583h);
        }
        if (f576a) {
            C0783w.m555a("isURL: " + this.f584i);
        }
        if (f576a) {
            C0783w.m555a("videoOffset: " + this.f585j);
        }
        if (f576a) {
            C0783w.m555a("videoLength: " + this.f586k);
        }
        setFocusable(true);
    ...
    private void m554a() {
        ...
        try {
            ...
            if (f576a) {
                C0783w.m555a("error: " + e2.getMessage() + e2);
            }
            onDestroy();
        }
    }
    ...
    private void m556b() {
        if (!isPlaying()) {
            if (f576a) {
                C0783w.m555a("startVideoPlayback");
            }
            updateVideoLayout();
            if (!this.f598w) {
                start();
    ...
    public final void onBufferingUpdate(MediaPlayer mediaPlayer, int i) {
        if (f576a) {
            C0783w.m555a("onBufferingUpdate percent:" + i);
        }
        this.f597v = i;
    }
    ...
    public final void onCompletion(MediaPlayer mediaPlayer) {
        if (f576a) {
            C0783w.m555a("onCompletion called");
        }
        onDestroy();
    }
    ...
    protected final void onDestroy() {
        onPause();
        doCleanUp();
        UnityPlayer.m426a(new C07821(this));
    }
    ...
    public final void onPrepared(MediaPlayer mediaPlayer) {
        if (f576a) {
            C0783w.m555a("onPrepared called");
        }
        this.f596u = true;
    ...
    public final void onVideoSizeChanged(MediaPlayer mediaPlayer, int i, int i2) {
        if (f576a) {
            C0783w.m555a("onVideoSizeChanged called " + i + "x" + i2);
        }
        if (i != 0 && i2 != 0) {
            this.f595t = true;
            this.f591p = i;
            ...
            C0783w.m555a("invalid video width(" + i + ") or height(" + i2 + ")");
        }
    }
    ...
    public final void surfaceChanged(SurfaceHolder surfaceHolder, int i, int i2, int i3) {
        if (f576a) {
            C0783w.m555a("surfaceChanged called " + i + " " + i2 + "x" + i3);
        }
    ...
    public final void surfaceCreated(SurfaceHolder surfaceHolder) {
        if (f576a) {
            C0783w.m555a("surfaceCreated called");
        }
        m554a();
        seekTo(this.f599x);
    }
    ...
    public final void surfaceDestroyed(SurfaceHolder surfaceHolder) {
        if (f576a) {
            C0783w.m555a("surfaceDestroyed called");
        }
        doCleanUp();
    }
    ...
    protected final void updateVideoLayout() {
        if (f576a) {
            C0783w.m555a("updateVideoLayout");
        }
        ...
        if (f576a) {
            C0783w.m555a("frameWidth = " + i + "; frameHeight = " + i2);
        }
