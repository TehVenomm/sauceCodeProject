...
public final class C0769n implements C0758i {
    /* renamed from: a */
    ...
    public final void mo4203a(Activity activity, final Runnable runnable) {
        if (activity != null) {
            ...
            try {
                ...
                if (C0769n.m506a(activityInfo) || C0769n.m506a(applicationInfo)) {
                    runnable.run();
                    return;
                }
            } catch (Exception e) {
            ...
            try {
                ...
                for (String str : packageInfo.requestedPermissions) {
                    try {
                        ...
                        C0767m.Log(5, "Failed to get permission info for " + str + ", manifest likely missing custom permission declaration");
                        C0767m.Log(5, "Permission " + str + " ignored");
                    }
                }
                ...
                Fragment c07681 = new Fragment(this) {
                    /* renamed from: d */
                    final /* synthetic */ C0769n f529d;

                    public final void onRequestPermissionsResult(int i, String[] strArr, int[] iArr) {
                        if (i == 15881) {
                            int i2 = 0;
                            while (i2 < strArr.length && i2 < iArr.length) {
                                C0767m.Log(4, strArr[i2] + (iArr[i2] == 0 ? " granted" : " denied"));
                                i2++;
                            }
                ...
                FragmentTransaction beginTransaction = fragmentManager.beginTransaction();
                beginTransaction.add(0, c07681);
                beginTransaction.commit();
            } catch (Exception e3) {
                C0767m.Log(6, "Unable to query for permission: " + e3.getMessage());
            }
        }
    }
}
