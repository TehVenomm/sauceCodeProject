...
public final class C0772p implements C0759j {
    /* renamed from: a */
    private final Queue f532a = new ConcurrentLinkedQueue();
    /* renamed from: b */
    private final Activity f533b;
    /* renamed from: c */
    private Runnable f534c = new C07711(this);

    /* renamed from: com.unity3d.player.p$1 */
    final class C07711 implements Runnable {
        /* renamed from: a */
        final /* synthetic */ C0772p f531a;

        C07711(C0772p c0772p) {
            this.f531a = c0772p;
        }
        ...
        private static void m510a(View view, MotionEvent motionEvent) {
            if (C0773q.f536b) {
                C0773q.f544j.mo4193a(view, motionEvent);
            }
        }
                    ...
                    if ((source & 2) != 0) {
                        switch (motionEvent.getAction() & 255) {
                            ...
                            case 6:
                                ...
                                break;
                            default:
                                C07711.m510a(decorView, motionEvent);
                                break;
                        }
                    } else if ((source & 4) != 0) {
    ...
    public C0772p(ContextWrapper contextWrapper) {
    ...
    private static PointerCoords[] m513a(int i, float[] fArr) {
        ...
        C0772p.m511a(pointerCoordsArr, fArr, 0);
    ...
    public final void mo4204a(long j, long j2, int i, int i2, int[] iArr, float[] fArr, int i3, float f, float f2, int i4, int i5, int i6, int i7, int i8, long[] jArr, float[] fArr2) {
        if (this.f533b != null) {
            MotionEvent obtain = MotionEvent.obtain(j, j2, i, i2, iArr, C0772p.m513a(i2, fArr), i3, f, f2, i4, i5, i6, i7);
            int i9 = 0;
            for (int i10 = 0; i10 < i8; i10++) {
                PointerCoords[] pointerCoordsArr = new PointerCoords[i2];
                i9 = C0772p.m511a(pointerCoordsArr, fArr2, i9);
