...
class AdvertisingInfoReflectionStrategy implements AdvertisingInfoStrategy {
    ...
    boolean isGooglePlayServiceAvailable(Context context) {
        try {
            return ((Integer) Class.forName(CLASS_NAME_GOOGLE_PLAY_SERVICES_UTILS).getMethod(METHOD_NAME_IS_GOOGLE_PLAY_SERVICES_AVAILABLE, new Class[]{Context.class}).invoke(null, new Object[]{context})).intValue() == 0;
        } catch (Exception e) {
            return false;
        }
    }
