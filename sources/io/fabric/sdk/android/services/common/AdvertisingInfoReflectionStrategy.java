...
class AdvertisingInfoReflectionStrategy implements AdvertisingInfoStrategy {
    ...
    private String getAdvertisingId() {
        try {
            ...
            Fabric.getLogger().mo20982w(Fabric.TAG, "Could not call getId on com.google.android.gms.ads.identifier.AdvertisingIdClient$Info");
            return null;
        }
    }
    ...
    private Object getInfo() {
        ...
        try {
            ...
            Fabric.getLogger().mo20982w(Fabric.TAG, "Could not call getAdvertisingIdInfo on com.google.android.gms.ads.identifier.AdvertisingIdClient");
            return z;
        }
    }
    ...
    private boolean isLimitAdTrackingEnabled() {
        try {
            ...
            Fabric.getLogger().mo20982w(Fabric.TAG, "Could not call isLimitAdTrackingEnabled on com.google.android.gms.ads.identifier.AdvertisingIdClient$Info");
            return false;
        }
    }
    ...
    public boolean isGooglePlayServiceAvailable(Context context2) {
        try {
            return ((Integer) Class.forName(CLASS_NAME_GOOGLE_PLAY_SERVICES_UTILS).getMethod(METHOD_NAME_IS_GOOGLE_PLAY_SERVICES_AVAILABLE, new Class[]{Context.class}).invoke(null, new Object[]{context2})).intValue() == 0;
        } catch (Exception e) {
            return false;
        }
    }
