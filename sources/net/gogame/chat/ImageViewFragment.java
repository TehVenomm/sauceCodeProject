...
public class ImageViewFragment extends Fragment {
    ...
    public View onCreateView(LayoutInflater layoutInflater, ViewGroup viewGroup, Bundle bundle) {
        View inflate = layoutInflater.inflate(C1122R.C1126layout.net_gogame_chat_fragment_image_view, viewGroup, false);
        ZoomableImageView zoomableImageView = (ZoomableImageView) inflate.findViewById(C1122R.C1125id.imageView);
        final ProgressBar progressBar = (ProgressBar) inflate.findViewById(C1122R.C1125id.progressBar);
