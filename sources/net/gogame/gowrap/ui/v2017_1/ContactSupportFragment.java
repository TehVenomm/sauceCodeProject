...
public class ContactSupportFragment extends Fragment implements VipListener {
    ...
    public View onCreateView(LayoutInflater layoutInflater, ViewGroup viewGroup, Bundle bundle) {
        UIContext uIContext;
        View inflate = layoutInflater.inflate(C1426R.layout.net_gogame_gowrap_fragment_contact_support, viewGroup, false);
        ...
        inflate.findViewById(C1426R.id.net_gogame_gowrap_support_form_button).setOnClickListener(new OnClickListener() {
        ...
        this.chatButton = (SupportCustomImageButton) inflate.findViewById(C1426R.id.net_gogame_gowrap_support_chat_button);
