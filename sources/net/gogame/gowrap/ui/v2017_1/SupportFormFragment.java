...
public class SupportFormFragment extends Fragment {
    ...
    class C12106 implements OnClickListener {
        C12106() {
        }
        ...
        public void onClick(View view) {
            ...
            SupportFormFragment.this.startActivityForResult(Intent.createChooser(intent, SupportFormFragment.this.context.getResources().getString(C1110R.string.net_gogame_gowrap_support_form_select_picture_prompt)), 5001);
        }
    }

    /* renamed from: net.gogame.gowrap.ui.v2017_1.SupportFormFragment$7 */
    class C12117 implements OnClickListener {
        C12117() {
        }
        ...
        public void onClick(View view) {
            ...
            SupportFormFragment.this.attachmentView.setText(C1110R.string.net_gogame_gowrap_support_form_attachment_no_file_caption);
        }
    }
    ...
    private class SubmitSupportRequestTask extends AsyncTask<SupportRequest, Void, Void> {
        ...
        class C12131 implements Listener {
            C12131() {
            }
        ...
        protected void onPreExecute() {
            this.progressDialog = CustomDialog.newBuilder(SupportFormFragment.this.context).withType(Type.PROGRESS).withTitle(C1110R.string.net_gogame_gowrap_support_form_title).withMessage(C1110R.string.net_gogame_gowrap_support_form_submitting_request_message).build();
        ...
        protected void onPostExecute(Void voidR) {
            ...
            if (this.successful) {
                CustomDialog.newBuilder(SupportFormFragment.this.context).withType(Type.INFO).withTitle(C1110R.string.net_gogame_gowrap_support_form_title).withMessage(C1110R.string.net_gogame_gowrap_support_form_request_submitted_message).withListener(new C12131()).build().show();
            } else {
                CustomDialog.newBuilder(SupportFormFragment.this.context).withType(Type.ALERT).withTitle(C1110R.string.net_gogame_gowrap_support_form_title).withMessage(C1110R.string.net_gogame_gowrap_support_form_request_failed_message).build().show();
            }
        }
    }
    ...
    public View onCreateView(LayoutInflater layoutInflater, ViewGroup viewGroup, Bundle bundle) {
        View inflate = layoutInflater.inflate(C1110R.layout.net_gogame_gowrap_fragment_support_form, viewGroup, false);
        this.context = viewGroup.getContext();
        if (getActivity() instanceof UIContext) {
            this.uiContext = (UIContext) getActivity();
        }
        inflate.findViewById(C1110R.id.net_gogame_gowrap_back_button).setOnClickListener(new C12051());
        boolean isEquals = StringUtils.isEquals(CoreSupport.INSTANCE.getAppId(), "DisneyCrossyRoad-PH-Globe");
        View findViewById = inflate.findViewById(C1110R.id.net_gogame_gowrap_support_form_group_mobile_number);
        if (isEquals) {
            findViewById.setVisibility(0);
        } else {
            findViewById.setVisibility(8);
        }
        final EditText editText = (EditText) inflate.findViewById(C1110R.id.net_gogame_gowrap_support_form_field_name);
        final EditText editText2 = (EditText) inflate.findViewById(C1110R.id.net_gogame_gowrap_support_form_field_email);
        final EditText editText3 = (EditText) inflate.findViewById(C1110R.id.net_gogame_gowrap_support_form_field_mobile_number);
        TextView textView = (TextView) inflate.findViewById(C1110R.id.net_gogame_gowrap_support_form_field_category);
        final EditText editText4 = (EditText) inflate.findViewById(C1110R.id.net_gogame_gowrap_support_form_field_body);
        this.attachmentView = (TextView) inflate.findViewById(C1110R.id.net_gogame_gowrap_support_form_field_attachment);
        this.removeAttachmentView = inflate.findViewById(C1110R.id.net_gogame_gowrap_support_form_field_remove_attachment);
        final View findViewById2 = inflate.findViewById(C1110R.id.net_gogame_gowrap_support_form_button_send);
        ...
        ListAdapter arrayAdapter = new ArrayAdapter(this.context, C1110R.layout.net_gogame_gowrap_default_listview_item, C1110R.id.net_gogame_gowrap_text_view, arrayList);
        final SupportRequestCollector c12062 = new SupportRequestCollector() {
        ...
        TextWatcher c12073 = new TextWatcher() {
            ...
            public void afterTextChanged(Editable editable) {
                findViewById2.setSelected(SupportManager.isValid(c12062.collect()));
            }
        };
        editText.addTextChangedListener(c12073);
        editText2.addTextChangedListener(c12073);
        editText4.addTextChangedListener(c12073);
        View inflate2 = getActivity().getLayoutInflater().inflate(C1110R.layout.net_gogame_gowrap_default_listview, null, false);
        final ListView listView = (ListView) inflate2.findViewById(C1110R.id.net_gogame_gowrap_list_view);
        listView.setAdapter(arrayAdapter);
        final Dialog dialog = new Dialog(getActivity(), C1110R.style.net_gogame_gowrap_dialog);
        dialog.setCanceledOnTouchOutside(true);
        dialog.setContentView(inflate2);
        final ListAdapter listAdapter = arrayAdapter;
        final TextView textView2 = textView;
        final SupportRequestCollector supportRequestCollector = c12062;
        ...
        this.attachmentView.setOnClickListener(new C12106());
        this.removeAttachmentView.setOnClickListener(new C12117());
        findViewById2.setSelected(false);
        findViewById2.setOnClickListener(new OnClickListener() {
            public void onClick(View view) {
                SupportRequest collect = c12062.collect();
                ...
                findViewById2.setSelected(false);
                CustomDialog.newBuilder(SupportFormFragment.this.getActivity()).withType(Type.ALERT).withTitle(C1110R.string.net_gogame_gowrap_support_form_title).withMessage(C1110R.string.net_gogame_gowrap_support_form_invalid_message).withCanceledOnTouchOutside(true).build().show();
            }
        });
        return inflate;
    }
