...
public final class C1398i extends C1359a {
    ...
    private View m856a(int i, View view) {
        int i2 = 0;
        if (view == 0) {
            r11 = new LinearLayout(this.f993a);
        ...
        bvVar.f1274c = i;
        bvVar.f1273b.setText(((C1365a) getItem(bvVar.f1274c)).getDisplayName());
        bvVar.f1272a.setVisibility(4);
        C1415m.m927b(mo21498a(), ((C1365a) getItem(bvVar.f1274c)).getDisplayIcon(), new C1627j(this, bvVar, i));
        return view;
    }
    ...
    private View m857b(int i, View view) {
        if (view == 0) {
            r10 = new RelativeLayout(this.f993a);
        ...
        bvVar.f1273b.setText(((C1365a) getItem(bvVar.f1274c)).getDisplayName());
        bvVar.f1272a.setVisibility(4);
        C1415m.m927b(mo21498a(), ((C1365a) getItem(bvVar.f1274c)).getDisplayIcon(), new C1628k(this, bvVar, i));
        return view;
    }

    public final View getDropDownView(int i, View view, ViewGroup viewGroup) {
        return this.f1110d == 1 ? m856a(i, view) : m857b(i, view);
    }
