...
public interface IOpenInAppBillingService extends IInterface {

    public static abstract class Stub extends Binder implements IOpenInAppBillingService {
        ...
        private static class Proxy implements IOpenInAppBillingService {
        ...
        public static IOpenInAppBillingService asInterface(IBinder iBinder) {
            if (iBinder == null) {
                return null;
            }
            IInterface queryLocalInterface = iBinder.queryLocalInterface(DESCRIPTOR);
            return (queryLocalInterface == null || !(queryLocalInterface instanceof IOpenInAppBillingService)) ? new Proxy(iBinder) : (IOpenInAppBillingService) queryLocalInterface;
        }
