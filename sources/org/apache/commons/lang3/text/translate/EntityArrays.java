...
public class EntityArrays {
    ...
    static {
        ...
        r0[DisplaySupport.SCREEN_DENSITY_LOW] = new String[]{"♣", "&clubs;"};
        r0[121] = new String[]{"♥", "&hearts;"};
        r0[122] = new String[]{"♦", "&diams;"};
        r0[123] = new String[]{"Œ", "&OElig;"};
        r0[MetadataChangeSet.CUSTOM_PROPERTY_SIZE_LIMIT_BYTES] = new String[]{"œ", "&oelig;"};
        r0[125] = new String[]{"Š", "&Scaron;"};
        r0[TransportMediator.KEYCODE_MEDIA_PLAY] = new String[]{"š", "&scaron;"};
        r0[TransportMediator.KEYCODE_MEDIA_PAUSE] = new String[]{"Ÿ", "&Yuml;"};
        r0[128] = new String[]{"ˆ", "&circ;"};
        r0[129] = new String[]{"˜", "&tilde;"};
        r0[TransportMediator.KEYCODE_MEDIA_RECORD] = new String[]{" ", "&ensp;"};
        ...
        r0 = new String[5][];
        r0[0] = new String[]{"\b", "\\b"};
        r0[1] = new String[]{StringUtils.LF, "\\n"};
        r0[2] = new String[]{"\t", "\\t"};
        r0[3] = new String[]{"\f", "\\f"};
