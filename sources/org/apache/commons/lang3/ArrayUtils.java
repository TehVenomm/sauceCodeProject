...
public class ArrayUtils {
    ...
    public static <T> T[] removeElements(T[] tArr, T... tArr2) {
        ...
        for (Entry entry : hashMap.entrySet()) {
            ...
            for (int i2 = 0; i2 < intValue; i2++) {
                int indexOf = indexOf((Object[]) tArr, key, i);
                if (indexOf < 0) {
                    break;
                }
                i = indexOf + 1;
    ...
    public static byte[] removeElements(byte[] bArr, byte... bArr2) {
        ...
        for (Entry entry : hashMap.entrySet()) {
            ...
            int i = 0;
            for (int i2 = 0; i2 < intValue; i2++) {
                int indexOf = indexOf(bArr, b.byteValue(), i);
                if (indexOf < 0) {
                    break;
                }
                i = indexOf + 1;
    ...
    public static short[] removeElements(short[] sArr, short... sArr2) {
        ...
        for (Entry entry : hashMap.entrySet()) {
            ...
            int i = 0;
            for (int i2 = 0; i2 < intValue; i2++) {
                int indexOf = indexOf(sArr, sh.shortValue(), i);
                if (indexOf < 0) {
                    break;
                }
                i = indexOf + 1;
    ...
    public static int[] removeElements(int[] iArr, int... iArr2) {
        ...
        for (Entry entry : hashMap.entrySet()) {
            ...
            int i = 0;
            for (int i2 = 0; i2 < intValue; i2++) {
                int indexOf = indexOf(iArr, num.intValue(), i);
                if (indexOf < 0) {
                    break;
                }
                i = indexOf + 1;
    ...
    public static char[] removeElements(char[] cArr, char... cArr2) {
        ...
        for (Entry entry : hashMap.entrySet()) {
            ...
            int i = 0;
            for (int i2 = 0; i2 < intValue; i2++) {
                int indexOf = indexOf(cArr, ch.charValue(), i);
                if (indexOf < 0) {
                    break;
                }
                i = indexOf + 1;
    ...
    public static long[] removeElements(long[] jArr, long... jArr2) {
        ...
        for (Entry entry : hashMap.entrySet()) {
            ...
            int i = 0;
            for (int i2 = 0; i2 < intValue; i2++) {
                int indexOf = indexOf(jArr, l.longValue(), i);
                if (indexOf < 0) {
                    break;
                }
                i = indexOf + 1;
    ...
    public static float[] removeElements(float[] fArr, float... fArr2) {
        ...
        for (Entry entry : hashMap.entrySet()) {
            ...
            int i = 0;
            for (int i2 = 0; i2 < intValue; i2++) {
                int indexOf = indexOf(fArr, f.floatValue(), i);
                if (indexOf < 0) {
                    break;
                }
                i = indexOf + 1;
    ...
    public static double[] removeElements(double[] dArr, double... dArr2) {
        ...
        for (Entry entry : hashMap.entrySet()) {
            ...
            int i = 0;
            for (int i2 = 0; i2 < intValue; i2++) {
                int indexOf = indexOf(dArr, d.doubleValue(), i);
                if (indexOf < 0) {
                    break;
                }
                i = indexOf + 1;
    ...
    public static boolean[] removeElements(boolean[] zArr, boolean... zArr2) {
        ...
        for (Entry entry : hashMap.entrySet()) {
            ...
            int i = 0;
            for (int i2 = 0; i2 < intValue; i2++) {
                int indexOf = indexOf(zArr, bool.booleanValue(), i);
                if (indexOf < 0) {
                    break;
                }
                i = indexOf + 1;
