...
public class Conversion {
    ...
    public static char binaryBeMsb0ToHexDigit(boolean[] zArr, int i) {
        ...
        System.arraycopy(zArr, (length + 1) - min, obj, 4 - min, min);
        if (!obj[0]) {
            return (obj.length <= 1 || !obj[1]) ? (obj.length <= 2 || !obj[2]) ? (obj.length <= 3 || !obj[3]) ? '0' : '1' : (obj.length <= 3 || !obj[3]) ? '2' : '3' : (obj.length <= 2 || !obj[2]) ? (obj.length <= 3 || !obj[3]) ? '4' : '5' : (obj.length <= 3 || !obj[3]) ? '6' : '7';
        } else {
            if (obj.length <= 1 || !obj[1]) {
                return (obj.length <= 2 || !obj[2]) ? (obj.length <= 3 || !obj[3]) ? '8' : '9' : (obj.length <= 3 || !obj[3]) ? 'a' : 'b';
            } else {
                if (obj.length <= 2 || !obj[2]) {
                    return (obj.length <= 3 || !obj[3]) ? 'c' : 'd';
                } else {
    ...
    public static long intArrayToLong(int[] iArr, int i, long j, int i2, int i3) {
        if (!((iArr.length == 0 && i == 0) || i3 == 0)) {
            ...
            for (int i4 = 0; i4 < i3; i4++) {
                int i5 = (i4 * 32) + i2;
                j = (((4294967295L << i5) ^ -1) & j) | ((((long) iArr[i4 + i]) & 4294967295L) << i5);
            }
        }
        return j;
    }
    ...
    public static String longToHex(long j, int i, String str, int i2, int i3) {
        ...
        for (int i4 = 0; i4 < i3; i4++) {
            ...
            if (i2 + i4 == length) {
                ...
                stringBuilder.setCharAt(i2 + i4, intToHexDigit(i5));
            }
        }
    ...
    public static String intToHex(int i, int i2, String str, int i3, int i4) {
        ...
        for (int i5 = 0; i5 < i4; i5++) {
            ...
            if (i3 + i5 == length) {
                ...
                stringBuilder.setCharAt(i3 + i5, intToHexDigit(i6));
            }
        }
        return stringBuilder.toString();
    }
