...
public class EventUtils {
    ...
    public static <L> void addEventListener(Object obj, Class<L> cls, L l) {
        try {
            ...
            throw new IllegalArgumentException("Class " + obj.getClass().getName() + " does not have a public add" + cls.getSimpleName() + " method which takes a parameter of type " + cls.getName() + AbstractIntegrationSupport.DEFAULT_EVENT_NAME_DELIMITER);
        } catch (IllegalAccessException e2) {
            throw new IllegalArgumentException("Class " + obj.getClass().getName() + " does not have an accessible add" + cls.getSimpleName() + " method which takes a parameter of type " + cls.getName() + AbstractIntegrationSupport.DEFAULT_EVENT_NAME_DELIMITER);
