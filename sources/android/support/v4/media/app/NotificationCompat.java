...
public class NotificationCompat {
    ...
    public static class DecoratedMediaCustomViewStyle extends MediaStyle {
        private void setBackgroundColor(RemoteViews remoteViews) {
            remoteViews.setInt(C0048R.C0050id.status_bar_latest_event_content, "setBackgroundColor", this.mBuilder.getColor() != 0 ? this.mBuilder.getColor() : this.mBuilder.mContext.getResources().getColor(C0048R.color.notification_material_background_media_default_color));
        }
        ...
        public int getBigContentViewLayoutResource(int i) {
            return i <= 3 ? C0048R.C0051layout.notification_template_big_media_narrow_custom : C0048R.C0051layout.notification_template_big_media_custom;
        }

        /* access modifiers changed from: 0000 */
        public int getContentViewLayoutResource() {
            return this.mBuilder.getContentView() != null ? C0048R.C0051layout.notification_template_media_custom : super.getContentViewLayoutResource();
        }
        ...
        public RemoteViews makeBigContentView(NotificationBuilderWithBuilderAccessor notificationBuilderWithBuilderAccessor) {
            ...
            if (VERSION.SDK_INT < 24) {
                RemoteViews contentView = this.mBuilder.getBigContentView() != null ? this.mBuilder.getBigContentView() : this.mBuilder.getContentView();
                if (contentView != null) {
        ...
        public RemoteViews makeHeadsUpContentView(NotificationBuilderWithBuilderAccessor notificationBuilderWithBuilderAccessor) {
            RemoteViews remoteViews = null;
            if (VERSION.SDK_INT < 24) {
                RemoteViews contentView = this.mBuilder.getHeadsUpContentView() != null ? this.mBuilder.getHeadsUpContentView() : this.mBuilder.getContentView();
                if (contentView != null) {
                    remoteViews = generateBigContentView();
                    buildIntoRemoteViews(remoteViews, contentView);
                    if (VERSION.SDK_INT >= 21) {
    ...
    public static class MediaStyle extends Style {
        ...
        private RemoteViews generateMediaActionButton(Action action) {
            ...
            RemoteViews remoteViews = new RemoteViews(this.mBuilder.mContext.getPackageName(), C0048R.C0051layout.notification_media_action);
            remoteViews.setImageViewResource(C0048R.C0050id.action0, action.getIcon());
            if (!z) {
                remoteViews.setOnClickPendingIntent(C0048R.C0050id.action0, action.getActionIntent());
            }
            if (VERSION.SDK_INT >= 15) {
                remoteViews.setContentDescription(C0048R.C0050id.action0, action.getTitle());
            }
            return remoteViews;
        }
        ...
        public RemoteViews generateBigContentView() {
            ...
            applyStandardTemplate.removeAllViews(C0048R.C0050id.media_actions);
            if (min > 0) {
                for (int i = 0; i < min; i++) {
                    applyStandardTemplate.addView(C0048R.C0050id.media_actions, generateMediaActionButton((Action) this.mBuilder.mActions.get(i)));
                }
            }
            if (this.mShowCancelButton) {
                applyStandardTemplate.setViewVisibility(C0048R.C0050id.cancel_action, 0);
                applyStandardTemplate.setInt(C0048R.C0050id.cancel_action, "setAlpha", this.mBuilder.mContext.getResources().getInteger(C0048R.integer.cancel_button_image_alpha));
                applyStandardTemplate.setOnClickPendingIntent(C0048R.C0050id.cancel_action, this.mCancelButtonIntent);
            } else {
                applyStandardTemplate.setViewVisibility(C0048R.C0050id.cancel_action, 8);
            }
        ...
        public RemoteViews generateContentView() {
            ...
            if (min > 0) {
                for (int i = 0; i < min; i++) {
                    ...
                    applyStandardTemplate.addView(C0048R.C0050id.media_actions, generateMediaActionButton((Action) this.mBuilder.mActions.get(this.mActionsToShowInCompact[i])));
                }
            }
            if (this.mShowCancelButton) {
                applyStandardTemplate.setViewVisibility(C0048R.C0050id.end_padder, 8);
                applyStandardTemplate.setViewVisibility(C0048R.C0050id.cancel_action, 0);
                applyStandardTemplate.setOnClickPendingIntent(C0048R.C0050id.cancel_action, this.mCancelButtonIntent);
                applyStandardTemplate.setInt(C0048R.C0050id.cancel_action, "setAlpha", this.mBuilder.mContext.getResources().getInteger(C0048R.integer.cancel_button_image_alpha));
            } else {
                applyStandardTemplate.setViewVisibility(C0048R.C0050id.end_padder, 0);
                applyStandardTemplate.setViewVisibility(C0048R.C0050id.cancel_action, 8);
            }
            return applyStandardTemplate;
        }
        ...
        /* access modifiers changed from: 0000 */
        public int getBigContentViewLayoutResource(int i) {
            return i <= 3 ? C0048R.C0051layout.notification_template_big_media_narrow : C0048R.C0051layout.notification_template_big_media;
        }

        /* access modifiers changed from: 0000 */
        public int getContentViewLayoutResource() {
            return C0048R.C0051layout.notification_template_media;
        }
