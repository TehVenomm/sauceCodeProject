...
final class FragmentManagerImpl extends FragmentManager implements LayoutInflaterFactory {
    ...
    int mCurState = 0;
    boolean mDestroyed;
    Runnable mExecCommit = new C00181();
            ...
            while (i2 < size) {
                ...
                if (((BackStackRecord) arrayList.get(i2)).mAllowOptimization) {
                    ...
                    if (((Boolean) arrayList2.get(i2)).booleanValue()) {
                        while (i < size && ((Boolean) arrayList2.get(i)).booleanValue() && !((BackStackRecord) arrayList.get(i)).mAllowOptimization) {
                            i++;
                        }
                    }
                    i3 = i;
    ...
    L_0x0418:
        ...
        r11.setStateAfterAnimating(r12);
        r1 = new android.support.v4.app.FragmentManagerImpl$2;
        r2 = r11.mView;
        r1.<init>(r2, r0, r11);
