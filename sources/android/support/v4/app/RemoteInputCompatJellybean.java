...
class RemoteInputCompatJellybean {
    ...
    static RemoteInput fromBundle(Bundle bundle, Factory factory) {
        return factory.build(bundle.getString(KEY_RESULT_KEY), bundle.getCharSequence("label"), bundle.getCharSequenceArray(KEY_CHOICES), bundle.getBoolean(KEY_ALLOW_FREE_FORM_INPUT), bundle.getBundle("extras"));
    }
