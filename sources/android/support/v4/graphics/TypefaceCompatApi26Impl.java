...
public class TypefaceCompatApi26Impl extends TypefaceCompatApi21Impl {
    ...
    static {
        ...
        try {
            ...
            method5 = cls.getMethod(FREEZE_METHOD, new Class[0]);
            method2 = cls.getMethod(ABORT_CREATION_METHOD, new Class[0]);
            method = Typeface.class.getDeclaredMethod(CREATE_FROM_FAMILIES_WITH_DEFAULT_METHOD, new Class[]{Array.newInstance(cls, 1).getClass(), Integer.TYPE, Integer.TYPE});
