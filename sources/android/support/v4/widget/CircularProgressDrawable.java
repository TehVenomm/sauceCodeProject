    ...
    public void applyTransformation(float f, Ring ring, boolean z) {
        ...
        if (this.mFinishing) {
            ...
            if (f < SHRINK_OFFSET) {
                ...
                interpolation = startingStartTrim - (((1.0f - MATERIAL_INTERPOLATOR.getInterpolation((f - SHRINK_OFFSET) / SHRINK_OFFSET)) * 0.79f) + MIN_PROGRESS_ARC);
            }
            ...
            setRotation(GROUP_FULL_ROTATION * (f3 + f));
        }
    }
