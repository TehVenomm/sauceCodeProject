...
public class AlertDialog extends AppCompatDialog implements DialogInterface {
    ...
    public static class Builder {
        ...
        /* renamed from: P */
        private final AlertParams f21P;
        ...
        public Builder(@NonNull Context context, @StyleRes int i) {
            this.f21P = new AlertParams(new ContextThemeWrapper(context, AlertDialog.resolveDialogTheme(context, i)));
            this.mTheme = i;
        }
        ...
        public Builder setAdapter(ListAdapter listAdapter, OnClickListener onClickListener) {
            this.f21P.mAdapter = listAdapter;
        ...
        public Builder setItems(@ArrayRes int i, OnClickListener onClickListener) {
            this.f21P.mItems = this.f21P.mContext.getResources().getTextArray(i);
            this.f21P.mOnClickListener = onClickListener;
            return this;
        }

        public Builder setItems(CharSequence[] charSequenceArr, OnClickListener onClickListener) {
            this.f21P.mItems = charSequenceArr;
            this.f21P.mOnClickListener = onClickListener;
            return this;
        }

        public Builder setMessage(@StringRes int i) {
            this.f21P.mMessage = this.f21P.mContext.getText(i);
            return this;
        }
        ...
        public Builder setMultiChoiceItems(@ArrayRes int i, boolean[] zArr, OnMultiChoiceClickListener onMultiChoiceClickListener) {
            this.f21P.mItems = this.f21P.mContext.getResources().getTextArray(i);
            this.f21P.mOnCheckboxClickListener = onMultiChoiceClickListener;
            this.f21P.mCheckedItems = zArr;
        ...
        public Builder setMultiChoiceItems(Cursor cursor, String str, String str2, OnMultiChoiceClickListener onMultiChoiceClickListener) {
            this.f21P.mCursor = cursor;
            this.f21P.mOnCheckboxClickListener = onMultiChoiceClickListener;
            this.f21P.mIsCheckedColumn = str;
            this.f21P.mLabelColumn = str2;
            this.f21P.mIsMultiChoice = true;
            return this;
        }
        ...
        public Builder setNegativeButton(@StringRes int i, OnClickListener onClickListener) {
            this.f21P.mNegativeButtonText = this.f21P.mContext.getText(i);
            this.f21P.mNegativeButtonListener = onClickListener;
            return this;
        }

        public Builder setNegativeButton(CharSequence charSequence, OnClickListener onClickListener) {
            this.f21P.mNegativeButtonText = charSequence;
            this.f21P.mNegativeButtonListener = onClickListener;
            return this;
        }

        public Builder setNeutralButton(@StringRes int i, OnClickListener onClickListener) {
            this.f21P.mNeutralButtonText = this.f21P.mContext.getText(i);
        ...
        public Builder setNeutralButton(CharSequence charSequence, OnClickListener onClickListener) {
            this.f21P.mNeutralButtonText = charSequence;
            this.f21P.mNeutralButtonListener = onClickListener;
            return this;
        }
        ...
        public Builder setPositiveButton(@StringRes int i, OnClickListener onClickListener) {
            this.f21P.mPositiveButtonText = this.f21P.mContext.getText(i);
            this.f21P.mPositiveButtonListener = onClickListener;
            return this;
        }

        public Builder setPositiveButton(CharSequence charSequence, OnClickListener onClickListener) {
            this.f21P.mPositiveButtonText = charSequence;
            this.f21P.mPositiveButtonListener = onClickListener;
            return this;
        }
        ...
        public Builder setTitle(@StringRes int i) {
            this.f21P.mTitle = this.f21P.mContext.getText(i);
            return this;
        }
        ...
        public Builder setView(View view, int i, int i2, int i3, int i4) {
            ...
            this.f21P.mViewSpacingLeft = i;
            this.f21P.mViewSpacingTop = i2;
            this.f21P.mViewSpacingRight = i3;
            this.f21P.mViewSpacingBottom = i4;
            return this;
        }
    ...
    static int resolveDialogTheme(@NonNull Context context, @StyleRes int i) {
        ...
        TypedValue typedValue = new TypedValue();
        context.getTheme().resolveAttribute(C0260R.attr.alertDialogTheme, typedValue, true);
