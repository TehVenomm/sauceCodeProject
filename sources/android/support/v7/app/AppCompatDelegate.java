...
public abstract class AppCompatDelegate {
    ...
    private static AppCompatDelegate create(Context context, Window window, AppCompatCallback appCompatCallback) {
        return VERSION.SDK_INT >= 24 ? new AppCompatDelegateImplN(context, window, appCompatCallback) : VERSION.SDK_INT >= 23 ? new AppCompatDelegateImplV23(context, window, appCompatCallback) : VERSION.SDK_INT >= 14 ? new AppCompatDelegateImplV14(context, window, appCompatCallback) : VERSION.SDK_INT >= 11 ? new AppCompatDelegateImplV11(context, window, appCompatCallback) : new AppCompatDelegateImplV9(context, window, appCompatCallback);
    }
