...
class TwilightManager {
    ...
    private Location getLastKnownLocation() {
        ...
        Location location2 = PermissionChecker.checkSelfPermission(this.mContext, "android.permission.ACCESS_COARSE_LOCATION") == 0 ? getLastKnownLocationForProvider("network") : null;
