...
class AlertController {
    ...
    public static class AlertParams {
        ...
        private void createListView(final AlertController alertController) {
            ...
            if (!this.mIsMultiChoice) {
                ...
                checkedItemAdapter = this.mCursor != null ? new SimpleCursorAdapter(this.mContext, i, this.mCursor, new String[]{this.mLabelColumn}, new int[]{16908308}) : this.mAdapter != null ? this.mAdapter : new CheckedItemAdapter(this.mContext, i, 16908308, this.mItems);
    ...
    public static class RecycleListView extends ListView {
        ...
        public RecycleListView(Context context, AttributeSet attributeSet) {
            ...
            TypedArray obtainStyledAttributes = context.obtainStyledAttributes(attributeSet, C0260R.styleable.RecycleListView);
            this.mPaddingBottomNoButtons = obtainStyledAttributes.getDimensionPixelOffset(C0260R.styleable.RecycleListView_paddingBottomNoButtons, -1);
            this.mPaddingTopNoTitle = obtainStyledAttributes.getDimensionPixelOffset(C0260R.styleable.RecycleListView_paddingTopNoTitle, -1);
        }
    ...
    public AlertController(Context context, AppCompatDialog appCompatDialog, Window window) {
        ...
        TypedArray obtainStyledAttributes = context.obtainStyledAttributes(null, C0260R.styleable.AlertDialog, C0260R.attr.alertDialogStyle, 0);
        this.mAlertDialogLayout = obtainStyledAttributes.getResourceId(C0260R.styleable.AlertDialog_android_layout, 0);
        this.mButtonPanelSideLayout = obtainStyledAttributes.getResourceId(C0260R.styleable.AlertDialog_buttonPanelSideLayout, 0);
        this.mListLayout = obtainStyledAttributes.getResourceId(C0260R.styleable.AlertDialog_listLayout, 0);
        this.mMultiChoiceItemLayout = obtainStyledAttributes.getResourceId(C0260R.styleable.AlertDialog_multiChoiceItemLayout, 0);
        this.mSingleChoiceItemLayout = obtainStyledAttributes.getResourceId(C0260R.styleable.AlertDialog_singleChoiceItemLayout, 0);
        this.mListItemLayout = obtainStyledAttributes.getResourceId(C0260R.styleable.AlertDialog_listItemLayout, 0);
        this.mShowTitle = obtainStyledAttributes.getBoolean(C0260R.styleable.AlertDialog_showTitle, true);
    ...
    private void setScrollIndicators(ViewGroup viewGroup, View view, int i, int i2) {
        ...
        final View findViewById = this.mWindow.findViewById(C0260R.C0263id.scrollIndicatorUp);
        View findViewById2 = this.mWindow.findViewById(C0260R.C0263id.scrollIndicatorDown);
    ...
    private void setupContent(ViewGroup viewGroup) {
        this.mScrollView = (NestedScrollView) this.mWindow.findViewById(C0260R.C0263id.scrollView);
    ...
    private void setupCustomContent(ViewGroup viewGroup) {
        ...
        if (z) {
            FrameLayout frameLayout = (FrameLayout) this.mWindow.findViewById(C0260R.C0263id.custom);
    ...
    private void setupTitle(ViewGroup viewGroup) {
        if (this.mCustomTitleView != null) {
            ...
            this.mWindow.findViewById(C0260R.C0263id.title_template).setVisibility(8);
            return;
        }
        ...
        this.mTitleView = (TextView) this.mWindow.findViewById(C0260R.C0263id.alertTitle);
    ...
    private void setupView() {
        View findViewById = this.mWindow.findViewById(C0260R.C0263id.parentPanel);
        View findViewById2 = findViewById.findViewById(C0260R.C0263id.topPanel);
        View findViewById3 = findViewById.findViewById(C0260R.C0263id.contentPanel);
        View findViewById4 = findViewById.findViewById(C0260R.C0263id.buttonPanel);
        ViewGroup viewGroup = (ViewGroup) findViewById.findViewById(C0260R.C0263id.customPanel);
        setupCustomContent(viewGroup);
        View findViewById5 = viewGroup.findViewById(C0260R.C0263id.topPanel);
        View findViewById6 = viewGroup.findViewById(C0260R.C0263id.contentPanel);
        View findViewById7 = viewGroup.findViewById(C0260R.C0263id.buttonPanel);
        ...
        if (!z3 && resolvePanel2 != null) {
            View findViewById8 = resolvePanel2.findViewById(C0260R.C0263id.textSpacerNoButtons);
        ...
        if (z2) {
            ...
            if (!(this.mMessage == null && this.mListView == null)) {
                view = resolvePanel.findViewById(C0260R.C0263id.titleDividerNoCustom);
            }
            if (view != null) {
                view.setVisibility(0);
            }
        } else if (resolvePanel2 != null) {
            View findViewById9 = resolvePanel2.findViewById(C0260R.C0263id.textSpacerNoTitle);
        ...
        if (!z) {
            ...
            if (view2 != null) {
                setScrollIndicators(resolvePanel2, view2, (z3 ? 2 : 0) | (z2 ? 1 : 0), 3);
            }
        }
    ...
    private static boolean shouldCenterSingleButton(Context context) {
        ...
        context.getTheme().resolveAttribute(C0260R.attr.alertDialogCenterButtons, typedValue, true);
