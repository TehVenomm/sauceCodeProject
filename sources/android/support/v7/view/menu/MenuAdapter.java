...
public class MenuAdapter extends BaseAdapter {
    static final int ITEM_LAYOUT = C0260R.C0264layout.abc_popup_menu_item_layout;
    ...
    public View getView(int i, View view, ViewGroup viewGroup) {
        View view2 = view == null ? this.mInflater.inflate(ITEM_LAYOUT, viewGroup, false) : view;
