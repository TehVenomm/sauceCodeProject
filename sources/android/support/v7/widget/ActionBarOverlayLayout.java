...
public class ActionBarOverlayLayout extends ViewGroup implements DecorContentParent, NestedScrollingParent {
    static final int[] ATTRS = {C0260R.attr.actionBarSize, 16842841};
    ...
    public void draw(Canvas canvas) {
        ...
        if (this.mWindowContentOverlay != null && !this.mIgnoreWindowContentOverlay) {
            int i = this.mActionBarTop.getVisibility() == 0 ? (int) (((float) this.mActionBarTop.getBottom()) + this.mActionBarTop.getTranslationY() + 0.5f) : 0;
    ...
    public void pullChildren() {
        if (this.mContent == null) {
            this.mContent = (ContentFrameLayout) findViewById(C0260R.C0263id.action_bar_activity_content);
            this.mActionBarTop = (ActionBarContainer) findViewById(C0260R.C0263id.action_bar_container);
            this.mDecorToolbar = getDecorToolbar(findViewById(C0260R.C0263id.action_bar));
        }
    }
