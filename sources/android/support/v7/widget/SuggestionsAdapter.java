...
class SuggestionsAdapter extends ResourceCursorAdapter implements OnClickListener {
    ...
    private static final class ChildViewCache {
        ...
        public ChildViewCache(View view) {
            ...
            this.mIconRefine = (ImageView) view.findViewById(C0260R.C0263id.edit_query);
        }
    }
    ...
    private CharSequence formatUrl(CharSequence charSequence) {
        if (this.mUrlColor == null) {
            ...
            this.mContext.getTheme().resolveAttribute(C0260R.attr.textColorSearchUrl, typedValue, true);
    ...
    private Drawable getDrawableFromResourceValue(String str) {
        ...
        try {
            ...
            String str2 = "android.resource://" + this.mProviderContext.getPackageName() + Constants.URL_PATH_DELIMITER + parseInt;
    ...
    public void bindView(View view, Context context, Cursor cursor) {
        ...
        if (childViewCache.mText2 != null) {
            ...
            CharSequence stringOrNull2 = stringOrNull != null ? formatUrl(stringOrNull) : getStringOrNull(cursor, this.mText2Col);
    ...
    public View newView(Context context, Cursor cursor, ViewGroup viewGroup) {
        ...
        ((ImageView) newView.findViewById(C0260R.C0263id.edit_query)).setImageResource(this.mCommitIconResId);
        return newView;
    }
