...
namespace UnityStandardAssets.ImageEffects
{
	...
	public class BloomAndFlares : PostEffectsBase
	{
		...
		private void OnRenderImage(RenderTexture source, RenderTexture destination)
		{
			...
			RenderTexture temporary = RenderTexture.GetTemporary(source.get_width() / 2, source.get_height() / 2, 0, val);
			RenderTexture temporary2 = RenderTexture.GetTemporary(source.get_width() / 4, source.get_height() / 4, 0, val);
			RenderTexture temporary3 = RenderTexture.GetTemporary(source.get_width() / 4, source.get_height() / 4, 0, val);
			RenderTexture temporary4 = RenderTexture.GetTemporary(source.get_width() / 4, source.get_height() / 4, 0, val);
			...
			for (int i = 0; i < bloomBlurIterations; i++)
			{
				...
				Graphics.Blit(val2, temporary4, separableBlurMaterial);
			...
			Graphics.Blit(temporary2, destination, screenBlend, (int)bloomScreenBlendMode);
