	...
	public class NoiseAndGrain : PostEffectsBase
	{
		...
		private void OnRenderImage(RenderTexture source, RenderTexture destination)
		{
			...
			if (dx11Grain && supportDX11)
			{
				...
				{
					RenderTexture temporary = RenderTexture.GetTemporary((int)((float)source.get_width() * (1f - softness)), (int)((float)source.get_height() * (1f - softness)));
			...
			if (softness > Mathf.Epsilon)
			{
				RenderTexture temporary2 = RenderTexture.GetTemporary((int)((float)source.get_width() * (1f - softness)), (int)((float)source.get_height() * (1f - softness)));
