	...
	internal class GlobalFog : PostEffectsBase
	{
		...
		private void OnRenderImage(RenderTexture source, RenderTexture destination)
		{
			...
			else
			{
				...
				Transform val = component.get_transform();
				...
				Vector3 val2 = val.get_right() * nearClipPlane * Mathf.Tan(num * 0.0174532924f) * aspect;
				Vector3 val3 = val.get_up() * nearClipPlane * Mathf.Tan(num * 0.0174532924f);
				Vector3 val4 = val.get_forward() * nearClipPlane - val2 + val3;
				float num2 = val4.get_magnitude() * farClipPlane / nearClipPlane;
				val4.Normalize();
				val4 *= num2;
				Vector3 val5 = val.get_forward() * nearClipPlane + val2 + val3;
				val5.Normalize();
				val5 *= num2;
				Vector3 val6 = val.get_forward() * nearClipPlane + val2 - val3;
				val6.Normalize();
				val6 *= num2;
				Vector3 val7 = val.get_forward() * nearClipPlane - val2 - val3;
				val7.Normalize();
				val7 *= num2;
