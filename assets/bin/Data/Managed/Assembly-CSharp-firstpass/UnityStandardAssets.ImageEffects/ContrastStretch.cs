...
namespace UnityStandardAssets.ImageEffects
{
	...
	public class ContrastStretch
	{
		...
		private void OnRenderImage(RenderTexture source, RenderTexture destination)
		{
			...
			RenderTexture val = RenderTexture.GetTemporary(source.get_width() / 1, source.get_height() / 1);
			...
			while (val.get_width() > 1 || val.get_height() > 1)
			{
				...
				RenderTexture val2 = RenderTexture.GetTemporary(num, num2);
				Graphics.Blit(val, val2, materialReduce);
