...
public class QuestSpecialSelect : GameSection
{
	...
	protected virtual IEnumerator DoInitialize()
	{
		...
		if (!isInGameScene)
		{
			...
			{
				((_003CDoInitialize_003Ec__IteratorC3)/*Error near IL_007e: stateMachine*/)._003Cis_recv_delivery_003E__1 = true;
			});
		...
		{
			((_003CDoInitialize_003Ec__IteratorC3)/*Error near IL_0115: stateMachine*/)._003Cis_recv_delivery_003E__2 = true;
		});
	...
	protected unsafe virtual void SetDeliveryList(Delivery[] list)
	{
		if (selectedTab == UI.BTN_TAB_NORMAL && openRegionIds.Length >= 2)
		{
			...
			_003CSetDeliveryList_003Ec__AnonStorey391 _003CSetDeliveryList_003Ec__AnonStorey;
			SetDynamicList((Enum)UI.GRD_AREA, "QuestAreaListItem", areaInfos.Count, true, null, null, new Action<int, Transform, bool>((object)_003CSetDeliveryList_003Ec__AnonStorey, (IntPtr)(void*)/*OpCode not supported: LdFtn*/));
		...
		else if (list != null)
		{
			...
			_003CSetDeliveryList_003Ec__AnonStorey392 _003CSetDeliveryList_003Ec__AnonStorey2;
			SetDynamicList((Enum)UI.GRD_DELIVERY, "QuestRequestItem", list.Length, isDeliveryGridReset, null, null, new Action<int, Transform, bool>((object)_003CSetDeliveryList_003Ec__AnonStorey2, (IntPtr)(void*)/*OpCode not supported: LdFtn*/));
			isDeliveryGridReset = false;
			ShowNonDeliveryList();
		}
	}
	...
	protected unsafe void SendDeliveryComplete(int index, int delivery_id, bool is_enough_material, bool is_happen_quest)
	{
		...
		_003CSendDeliveryComplete_003Ec__AnonStorey395 _003CSendDeliveryComplete_003Ec__AnonStorey;
		MonoBehaviourSingleton<DeliveryManager>.I.SendDeliveryComplete(deliveryInfo[index].uId, enable_clear_event, new Action<bool, DeliveryRewardList>((object)_003CSendDeliveryComplete_003Ec__AnonStorey, (IntPtr)(void*)/*OpCode not supported: LdFtn*/));
	}
