...
public class TradingPostItemDetail : GameSection
{
	...
	private unsafe IEnumerator DoInitialize()
	{
		...
		bool wait = true;
		MonoBehaviourSingleton<TradingPostManager>.I.SendRequestItemDetail(info.itemId, currentPage, new Action<bool, List<TradingPostDetail>>((object)/*Error near IL_009e: stateMachine*/, (IntPtr)(void*)/*OpCode not supported: LdFtn*/));
		while (wait)
		{
	...
	public unsafe override void UpdateUI()
	{
		...
		int itemNum = MonoBehaviourSingleton<InventoryManager>.I.GetItemNum((ItemInfo x) => x.tableID == itemData.GetTableID(), 0, false);
		...
		SetItemIcon(FindCtrl(ctrl, UI.OBJ_ICON_ROOT), itemData, 0);
		SetActive(ctrl, UI.SPR_NEED, false);
		...
		SetGrid(ctrl, UI.GRD_HOWTO, "TradingPostListBaseItem", details.Count, false, new Action<int, Transform, bool>((object)this, (IntPtr)(void*)/*OpCode not supported: LdFtn*/));
	}
	...
	private unsafe void AddList(List<TradingPostDetail> list)
	{
		_003CAddList_003Ec__AnonStorey4AC _003CAddList_003Ec__AnonStorey4AC;
		AddItemList(GetCtrl(UI.GRD_HOWTO), "TradingPostListBaseItem", list.Count, null, null, new Action<int, Transform, bool>((object)_003CAddList_003Ec__AnonStorey4AC, (IntPtr)(void*)/*OpCode not supported: LdFtn*/));
	}
	...
	private void InitItemList(TradingPostDetail detail, Transform t, int i)
	{
		...
		SetItemIcon(FindCtrl(t, UI.OBJ_ICON), itemData, 0);
		SetEvent(t, "BUY", i);
	}
	...
	private void Update()
	{
		...
		else if ((refresh || next) && MonoBehaviourSingleton<GameSceneManager>.I.IsEventExecutionPossible() && !MonoBehaviourSingleton<GameSceneManager>.I.isChangeing)
		{
			if (refresh)
			{
				refresh = false;
	...
	private void OnQuery_SELL()
	{
		...
		{
			GameSection.ChangeEvent("NO_ITEM", null);
		}
		else
		{
	...
	private unsafe void OnQuery_REFRESH()
	{
		...
		MonoBehaviourSingleton<TradingPostManager>.I.SendRequestItemDetail((int)itemData.GetTableID(), currentPage, new Action<bool, List<TradingPostDetail>>((object)this, (IntPtr)(void*)/*OpCode not supported: LdFtn*/));
	}
	...
	private void OnQuery_BUY()
	{
		...
		{
			GameSection.ChangeEvent("LICENSE_REQUIRE", null);
		}
		else
		{
	...
	private unsafe void OnQuery_PURCHASE()
	{
		if (MonoBehaviourSingleton<UserInfoManager>.I.userStatus.crystal < currentDetail.price)
		{
			GameSection.ChangeEvent("LACK", null);
		}
		else
		{
			GameSection.StayEvent();
			MonoBehaviourSingleton<TradingPostManager>.I.SendRequestBuyItem(currentDetail.transactionId, new Action<bool, Error>((object)this, (IntPtr)(void*)/*OpCode not supported: LdFtn*/));
		}
	}
