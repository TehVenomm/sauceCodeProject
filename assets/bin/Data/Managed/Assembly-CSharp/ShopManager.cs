		...
		Protocol.Send(GoldPurchaseItemListModel.URL, sendForm, delegate(GoldPurchaseItemListModel ret)
		{
			...
			if (ret.Error == Error.None)
			{
				if (purchaseItemList == null || !purchaseItemList.checkSum.Equals(ret.result.checkSum))
				{
					...
					if (_003CSendGetGoldPurchaseItemList_003Ec__AnonStorey6C8._003C_003Ef__am_0024cache2 == null)
					{
						_003CSendGetGoldPurchaseItemList_003Ec__AnonStorey6C8._003C_003Ef__am_0024cache2 = new Func<ProductData, string>((object)null, (IntPtr)(void*)/*OpCode not supported: LdFtn*/);
					}
					string productNameData = string.Join("----", shopList.Select<ProductData, string>(_003CSendGetGoldPurchaseItemList_003Ec__AnonStorey6C8._003C_003Ef__am_0024cache2).ToArray());
					Native.SetProductNameData(productNameData);
					List<ProductData> shopList2 = purchaseItemList.shopList;
					if (_003CSendGetGoldPurchaseItemList_003Ec__AnonStorey6C8._003C_003Ef__am_0024cache3 == null)
					{
						_003CSendGetGoldPurchaseItemList_003Ec__AnonStorey6C8._003C_003Ef__am_0024cache3 = new Func<ProductData, string>((object)null, (IntPtr)(void*)/*OpCode not supported: LdFtn*/);
					}
					productNameData = string.Join("----", shopList2.Select<ProductData, string>(_003CSendGetGoldPurchaseItemList_003Ec__AnonStorey6C8._003C_003Ef__am_0024cache3).ToArray());
