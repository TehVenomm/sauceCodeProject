...
public class CarnivalResultPoint : GameSection
{
	...
	private unsafe void SetRewardUI()
	{
		...
		_003CSetRewardUI_003Ec__AnonStorey410 _003CSetRewardUI_003Ec__AnonStorey;
	...
	private IEnumerator GetPointAnimation()
	{
		...
		{
			((_003CGetPointAnimation_003Ec__Iterator12C)/*Error near IL_00b8: stateMachine*/)._003Cwait_003E__3 = false;
		}, true, 0);
		while (wait2)
		{
			if (skipRequest)
		...
		if (currentData.pointRankingData.getReward.Count > 0)
		{
			...
			{
				((_003CGetPointAnimation_003Ec__Iterator12C)/*Error near IL_01d8: stateMachine*/)._003Cwait_003E__3 = false;
			}, true, 0);
			while (wait2)
			{
				if (skipRequest)
	...
	{
		_003CSetNextItemIcon_003Ec__AnonStorey411 _003CSetNextItemIcon_003Ec__AnonStorey;
	...
	{
		_003CSetAllRewardItem_003Ec__AnonStorey412 _003CSetAllRewardItem_003Ec__AnonStorey;
	...
	private IEnumerator StartRankingAnimation()
	{
		...
		{
			((_003CStartRankingAnimation_003Ec__Iterator130)/*Error near IL_0056: stateMachine*/)._003Cwait_003E__0 = false;
		}, true, 0);
		while (wait2)
		{
			if (skipRequest)
		...
		if (currentRank > targetRank)
		{
			...
			{
				((_003CStartRankingAnimation_003Ec__Iterator130)/*Error near IL_039b: stateMachine*/)._003Cwait_003E__0 = false;
			}, true, 0);
			while (wait2)
			{
				if (skipRequest)
