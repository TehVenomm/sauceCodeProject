...
public class WorldMap : GameSection
{
	...
	protected unsafe override void OnOpen()
	{
		...
		_003COnOpen_003Ec__AnonStorey48E _003COnOpen_003Ec__AnonStorey48E;
		FadeInMap(new Action((object)_003COnOpen_003Ec__AnonStorey48E, (IntPtr)(void*)/*OpCode not supported: LdFtn*/));
	...
	public unsafe void FadeInMap(Action onComplete)
	{
		...
		_003CFadeInMap_003Ec__AnonStorey490 _003CFadeInMap_003Ec__AnonStorey;
		this.StartCoroutine(DoFadeMap(0f, 1f, 0.4f, new Action((object)_003CFadeInMap_003Ec__AnonStorey, (IntPtr)(void*)/*OpCode not supported: LdFtn*/)));
	}
	...
	public unsafe void EnterRegionMapEvent(Action onCompleteFilter)
	{
		...
		{
			DisableWorldMapObject();
			_003CEnterRegionMapEvent_003Ec__AnonStorey491 _003CEnterRegionMapEvent_003Ec__AnonStorey;
			blurFilter.StartBlurFilter(0f, 0.25f, 0.25f, blurCenter, new Action((object)_003CEnterRegionMapEvent_003Ec__AnonStorey, (IntPtr)(void*)/*OpCode not supported: LdFtn*/));
		}
	}
	...
	private IEnumerator PlayOpenRegionMap(bool useReleaseRegion)
	{
		if (releaseRegionId >= 0)
		{
			...
			{
				((_003CPlayOpenRegionMap_003Ec__Iterator189)/*Error near IL_0740: stateMachine*/)._003CisTweenEnd_003E__15 = true;
			});
