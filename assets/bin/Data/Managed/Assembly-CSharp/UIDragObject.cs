...
public class UIDragObject : MonoBehaviour
{
	...
	private void OnEnable()
	{
		...
		if ((Object)contentRect == (Object)null && (Object)target != (Object)null && Application.isPlaying)
		{
		...
		mTargetPos = ((!((Object)target != (Object)null)) ? Vector3.zero : target.position);
	}
	...
	{
		panelRegion = ((!((Object)target != (Object)null)) ? null : UIPanel.Find(target.transform.parent));
		if ((Object)panelRegion == (Object)null)
		{
	...
	private void OnPress(bool pressed)
	{
		if (UICamera.currentTouchID != -2 && UICamera.currentTouchID != -3)
		{
			...
			if ((!(timeScale < 0.01f) || timeScale == 0f) && base.enabled && NGUITools.GetActive(base.gameObject) && (Object)target != (Object)null)
			{
				if (pressed)
				{
					if (!mPressed)
					{
						...
						mStarted = false;
						CancelMovement();
						if (restrictWithinPanel && (Object)panelRegion == (Object)null)
						{
							FindPanel();
						}
						...
						mPlane = new Plane(((!((Object)panelRegion != (Object)null)) ? transform.rotation : panelRegion.cachedTransform.rotation) * Vector3.back, UICamera.lastWorldPosition);
					}
				}
	...
	{
		if (mPressed && mTouchID == UICamera.currentTouchID && base.enabled && NGUITools.GetActive(base.gameObject) && (Object)target != (Object)null)
		{
