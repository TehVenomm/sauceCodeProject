...
public class PlacementTable : Singleton<PlacementTable>
{
	...
	{
		objectTable = TableUtility.CreateUIntKeyTable<PlaceableObjectData>(placeableObjectTextAsset.text, PlaceableObjectData.cb, PlaceableObjectData.NT);
		objectTable.TrimExcess();
		mapTable = TableUtility.CreateUIntKeyTable<PlaceableMapData>(placeableMapTextAsset.text, PlaceableMapData.cb, PlaceableMapData.NT);
		mapTable.TrimExcess();
	}
