	...
	protected unsafe override void ResultEquipInfo()
	{
		if (resultData.itemData != null)
		{
			...
			if ((item.ability != null && item.ability.Length > 0) || flag2)
			{
				...
				_003CResultEquipInfo_003Ec__AnonStorey47B _003CResultEquipInfo_003Ec__AnonStorey47B;
				SetTable(detailBase, UI.TBL_ABILITY, "ItemDetailEquipAbilityItem", item.ability.Length + (flag2 ? 1 : 0), false, new Action<int, Transform, bool>((object)_003CResultEquipInfo_003Ec__AnonStorey47B, (IntPtr)(void*)/*OpCode not supported: LdFtn*/));
