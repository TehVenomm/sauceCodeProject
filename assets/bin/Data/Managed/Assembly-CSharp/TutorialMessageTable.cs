...
public class TutorialMessageTable : Singleton<TutorialMessageTable>, IDataTable
{
	...
	public unsafe static void SendTutorialBit(TUTORIAL_MENU_BIT bit, Action<bool> callback = null)
	{
		...
		_003CSendTutorialBit_003Ec__AnonStorey7D3 _003CSendTutorialBit_003Ec__AnonStorey7D;
		Protocol.Force(new Action((object)_003CSendTutorialBit_003Ec__AnonStorey7D, (IntPtr)(void*)/*OpCode not supported: LdFtn*/));
	}
