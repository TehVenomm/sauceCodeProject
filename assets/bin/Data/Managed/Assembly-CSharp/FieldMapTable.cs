...
public class FieldMapTable : Singleton<FieldMapTable>
{
	...
	{
		public const string NT = "mapId,popX,rotY,popY,popZ,popRadius,enemyId,enemyLv,popNumMin,popNumMax,popNumInit,popNumTotal,popTimeMin,popTimeMax,bigMonsterFlag,bossFlag,autoActivate,scountigRange,scoutingSight,scoutingAudibility,enemyPopType,escapeTime,walkSpeedMin,walkSpeedMax";
	...
	{
		enemyPopTable = TableUtility.CreateUIntKeyListTable<EnemyPopTableData>(csv_text, EnemyPopTableData.cb, "mapId,popX,rotY,popY,popZ,popRadius,enemyId,enemyLv,popNumMin,popNumMax,popNumInit,popNumTotal,popTimeMin,popTimeMax,bigMonsterFlag,bossFlag,autoActivate,scountigRange,scoutingSight,scoutingAudibility,enemyPopType,escapeTime,walkSpeedMin,walkSpeedMax");
	}

	public void AddEnemyPopTable(string csv_text)
	{
		TableUtility.AddUIntKeyListTable(enemyPopTable, csv_text, EnemyPopTableData.cb, "mapId,popX,rotY,popY,popZ,popRadius,enemyId,enemyLv,popNumMin,popNumMax,popNumInit,popNumTotal,popTimeMin,popTimeMax,bigMonsterFlag,bossFlag,autoActivate,scountigRange,scoutingSight,scoutingAudibility,enemyPopType,escapeTime,walkSpeedMin,walkSpeedMax");
	}

	public void CreateGatherPointTable(string csv_text)
	{
		gatherPointTable = TableUtility.CreateUIntKeyTable<GatherPointTableData>(csv_text, GatherPointTableData.cb, "pointId,pointMapId,pointX,pointZ,pointDir,viewId,maxNumRate,addNumRate,growthInterval,gimmickType,value1", null);
