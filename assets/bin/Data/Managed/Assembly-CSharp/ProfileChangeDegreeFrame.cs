...
public class ProfileChangeDegreeFrame : GameSection
{
	...
	private unsafe IEnumerator DoInitialize()
	{
		...
		if (_003CDoInitialize_003Ec__Iterator110._003C_003Ef__am_0024cache3 == null)
		{
			_003CDoInitialize_003Ec__Iterator110._003C_003Ef__am_0024cache3 = new Func<DegreeTable.DegreeData, bool>((object)null, (IntPtr)(void*)/*OpCode not supported: LdFtn*/);
		}
		allData = all.Where(_003CDoInitialize_003Ec__Iterator110._003C_003Ef__am_0024cache3).ToList();
		...
		else
		{
			...
			if (_003CDoInitialize_003Ec__Iterator110._003C_003Ef__am_0024cache5 == null)
			{
				_003CDoInitialize_003Ec__Iterator110._003C_003Ef__am_0024cache5 = new Func<DegreeTable.DegreeData, bool>((object)null, (IntPtr)(void*)/*OpCode not supported: LdFtn*/);
			}
			userHaveData = source.Where(_003CDoInitialize_003Ec__Iterator110._003C_003Ef__am_0024cache5).ToList();
			showAll = true;
			currentPage = 1;
	...
	public unsafe override void UpdateUI()
	{
		...
		SetGrid(UI.GRD_FRAME, "DegreePlate", item_num, true, new Action<int, Transform, bool>((object)_003CUpdateUI_003Ec__AnonStorey3EC, (IntPtr)(void*)/*OpCode not supported: LdFtn*/));
