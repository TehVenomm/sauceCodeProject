...
public class DataLoader
{
	...
	private IEnumerator Load(DataLoadRequest req, bool downloadOnly, bool useQueue, bool forceDownload = false)
	{
		...
		if (!cache.IsCached(req) || forceDownload)
		{
			...
			{
				((_003CLoad_003Ec__Iterator28C)/*Error near IL_00f7: stateMachine*/)._003Cbytes_003E__3 = b;
			}, delegate(DataTableLoadError e)
			{
				((_003CLoad_003Ec__Iterator28C)/*Error near IL_0103: stateMachine*/)._003Cerror_003E__2 = e;
			});
		...
		if (downloadOnly)
		{
			...
			ThreadPoolWrapper.QueueUserWorkItem(delegate
			{
				try
				{
					if (((_003CLoad_003Ec__Iterator28C)/*Error near IL_01cc: stateMachine*/)._003Cbytes_003E__3 != null)
					{
						((_003CLoad_003Ec__Iterator28C)/*Error near IL_01cc: stateMachine*/)._003Cerror_003E__2 = ((_003CLoad_003Ec__Iterator28C)/*Error near IL_01cc: stateMachine*/)._003C_003Ef__this.Save(((_003CLoad_003Ec__Iterator28C)/*Error near IL_01cc: stateMachine*/).req, ((_003CLoad_003Ec__Iterator28C)/*Error near IL_01cc: stateMachine*/)._003Cbytes_003E__3);
					}
				}
				catch (Exception)
				{
					((_003CLoad_003Ec__Iterator28C)/*Error near IL_01cc: stateMachine*/)._003Cerror_003E__2 = DataTableLoadError.FileReadError;
				}
				finally
				{
					((_003CLoad_003Ec__Iterator28C)/*Error near IL_01cc: stateMachine*/)._003Cwait_003E__6 = false;
				}
			});
			while (wait)
			{
		...
		else
		{
			...
			if (req.enableLoadBinaryData)
			{
				...
				{
					((_003CLoad_003Ec__Iterator28C)/*Error near IL_027b: stateMachine*/)._003Cerror_003E__2 = e;
				}, useQueue);
			...
			else
			{
				...
				{
					((_003CLoad_003Ec__Iterator28C)/*Error near IL_0330: stateMachine*/)._003Cerror_003E__2 = e;
				}, useQueue);
			}
			while (loading.MoveNext())
			{
	...
	private unsafe IEnumerator LoadCompressedTextWithSignature(DataLoadRequest req, byte[] bytes, Action<DataTableLoadError> onEnd, bool useQueue)
	{
		...
		else
		{
			ThreadPoolWrapper.QueueUserWorkItem(delegate
			{
				((_003CLoadCompressedTextWithSignature_003Ec__Iterator28D)/*Error near IL_0072: stateMachine*/)._003Cact_003E__2.Invoke();
			});
		}
		while (wait)
		{
	...
	private unsafe IEnumerator LoadCompressedBinary(DataLoadRequest req, byte[] bytes, Action<DataTableLoadError> onEnd, bool useQueue)
	{
		...
		else
		{
			ThreadPoolWrapper.QueueUserWorkItem(delegate
			{
				((_003CLoadCompressedBinary_003Ec__Iterator28E)/*Error near IL_0072: stateMachine*/)._003Cact_003E__2.Invoke();
			});
		}
		while (wait)
		{
