...
public class ClanChatWebSocketConnection : IClanChatConnection
{
	...
	private IEnumerator TryReconnect(int count)
	{
		...
		{
			((_003CTryReconnect_003Ec__Iterator22C)/*Error near IL_0088: stateMachine*/)._003C_003Ef__this.reconnecting = false;
			if (!success)
			{
				if (((_003CTryReconnect_003Ec__Iterator22C)/*Error near IL_0088: stateMachine*/).count > 0)
				{
					((_003CTryReconnect_003Ec__Iterator22C)/*Error near IL_0088: stateMachine*/)._003C_003Ef__this.Reconnect(((_003CTryReconnect_003Ec__Iterator22C)/*Error near IL_0088: stateMachine*/).count - 1);
				}
			}
			else
			{
				((_003CTryReconnect_003Ec__Iterator22C)/*Error near IL_0088: stateMachine*/)._003C_003Ef__this.Join(((_003CTryReconnect_003Ec__Iterator22C)/*Error near IL_0088: stateMachine*/)._003C_003Ef__this.roomId, ((_003CTryReconnect_003Ec__Iterator22C)/*Error near IL_0088: stateMachine*/)._003C_003Ef__this.userName);
			}
		});
	}
