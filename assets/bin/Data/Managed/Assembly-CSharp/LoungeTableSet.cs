...
public class LoungeTableSet
{
	...
	private IEnumerator CreateTable()
	{
		...
		Utility.ForEach(tablePoint, delegate(Transform o)
		{
			...
			{
				((_003CCreateTable_003Ec__Iterator100)/*Error near IL_00bf: stateMachine*/)._003C_003Ef__this.tablePoints.Add(o.GetComponent<TablePoint>());
			}
			return false;
		});
	}
	...
	private IEnumerator CreateChair()
	{
		...
		Utility.ForEach(chairPoint, delegate(Transform o)
		{
			...
			{
				((_003CCreateChair_003Ec__Iterator101)/*Error near IL_00bf: stateMachine*/)._003C_003Ef__this.chairSitPoints.Add(o.GetComponent<ChairPoint>());
			}
			return false;
		});
	}
