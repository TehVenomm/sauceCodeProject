...
public class WayPoint : MonoBehaviour
{
	...
	public Vector3 GetPosInCollider()
	{
		...
		{
			return transform.get_position() + Quaternion.Euler(0f, (float)Random.Range(0, 360), 0f) * Vector3.get_forward() * Random.Range(0f, (component as SphereCollider).get_radius());
		}
