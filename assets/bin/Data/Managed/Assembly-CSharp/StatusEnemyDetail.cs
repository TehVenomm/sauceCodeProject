	...
	public unsafe IEnumerator DoInitialize()
	{
		...
		else
		{
			...
			if (popMapIds != null)
			{
				...
				if (_003CDoInitialize_003Ec__Iterator166._003C_003Ef__am_0024cache18 == null)
				{
					_003CDoInitialize_003Ec__Iterator166._003C_003Ef__am_0024cache18 = new Func<uint, bool>((object)null, (IntPtr)(void*)/*OpCode not supported: LdFtn*/);
				}
				popMapIds = source.Where(_003CDoInitialize_003Ec__Iterator166._003C_003Ef__am_0024cache18).ToList();
			}
			if (string.IsNullOrEmpty(foundationName))
			{
			...
			if (_003CDoInitialize_003Ec__Iterator166._003C_003Ef__am_0024cache19 == null)
			{
				_003CDoInitialize_003Ec__Iterator166._003C_003Ef__am_0024cache19 = new Func<AchievementCounter, bool>((object)null, (IntPtr)(void*)/*OpCode not supported: LdFtn*/);
			}
			sameMonsterCounter = source2.Where(_003CDoInitialize_003Ec__Iterator166._003C_003Ef__am_0024cache19).Where(new Func<AchievementCounter, bool>((object)/*Error near IL_0597: stateMachine*/, (IntPtr)(void*)/*OpCode not supported: LdFtn*/)).ToList();
			...
			else
			{
				...
				if (_003CDoInitialize_003Ec__Iterator166._003C_003Ef__am_0024cache1A == null)
				{
					_003CDoInitialize_003Ec__Iterator166._003C_003Ef__am_0024cache1A = new Func<AchievementCounter, long>((object)null, (IntPtr)(void*)/*OpCode not supported: LdFtn*/);
				}
				SetLabelText((Enum)label_enum, source3.Sum(_003CDoInitialize_003Ec__Iterator166._003C_003Ef__am_0024cache1A).ToString());
			}
