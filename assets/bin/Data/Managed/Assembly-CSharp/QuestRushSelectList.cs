...
public class QuestRushSelectList : QuestEventSelectList
{
	...
	protected unsafe override void UpdateTable()
	{
		...
		else
		{
			...
			_003CUpdateTable_003Ec__AnonStorey406 _003CUpdateTable_003Ec__AnonStorey;
	...
	private unsafe void OnQuery_SELECT_RUSH()
	{
		...
		if (flag)
		{
			...
			_003COnQuery_SELECT_RUSH_003Ec__AnonStorey407 _003COnQuery_SELECT_RUSH_003Ec__AnonStorey;
	...
	private IEnumerator GetCurrentStatus()
	{
		...
		{
			((_003CGetCurrentStatus_003Ec__Iterator124)/*Error near IL_0059: stateMachine*/)._003CisRequest_003E__0 = false;
			((_003CGetCurrentStatus_003Ec__Iterator124)/*Error near IL_0059: stateMachine*/)._003C_003Ef__this.currentData = result.result;
