...
public class GimmickGeneratorObject : StageObject, IFieldGimmickObject
{
	...
	public void OnGenerateForLinearMove(Vector3 pos)
	{
		...
		{
			Transform transform = Utility.CreateGameObject("GimmickShot", base._transform);
			...
			if (transform2 != null)
			{
				...
				AttackHitInfo atkInfo = new AttackHitInfo
				{
					name = "generatedAttack",
					attackType = AttackHitInfo.ATTACK_TYPE.GIMMICK_GENERATED,
					toPlayer = 
					{
				...
				generatedAttackObject.Initialize(this, transform3.parent, atkInfo, Vector3.zero, Vector3.zero, colliderRadius, colliderHeight, colliderDirection, center, 31);
				generatedAttackObject2.Initialize(this, transform4.parent, atkInfo, Vector3.zero, Vector3.zero, colliderRadius, colliderHeight, colliderDirection, -center, 31);
				generatedAttackObject3.Initialize(this, transform3.parent, atkInfo, Vector3.zero, Vector3.zero, colliderRadius, colliderHeight, colliderDirection, center, 31);
				generatedAttackObject4.Initialize(this, transform4.parent, atkInfo, Vector3.zero, Vector3.zero, colliderRadius, colliderHeight, colliderDirection, -center, 31);
			}
