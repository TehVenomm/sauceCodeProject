...
public class LimitedLoginBonus : GameSection
{
	...
	private IEnumerator DoInitialize()
	{
		...
		if (GameSection.GetEventData() != null)
		{
			...
			}, url: LoginBonusConfirmModel.URL, call_back: (Action<LoginBonusConfirmModel>)delegate(LoginBonusConfirmModel ret)
			{
				if (ret.Error == Error.None)
				{
					...
					{
						((_003CDoInitialize_003Ec__IteratorA7)/*Error near IL_0071: stateMachine*/)._003C_003Ef__this.lb = ret.result[0];
					}
					((_003CDoInitialize_003Ec__IteratorA7)/*Error near IL_0071: stateMachine*/)._003Cconnect_003E__0 = true;
				}
		...
		else
		{
			...
			topImageLoadObj = loadingQueue.Load(true, RESOURCE_CATEGORY.LOGINBONUS_IMAGE, topImgName, false);
