...
public class FieldMapEnemyPopTimeZoneTable : Singleton<FieldMapEnemyPopTimeZoneTable>, IDataTable
{
	...
	{
		timeZoneDataTable = TableUtility.CreateUIntKeyTable<FieldMapEnemyPopTimeZoneData>(csv_text, FieldMapEnemyPopTimeZoneData.cb, "id,startTime,endTime,enemyId,mapId,existStrId,goneStrId", null);
	}
	...
	{
		TableUtility.AddUIntKeyTable(timeZoneDataTable, csv_text, FieldMapEnemyPopTimeZoneData.cb, "id,startTime,endTime,enemyId,mapId,existStrId,goneStrId", null);
	}
