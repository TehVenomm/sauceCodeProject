			...
			if (ret.Error == Error.None)
			{
				...
				gachaData.types.ForEach(delegate(GachaList.GachaType type)
				{
					type.groups.ForEach(delegate(GachaList.GachaGroup gr)
					{
						...
						if (_003CSendGetGacha_003Ec__AnonStorey5D5._003C_003Ef__am_0024cache6 == null)
						{
							_003CSendGetGacha_003Ec__AnonStorey5D5._003C_003Ef__am_0024cache6 = new Func<GachaList.Gacha, bool>((object)null, (IntPtr)(void*)/*OpCode not supported: LdFtn*/);
						}
						List<GachaList.Gacha> oncePurchaseGachaList = gachas.Where(_003CSendGetGacha_003Ec__AnonStorey5D5._003C_003Ef__am_0024cache6).ToList();
						int num = oncePurchaseGachaList.Count();
						for (int i = 0; i < num; i++)
						{
							GachaList.Gacha gacha = oncePurchaseGachaList.ElementAt(i);
							int gachaId = gacha.gachaId;
							_003CSendGetGacha_003Ec__AnonStorey5D5._003CSendGetGacha_003Ec__AnonStorey5D3 _003CSendGetGacha_003Ec__AnonStorey5D;
							List<GachaList.Gacha> list = gr.gachas.Where(new Func<GachaList.Gacha, bool>((object)_003CSendGetGacha_003Ec__AnonStorey5D, (IntPtr)(void*)/*OpCode not supported: LdFtn*/)).Where(new Func<GachaList.Gacha, bool>((object)_003CSendGetGacha_003Ec__AnonStorey5D, (IntPtr)(void*)/*OpCode not supported: LdFtn*/)).ToList();
							if (list.Count > 0)
							{
								gr.gachas.Remove(gacha);
								IEnumerable<GachaList.Gacha> source = gr.gachas.Where(new Func<GachaList.Gacha, bool>((object)_003CSendGetGacha_003Ec__AnonStorey5D, (IntPtr)(void*)/*OpCode not supported: LdFtn*/));
								if (_003CSendGetGacha_003Ec__AnonStorey5D5._003C_003Ef__am_0024cache7 == null)
								{
									_003CSendGetGacha_003Ec__AnonStorey5D5._003C_003Ef__am_0024cache7 = new Func<GachaList.Gacha, int>((object)null, (IntPtr)(void*)/*OpCode not supported: LdFtn*/);
								}
								int targetSubGroup = source.Select<GachaList.Gacha, int>(_003CSendGetGacha_003Ec__AnonStorey5D5._003C_003Ef__am_0024cache7).First();
								List<GachaList.Gacha> gachas2 = gr.gachas;
								if (_003CSendGetGacha_003Ec__AnonStorey5D5._003C_003Ef__am_0024cache8 == null)
								{
									_003CSendGetGacha_003Ec__AnonStorey5D5._003C_003Ef__am_0024cache8 = new Func<GachaList.Gacha, int, _003C_003E__AnonType0<GachaList.Gacha, int>>((object)null, (IntPtr)(void*)/*OpCode not supported: LdFtn*/);
								}
								var source2 = Enumerable.Select(gachas2, _003CSendGetGacha_003Ec__AnonStorey5D5._003C_003Ef__am_0024cache8).Where(new Func<_003C_003E__AnonType0<GachaList.Gacha, int>, bool>((object)_003CSendGetGacha_003Ec__AnonStorey5D, (IntPtr)(void*)/*OpCode not supported: LdFtn*/));
								if (_003CSendGetGacha_003Ec__AnonStorey5D5._003C_003Ef__am_0024cache9 == null)
								{
									_003CSendGetGacha_003Ec__AnonStorey5D5._003C_003Ef__am_0024cache9 = new Func<_003C_003E__AnonType0<GachaList.Gacha, int>, int>((object)null, (IntPtr)(void*)/*OpCode not supported: LdFtn*/);
								}
								int index = Enumerable.Select(source2, _003CSendGetGacha_003Ec__AnonStorey5D5._003C_003Ef__am_0024cache9).First();
