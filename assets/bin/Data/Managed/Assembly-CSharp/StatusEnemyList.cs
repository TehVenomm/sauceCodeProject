	...
	private unsafe void CreateIcon(IEnumerable<EnemyCollectionTable.EnemyCollectionData> items, UI targetType, int start)
	{
		if (items.Count() > start)
		{
			...
			if (num > 0)
			{
				...
				_003CCreateIcon_003Ec__AnonStorey46E _003CCreateIcon_003Ec__AnonStorey46E;
				SetDynamicList((Enum)targetType, "EnemyCollectionIcon", num, false, null, null, new Action<int, Transform, bool>((object)_003CCreateIcon_003Ec__AnonStorey46E, (IntPtr)(void*)/*OpCode not supported: LdFtn*/));
			}
			else
			{
