...
public class TutorialMessage : UIBehaviour
{
	...
	private IEnumerator _LoadMessageImage(TutorialData tutorial_data)
	{
		...
		m_tutorial.Messages.messageData.ForEach(delegate(TutorialMessageTable.TutorialMessageData.MessageData msg)
		{
			if (msg == null)
			{
				((_003C_LoadMessageImage_003Ec__Iterator297)/*Error near IL_0052: stateMachine*/)._003Clist_003E__1.Add(null);
			}
			...
			{
				LoadObject item = ((_003C_LoadMessageImage_003Ec__Iterator297)/*Error near IL_0052: stateMachine*/)._003Clo_queue_003E__0.Load(RESOURCE_CATEGORY.UI, msg.imageResourceName, false);
				((_003C_LoadMessageImage_003Ec__Iterator297)/*Error near IL_0052: stateMachine*/)._003Clist_003E__1.Add(item);
			}
		});
		...
		{
			((_003C_LoadMessageImage_003Ec__Iterator297)/*Error near IL_009d: stateMachine*/)._003Cindex_003E__2++;
			if (data != null)
			{
				Transform val = ResourceUtility.Realizes(data.loadedObject, ((_003C_LoadMessageImage_003Ec__Iterator297)/*Error near IL_009d: stateMachine*/)._003C_003Ef__this.GetCtrl(UI.OBJ_IMAGE_ROOT), 5);
				if (val != null)
				{
					val.set_name(((_003C_LoadMessageImage_003Ec__Iterator297)/*Error near IL_009d: stateMachine*/)._003Cindex_003E__2.ToString());
					((_003C_LoadMessageImage_003Ec__Iterator297)/*Error near IL_009d: stateMachine*/).tutorial_data.SetImage(((_003C_LoadMessageImage_003Ec__Iterator297)/*Error near IL_009d: stateMachine*/)._003Cindex_003E__2, val);
				}
			}
		});
	}
