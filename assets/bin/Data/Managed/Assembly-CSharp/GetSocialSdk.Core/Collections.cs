...
namespace GetSocialSdk.Core
{
	public static class Collections
	{
		...
		public unsafe static bool ListEquals<T>(this List<T> self, List<T> other)
		{
			...
			_003CListEquals_003Ec__AnonStorey7FF<T> _003CListEquals_003Ec__AnonStorey7FF;
			return !Enumerable.Where<T>((IEnumerable<T>)self, new Func<_003F, int, bool>((object)_003CListEquals_003Ec__AnonStorey7FF, (IntPtr)(void*)/*OpCode not supported: LdFtn*/)).Any();
		}
