...
namespace GetSocialSdk.Core
{
	public class JavaInterfaceProxy
	{
		...
		protected unsafe void HandleError(AndroidJavaObject throwable, Action<GetSocialError> onFailure)
		{
			...
			if (onFailure != null)
			{
				try
				{
					...
					_003CHandleError_003Ec__AnonStorey801 _003CHandleError_003Ec__AnonStorey;
					ExecuteOnMainThread(new Action((object)_003CHandleError_003Ec__AnonStorey, (IntPtr)(void*)/*OpCode not supported: LdFtn*/));
				}
				finally
				{
		...
		protected unsafe void HandleValue<T>(T value, Action<T> onSuccess)
		{
			...
			if (onSuccess != null)
			{
				_003CHandleValue_003Ec__AnonStorey802<T> _003CHandleValue_003Ec__AnonStorey;
				ExecuteOnMainThread(new Action((object)_003CHandleValue_003Ec__AnonStorey, (IntPtr)(void*)/*OpCode not supported: LdFtn*/));
			}
		}
	}
}
