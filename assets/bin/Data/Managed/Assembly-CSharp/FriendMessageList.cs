...
public class FriendMessageList : FollowListBase
{
	...
	protected unsafe override void UpdateDynamicList()
	{
		...
		if (pageItemLength >= 1 && array.Length >= 1 && array.Length >= num + pageItemLength)
		{
			...
			CleanItemList();
			_003CUpdateDynamicList_003Ec__AnonStorey314 _003CUpdateDynamicList_003Ec__AnonStorey;
	...
	{
		_003CSendGetList_003Ec__AnonStorey315 _003CSendGetList_003Ec__AnonStorey;
