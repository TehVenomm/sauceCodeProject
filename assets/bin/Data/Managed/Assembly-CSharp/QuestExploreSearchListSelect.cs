...
public class QuestExploreSearchListSelect : QuestSearchListSelectBase
{
	...
	{
		_003CSendSearchRequest_003Ec__AnonStorey3FD _003CSendSearchRequest_003Ec__AnonStorey3FD;
		MonoBehaviourSingleton<PartyManager>.I.SendEventSearch(eventId, new Action<bool, Error>((object)_003CSendSearchRequest_003Ec__AnonStorey3FD, (IntPtr)(void*)/*OpCode not supported: LdFtn*/));
	}
	...
	public unsafe override void UpdateUI()
	{
		...
		else
		{
			...
			SetGrid(UI.GRD_QUEST, "QuestExploreSearchListSelectItem", partys.Length, false, new Action<int, Transform, bool>((object)_003CUpdateUI_003Ec__AnonStorey3FE, (IntPtr)(void*)/*OpCode not supported: LdFtn*/));
			base.UpdateUI();
		}
	}
