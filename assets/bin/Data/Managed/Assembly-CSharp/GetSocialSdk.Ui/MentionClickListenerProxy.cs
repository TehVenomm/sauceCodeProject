...
namespace GetSocialSdk.Ui
{
	public class MentionClickListenerProxy : JavaInterfaceProxy
	{
		...
		private unsafe void onMentionClicked(string userId)
		{
			...
			_003ConMentionClicked_003Ec__AnonStorey7F7 _003ConMentionClicked_003Ec__AnonStorey7F;
			JavaInterfaceProxy.ExecuteOnMainThread(new Action((object)_003ConMentionClicked_003Ec__AnonStorey7F, (IntPtr)(void*)/*OpCode not supported: LdFtn*/));
		}
	}
}
