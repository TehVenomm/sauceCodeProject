...
public class InGameGuildInvitedJoinDialog : GameSection
{
	...
	private unsafe void OnQuery_REJECT()
	{
		...
		MonoBehaviourSingleton<GuildManager>.I.SendRejectInviteClan(guildInviteInfo.requestId, delegate
		{
			...
			_003COnQuery_REJECT_003Ec__AnonStorey37A _003COnQuery_REJECT_003Ec__AnonStorey37A;
			DoWaitProtocolBusyFinish(new Action((object)_003COnQuery_REJECT_003Ec__AnonStorey37A, (IntPtr)(void*)/*OpCode not supported: LdFtn*/));
		});
	}
