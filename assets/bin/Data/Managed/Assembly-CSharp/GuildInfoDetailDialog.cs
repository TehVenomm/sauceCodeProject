...
public class GuildInfoDetailDialog : GameSection
{
	...
	private IEnumerator DoInitialize()
	{
		...
		{
			((_003CDoInitialize_003Ec__Iterator58)/*Error near IL_0038: stateMachine*/)._003C_003Ef__this.members = new List<FriendCharaInfo>(ret.result.list);
			((_003CDoInitialize_003Ec__Iterator58)/*Error near IL_0038: stateMachine*/)._003C_003Ef__this.members.Remove(((_003CDoInitialize_003Ec__Iterator58)/*Error near IL_0038: stateMachine*/)._003C_003Ef__this.members.FirstOrDefault((FriendCharaInfo o) => o.userId == MonoBehaviourSingleton<UserInfoManager>.I.userInfo.id));
			((_003CDoInitialize_003Ec__Iterator58)/*Error near IL_0038: stateMachine*/)._003C_003Ef__this._clanMasterUserId = ret.result.clanMasterId;
			((_003CDoInitialize_003Ec__Iterator58)/*Error near IL_0038: stateMachine*/)._003Cis_finish_003E__0 = true;
		});
		while (!is_finish)
		{
