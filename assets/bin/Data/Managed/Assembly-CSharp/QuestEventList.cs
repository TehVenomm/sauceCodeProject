...
public class QuestEventList : GameSection
{
	...
	private IEnumerator DoInitialize()
	{
		...
		{
			((_003CDoInitialize_003Ec__IteratorCC)/*Error near IL_003d: stateMachine*/)._003Cis_recv_delivery_003E__0 = true;
		});
		...
		{
			((_003CDoInitialize_003Ec__IteratorCC)/*Error near IL_007d: stateMachine*/)._003Cis_recv_delivery_003E__0 = true;
		});
		while (!is_recv_delivery2)
		{
			yield return (object)null;
		...
		for (int i = 0; i < eventList.Count; i++)
		{
			...
			{
				LoadObject obj = loadingQueue.Load(RESOURCE_CATEGORY.EVENT_ICON, GetBannerName(e, bannerId), false);
		...
		if (isCarnival)
		{
			...
			LoadObject eventBG = loadingQueue.Load(RESOURCE_CATEGORY.EVENT_BG, resourceName, false);
			if (loadingQueue.IsLoading())
			{
				yield return (object)loadingQueue.Wait();
			}
	...
	{
		bool isRequest = true;
		Protocol.Send<QuestCarnivalPointModel.RequestSendForm, QuestCarnivalPointModel>(post_data: new QuestCarnivalPointModel.RequestSendForm
		{
			eid = MonoBehaviourSingleton<QuestManager>.I.carnivalEventId
		}, url: QuestCarnivalPointModel.URL, call_back: (Action<QuestCarnivalPointModel>)delegate(QuestCarnivalPointModel result)
		{
			((_003CGetCurrentCarnivalStatus_003Ec__IteratorCD)/*Error near IL_0053: stateMachine*/)._003CisRequest_003E__0 = false;
			((_003CGetCurrentCarnivalStatus_003Ec__IteratorCD)/*Error near IL_0053: stateMachine*/)._003C_003Ef__this.currentCarnivalData = result.result;
	...
	private unsafe void _UpdateEvent()
	{
		if (IsActive(UI.OBJ_QUEST_LIST_ROOT))
		{
			...
			float offsetY = 0f;
			_003C_UpdateEvent_003Ec__AnonStorey3AB _003C_UpdateEvent_003Ec__AnonStorey3AB;
			SetSimpleContent(UI.OBJ_EVENT_ROOT, string.Empty, eventList.Count, false, new Func<int, bool>((object)_003C_UpdateEvent_003Ec__AnonStorey3AB, (IntPtr)(void*)/*OpCode not supported: LdFtn*/), new Func<int, Transform, Transform>((object)_003C_UpdateEvent_003Ec__AnonStorey3AB, (IntPtr)(void*)/*OpCode not supported: LdFtn*/), new Action<int, Transform, bool>((object)_003C_UpdateEvent_003Ec__AnonStorey3AB, (IntPtr)(void*)/*OpCode not supported: LdFtn*/));
	...
	private unsafe void _UpdateCarnival()
	{
		...
		_003C_UpdateCarnival_003Ec__AnonStorey3AC _003C_UpdateCarnival_003Ec__AnonStorey3AC;
		SetTable(UI.TBL_CARNIVAL_QUEST, string.Empty, itemNum, false, new Func<int, Transform, Transform>((object)_003C_UpdateCarnival_003Ec__AnonStorey3AC, (IntPtr)(void*)/*OpCode not supported: LdFtn*/), new Action<int, Transform, bool>((object)_003C_UpdateCarnival_003Ec__AnonStorey3AC, (IntPtr)(void*)/*OpCode not supported: LdFtn*/));
	...
	private unsafe void OnQuery_SELECT_DISABLE()
	{
		...
		_003COnQuery_SELECT_DISABLE_003Ec__AnonStorey3AD _003COnQuery_SELECT_DISABLE_003Ec__AnonStorey3AD;
		Network.EventData eventData = MonoBehaviourSingleton<QuestManager>.I.eventList.Where(new Func<Network.EventData, bool>((object)_003COnQuery_SELECT_DISABLE_003Ec__AnonStorey3AD, (IntPtr)(void*)/*OpCode not supported: LdFtn*/)).First();
		...
		if (ev != null)
		{
			...
			else
			{
				...
				else if (!ev.readPrologueStory)
				{
					...
					_003C_CheckEvent_003Ec__AnonStorey3AE _003C_CheckEvent_003Ec__AnonStorey3AE;
					MonoBehaviourSingleton<QuestManager>.I.SendQuestReadEventStory(ev.eventId, new Action<bool, Error>((object)_003C_CheckEvent_003Ec__AnonStorey3AE, (IntPtr)(void*)/*OpCode not supported: LdFtn*/));
				}
			}
		}
	}
