...
public class DeliveryManager : MonoBehaviourSingleton<DeliveryManager>
{
	...
	private unsafe IEnumerator CheckUpdateDeliveryItem(float remainTime)
	{
		...
		if (_003CCheckUpdateDeliveryItem_003Ec__Iterator23F._003C_003Ef__am_0024cache4 == null)
		{
			_003CCheckUpdateDeliveryItem_003Ec__Iterator23F._003C_003Ef__am_0024cache4 = new Action((object)null, (IntPtr)(void*)/*OpCode not supported: LdFtn*/);
		}
		Protocol.Force(_003CCheckUpdateDeliveryItem_003Ec__Iterator23F._003C_003Ef__am_0024cache4);
	}
	...
	{
		_003CGetCompletableEventDeliveryNum_003Ec__AnonStorey599 _003CGetCompletableEventDeliveryNum_003Ec__AnonStorey;
	...
	{
		_003CGetCompletableRegionDeliveryNum_003Ec__AnonStorey59A _003CGetCompletableRegionDeliveryNum_003Ec__AnonStorey59A;
		return CountCompletableDeliveryNum(new Func<ClearStatusDelivery, DeliveryTable.DeliveryData, bool>((object)_003CGetCompletableRegionDeliveryNum_003Ec__AnonStorey59A, (IntPtr)(void*)/*OpCode not supported: LdFtn*/), new DELIVERY_TYPE[2]
		{
			DELIVERY_TYPE.STORY,
			DELIVERY_TYPE.ONCE
		});
