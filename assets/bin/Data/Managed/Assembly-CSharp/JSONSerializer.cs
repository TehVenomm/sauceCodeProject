			...
			default:
				if (stream.Has(GetName(item)))
				{
					...
					else if (item.FieldType.IsGenericType)
					{
						...
						_003CDeserializeObject_003Ec__AnonStorey8A2 _003CDeserializeObject_003Ec__AnonStorey8A;
						stream.List(GetName(item), new Action<int, JSONInStream>((object)_003CDeserializeObject_003Ec__AnonStorey8A, (IntPtr)(void*)/*OpCode not supported: LdFtn*/));
					...
					else if (item.FieldType.IsArray)
					{
						...
						_003CDeserializeObject_003Ec__AnonStorey8A3 _003CDeserializeObject_003Ec__AnonStorey8A2;
						stream.List(GetName(item), new Action<int, JSONInStream>((object)_003CDeserializeObject_003Ec__AnonStorey8A2, (IntPtr)(void*)/*OpCode not supported: LdFtn*/));
