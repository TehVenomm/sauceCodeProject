	...
	public class NativeRealtimeMultiplayerClient : IRealTimeMultiplayerClient
	{
		...
		private class OnGameThreadForwardingListener
		{
			...
			public unsafe void RoomSetupProgress(float percent)
			{
				...
				_003CRoomSetupProgress_003Ec__AnonStorey7FF _003CRoomSetupProgress_003Ec__AnonStorey7FF;
				PlayGamesHelperObject.RunOnGameThread(new Action((object)_003CRoomSetupProgress_003Ec__AnonStorey7FF, (IntPtr)(void*)/*OpCode not supported: LdFtn*/));
			}
			...
			public unsafe void RoomConnected(bool success)
			{
				//IL_001b: Unknown result type (might be due to invalid IL or missing references)
				//IL_0020: Expected O, but got Unknown
				_003CRoomConnected_003Ec__AnonStorey800 _003CRoomConnected_003Ec__AnonStorey;
			...
			public unsafe void PeersConnected(string[] participantIds)
			{
				//IL_001b: Unknown result type (might be due to invalid IL or missing references)
				//IL_0020: Expected O, but got Unknown
				_003CPeersConnected_003Ec__AnonStorey801 _003CPeersConnected_003Ec__AnonStorey;
			...
			public unsafe void PeersDisconnected(string[] participantIds)
			{
				//IL_001b: Unknown result type (might be due to invalid IL or missing references)
				//IL_0020: Expected O, but got Unknown
				_003CPeersDisconnected_003Ec__AnonStorey802 _003CPeersDisconnected_003Ec__AnonStorey;
			...
			public unsafe void RealTimeMessageReceived(bool isReliable, string senderId, byte[] data)
			{
				...
				_003CRealTimeMessageReceived_003Ec__AnonStorey803 _003CRealTimeMessageReceived_003Ec__AnonStorey;
			...
			public unsafe void ParticipantLeft(Participant participant)
			{
				//IL_001b: Unknown result type (might be due to invalid IL or missing references)
				//IL_0020: Expected O, but got Unknown
				_003CParticipantLeft_003Ec__AnonStorey804 _003CParticipantLeft_003Ec__AnonStorey;
		...
		private class ActiveState : MessagingEnabledState
		{
			...
			internal unsafe override void HandleConnectedSetChanged(NativeRealTimeRoom room)
			{
				...
				_003CHandleConnectedSetChanged_003Ec__AnonStorey805 _003CHandleConnectedSetChanged_003Ec__AnonStorey;
				...
				else
				{
					...
					using (RealtimeRoomConfigBuilder realtimeRoomConfigBuilder = RealtimeRoomConfigBuilder.Create())
					{
						...
						using (config)
						{
							...
							try
							{
								_003CCreateQuickGame_003Ec__AnonStorey7EF _003CCreateQuickGame_003Ec__AnonStorey7EF;
								newSession.StartRoomCreation(mNativeClient.GetUserId(), new Action((object)_003CCreateQuickGame_003Ec__AnonStorey7EF, (IntPtr)(void*)/*OpCode not supported: LdFtn*/));
							}
							finally
							{
								if (helper != null)
		...
		public unsafe void CreateWithInvitationScreen(uint minOpponents, uint maxOppponents, uint variant, RealTimeMultiplayerListener listener)
		{
			lock (mSessionLock)
			{
				...
				else
				{
					...
					_003CCreateWithInvitationScreen_003Ec__AnonStorey7F2._003CCreateWithInvitationScreen_003Ec__AnonStorey7F5 _003CCreateWithInvitationScreen_003Ec__AnonStorey7F;
						...
						else
						{
							...
							using (RealtimeRoomConfigBuilder realtimeRoomConfigBuilder = RealtimeRoomConfigBuilder.Create())
							{
								...
								try
								{
									...
									try
									{
										newRoom.StartRoomCreation(mNativeClient.GetUserId(), new Action((object)_003CCreateWithInvitationScreen_003Ec__AnonStorey7F, (IntPtr)(void*)/*OpCode not supported: LdFtn*/));
									}
									finally
									{
										if (helper != null)
					...
					mRealtimeManager.ShowRoomInboxUI(delegate(RealtimeManager.RoomInboxUIResponse response)
					{
						...
						else
						{
							...
							try
							{
								...
								_003CAcceptFromInbox_003Ec__AnonStorey7F7._003CAcceptFromInbox_003Ec__AnonStorey7F9 _003CAcceptFromInbox_003Ec__AnonStorey7F;
								newRoom.StartRoomCreation(mNativeClient.GetUserId(), new Action((object)_003CAcceptFromInbox_003Ec__AnonStorey7F, (IntPtr)(void*)/*OpCode not supported: LdFtn*/));
							}
							finally
							{
								if (helper != null)
		...
		public unsafe void AcceptInvitation(string invitationId, RealTimeMultiplayerListener listener)
		{
			lock (mSessionLock)
			{
				...
				else
				{
					mCurrentSession = newRoom;
					GooglePlayGames.Native.PInvoke.RealTimeEventListenerHelper helper;
					_003CAcceptInvitation_003Ec__AnonStorey7FA._003CAcceptInvitation_003Ec__AnonStorey7FD _003CAcceptInvitation_003Ec__AnonStorey7FD;
					mRealtimeManager.FetchInvitations(delegate(RealtimeManager.FetchInvitationsResponse response)
					{
								...
								while (enumerator.MoveNext())
								{
									...
									using (invitation)
									{
										if (invitation.Id().Equals(invitationId))
										{
											...
											try
											{
												newRoom.StartRoomCreation(mNativeClient.GetUserId(), new Action((object)_003CAcceptInvitation_003Ec__AnonStorey7FD, (IntPtr)(void*)/*OpCode not supported: LdFtn*/));
												return;
												IL_011e:;
											}
											finally
