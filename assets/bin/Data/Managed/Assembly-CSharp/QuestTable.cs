...
public class QuestTable : Singleton<QuestTable>
{
	...
	public unsafe static int GetQuestNum(QuestItemInfo quest_item)
	{
		...
		if (MonoBehaviourSingleton<UserInfoManager>.I.isGuildRequestOpen)
		{
			...
			_003CGetQuestNum_003Ec__AnonStorey792 _003CGetQuestNum_003Ec__AnonStorey;
	...
	public IEnumerable<QuestTableData> GetEnemyAppearQuestData(uint enemy_id)
	{
		...
		questTable.ForEach(delegate(QuestTableData table)
		{
			if (table.enemyID != null && Array.IndexOf(table.enemyID, (int)((_003CGetEnemyAppearQuestData_003Ec__Iterator28F)/*Error near IL_0039: stateMachine*/).enemy_id) >= 0)
			{
				((_003CGetEnemyAppearQuestData_003Ec__Iterator28F)/*Error near IL_0039: stateMachine*/)._003CenemyTable_003E__0.Add(table);
			}
		});
