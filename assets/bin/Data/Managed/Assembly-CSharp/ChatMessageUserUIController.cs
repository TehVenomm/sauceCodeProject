...
public class ChatMessageUserUIController
{
	...
	protected unsafe void GenerateMessageUserList(List<FriendMessageUserListModel.MessageUserInfo> recv_data)
	{
		...
		_003CGenerateMessageUserList_003Ec__AnonStorey2CB _003CGenerateMessageUserList_003Ec__AnonStorey2CB;
		for (int i = 0; i < len; i++)
		{
			...
			initParam.OnCompleteLoading = new Action((object)_003CGenerateMessageUserList_003Ec__AnonStorey2CB, (IntPtr)(void*)/*OpCode not supported: LdFtn*/);
