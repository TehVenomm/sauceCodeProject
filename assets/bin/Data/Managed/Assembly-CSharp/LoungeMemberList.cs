...
public class LoungeMemberList : GameSection
{
	...
	private IEnumerator DoInitialize()
	{
		...
		{
			((_003CDoInitialize_003Ec__IteratorCD)/*Error near IL_002d: stateMachine*/)._003CisWait_003E__0 = false;
		});
		while (isWait)
		{
	...
	{
		SetDynamicList((Enum)UI.GRD_LIST, "LoungeMemberListItem", members.Count, false, (Func<int, bool>)null, (Func<int, Transform, Transform>)null, (Action<int, Transform, bool>)delegate(int i, Transform t, bool is_recycle)
		{
