...
public abstract class EquipGenerateBase : EquipMaterialBase
{
		...
		if (table_data != null)
		{
			...
			if (smithType != SmithType.EVOLVE)
			{
				...
				if (table_data.fixedAbility.Length > 0)
				{
					...
					_003CEquipTableParam_003Ec__AnonStorey44A _003CEquipTableParam_003Ec__AnonStorey44A;
					SetTable(UI.TBL_ABILITY, "ItemDetailEquipAbilityItem", table_data.fixedAbility.Length, false, new Action<int, Transform, bool>((object)_003CEquipTableParam_003Ec__AnonStorey44A, (IntPtr)(void*)/*OpCode not supported: LdFtn*/));
	...
	protected unsafe override void Send()
	{
		...
		_003CSend_003Ec__AnonStorey44B _003CSend_003Ec__AnonStorey44B;
		MonoBehaviourSingleton<SmithManager>.I.SendCreateEquipItem(GetCreateEquiptableID(), new Action<Error, EquipItemInfo>((object)_003CSend_003Ec__AnonStorey44B, (IntPtr)(void*)/*OpCode not supported: LdFtn*/));
	}
