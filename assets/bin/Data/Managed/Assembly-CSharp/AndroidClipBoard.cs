...
public class AndroidClipBoard : iClipBoard
{
	public unsafe void SetClipBoard(string s)
	{
		...
		_003CSetClipBoard_003Ec__AnonStorey6FE _003CSetClipBoard_003Ec__AnonStorey6FE;
		activity.Call("runOnUiThread", new object[1]
		{
			(object)new AndroidJavaRunnable((object)_003CSetClipBoard_003Ec__AnonStorey6FE, (IntPtr)(void*)/*OpCode not supported: LdFtn*/)
		});
	}
}
