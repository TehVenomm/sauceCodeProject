...
public class FriendInfo : SkillInfoBase
{
	...
	protected unsafe void SendFollow(List<int> send_follow_list, Action<bool> callback = null)
	{
		...
		_003CSendFollow_003Ec__AnonStorey2EE _003CSendFollow_003Ec__AnonStorey2EE;
		MonoBehaviourSingleton<FriendManager>.I.SendFollowUser(send_follow_list, new Action<Error, List<int>>((object)_003CSendFollow_003Ec__AnonStorey2EE, (IntPtr)(void*)/*OpCode not supported: LdFtn*/));
	}
