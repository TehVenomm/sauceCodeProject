...
public class NPCTable : Singleton<NPCTable>, IDataTable
{
	...
	public class NPCData
	{
		...
		public unsafe ModelLoaderBase LoadModel(GameObject go, bool need_shadow, bool enable_light_probe, Action<Animator> on_complete, bool useSpecialModel)
		{
			...
			_003CLoadModel_003Ec__AnonStorey77E _003CLoadModel_003Ec__AnonStorey77E;
			loader2.Load(npc_model_id, go.get_layer(), need_shadow, enable_light_probe, (!enable_light_probe) ? SHADER_TYPE.UI : ShaderGlobal.GetCharacterShaderType(), new Action((object)_003CLoadModel_003Ec__AnonStorey77E, (IntPtr)(void*)/*OpCode not supported: LdFtn*/), false);
			return loader2;
		}
