...
public class SmithExceedDialog : GameSection
{
	...
	public unsafe override void UpdateUI()
	{
		...
		_003CUpdateUI_003Ec__AnonStorey3C1 _003CUpdateUI_003Ec__AnonStorey3C;
		SetGrid(UI.GRD_LAPIS, "SmithExceedItem", item_num, false, new Action<int, Transform, bool>((object)_003CUpdateUI_003Ec__AnonStorey3C, (IntPtr)(void*)/*OpCode not supported: LdFtn*/));
		...
		else
		{
			...
			else
			{
				...
				else
				{
					...
					_003COnQuery_SmithExceedConfirm_YES_003Ec__AnonStorey3C2 _003COnQuery_SmithExceedConfirm_YES_003Ec__AnonStorey3C;
					MonoBehaviourSingleton<SmithManager>.I.SendExceedEquipItem(selectEquipData.uniqueID, itemId, new Action<Error, EquipItemInfo>((object)_003COnQuery_SmithExceedConfirm_YES_003Ec__AnonStorey3C, (IntPtr)(void*)/*OpCode not supported: LdFtn*/));
				}
			}
		}
	}
