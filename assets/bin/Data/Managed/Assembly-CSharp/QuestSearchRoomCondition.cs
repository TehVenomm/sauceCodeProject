...
public class QuestSearchRoomCondition : QuestSearchRoomConditionBase
{
	...
	private void ShowMinLevelPopup()
	{
		...
		if (!((UnityEngine.Object)minLevelPopup == (UnityEngine.Object)null))
		{
			...
			UIScrollablePopupList.CreatePopup(minLevelPopup, GetCtrl(UI.POP_TARGET_MIN_LEVEL), 6, UIScrollablePopupList.ATTACH_DIRECTION.BOTTOM, true, list.ToArray(), array, enemyMinLevelIndex, delegate(int index)
			{
