...
public class PresentManager : MonoBehaviourSingleton<PresentManager>
{
	...
	public unsafe void SendDebugAddCrystal(int num, Action<bool> call_back)
	{
		...
		_003CSendDebugAddCrystal_003Ec__AnonStorey69C _003CSendDebugAddCrystal_003Ec__AnonStorey69C;
		Protocol.Send(DebugAddPresentModel.URL, requestSendForm, delegate(DebugAddPresentModel ret)
		{
			...
			if (ret.Error == Error.None)
			{
				...
				SendReceivePresent(list, new Action<bool, Error, int>((object)_003CSendDebugAddCrystal_003Ec__AnonStorey69C, (IntPtr)(void*)/*OpCode not supported: LdFtn*/));
			}
			else
			{
				call_back(false);
