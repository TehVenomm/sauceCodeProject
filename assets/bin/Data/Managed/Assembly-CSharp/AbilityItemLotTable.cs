...
public class AbilityItemLotTable : Singleton<AbilityItemLotTable>, IDataTable
{
	...
	{
		abilityItemLot = TableUtility.CreateUIntKeyTable<AbilityItemLot>(csv_text, AbilityItemLot.cb, "id,itemId,abilityType,target,spTarget,spAttackType,unlockEventId,format,minValue,maxValue,lotGroup,rate", null);
		abilityItemLot.TrimExcess();
	}

	public void AddTable(string csv_text)
	{
		TableUtility.AddUIntKeyTable(abilityItemLot, csv_text, AbilityItemLot.cb, "id,itemId,abilityType,target,spTarget,spAttackType,unlockEventId,format,minValue,maxValue,lotGroup,rate", null);
	}
