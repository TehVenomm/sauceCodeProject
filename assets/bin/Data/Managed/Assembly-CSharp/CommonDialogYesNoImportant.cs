public class CommonDialogYesNoImportant : CommonDialog
{
	...
	protected override void InitDialog(object data_object)
	{
		...
		if (text == null)
		{
			...
			base.InitDialog(new Desc(TYPE.DECLINE_COMFIRM, (texts.Length <= 0) ? string.Empty : texts[0], (texts.Length <= 1) ? string.Empty : texts[1], (texts.Length <= 2) ? string.Empty : texts[2]));
		}
		else
		{
