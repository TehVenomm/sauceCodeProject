...
public class DeliveryBattleChecker : BattleCheckerBase
{
	...
	public unsafe void AddSkillCount(int skillId, int count = 1)
	{
		...
		_003CAddSkillCount_003Ec__AnonStorey50F _003CAddSkillCount_003Ec__AnonStorey50F;
		DeliveryBattleInfo.SkillCount skillCount = deliveryBattleInfo.totalSkillCountList.FirstOrDefault(new Func<DeliveryBattleInfo.SkillCount, bool>((object)_003CAddSkillCount_003Ec__AnonStorey50F, (IntPtr)(void*)/*OpCode not supported: LdFtn*/));
