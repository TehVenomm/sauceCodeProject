...
public class NPCMessage : UIBehaviour
{
	...
	private unsafe void OnModelLoadComplete(Animator animator)
	{
		...
		{
			_003COnModelLoadComplete_003Ec__AnonStorey7AF _003COnModelLoadComplete_003Ec__AnonStorey7AF;
			this.StartCoroutine(DoCacheVoice(new Action((object)_003COnModelLoadComplete_003Ec__AnonStorey7AF, (IntPtr)(void*)/*OpCode not supported: LdFtn*/)));
		}
		else
		{
