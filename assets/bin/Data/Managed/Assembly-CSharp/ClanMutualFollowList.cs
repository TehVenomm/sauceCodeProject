...
public class ClanMutualFollowList : FollowListBase
{
	...
	protected override void UpdateDynamicList()
	{
		...
		CleanItemList();
		SetDynamicList((Enum)UI.GRD_LIST, "FriendInClanListItem", pageItemLength, reset: false, (Func<int, bool>)null, (Func<int, Transform, Transform>)null, (Action<int, Transform, bool>)delegate(int i, Transform t, bool is_recycle)
		{
	...
	public void OnQuery_DETAIL()
	{
		...
		FriendCharaInfo friendCharaInfo = messageUserInfo[num];
		GameSection.SetEventData(friendCharaInfo.userClanData.cId);
	}
