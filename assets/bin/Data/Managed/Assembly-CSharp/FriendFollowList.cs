...
public class FriendFollowList : FollowListBase
{
	...
	protected override void OnQuery_SORT()
	{
		...
		{
			MonoBehaviourSingleton<GameSceneManager>.I.OpenCommonDialog(new CommonDialog.Desc(CommonDialog.TYPE.OK, "You have no Following Hunters", StringTable.Get(STRING_CATEGORY.COMMON_DIALOG, 100u)), delegate
			{
			});
		}
	}
