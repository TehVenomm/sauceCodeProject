...
public class MutualFollowFBInviteDialog : GameSection
{
	...
	private IEnumerator DoInitialize()
	{
		...
		{
			((_003CDoInitialize_003Ec__IteratorFA)/*Error near IL_0034: stateMachine*/)._003CgetInvitableFriendFinish_003E__1 = true;
			MonoBehaviourSingleton<FBManager>.I.GetFriends(delegate
			{
				((_003CDoInitialize_003Ec__IteratorFA)/*Error near IL_0034: stateMachine*/)._003CgetFriendFinish_003E__0 = true;
			});
		});
		...
		{
			string inputValue = ((_003CDoInitialize_003Ec__IteratorFA)/*Error near IL_0085: stateMachine*/)._003C_003Ef__this.GetInputValue((Enum)UI.IPT_NAME);
			((_003CDoInitialize_003Ec__IteratorFA)/*Error near IL_0085: stateMachine*/)._003C_003Ef__this.SetWrapContentFilterText((Enum)UI.WRP_LIST, inputValue);
		});
		base.Initialize();
	}
	...
	private unsafe void _UpdateListFriend(FBManager.InvitableFriendInfo invitable_friend_info)
	{
		...
		int i = 0;
		_003C_UpdateListFriend_003Ec__AnonStorey3D5 _003C_UpdateListFriend_003Ec__AnonStorey3D;
		SetWrapContentFilter(UI.WRP_LIST, "MutualFollowFBInviteListItem", friendList.Count, false, new Action<int, Transform, bool>((object)_003C_UpdateListFriend_003Ec__AnonStorey3D, (IntPtr)(void*)/*OpCode not supported: LdFtn*/), new Func<int, string, bool>((object)_003C_UpdateListFriend_003Ec__AnonStorey3D, (IntPtr)(void*)/*OpCode not supported: LdFtn*/));
	}
