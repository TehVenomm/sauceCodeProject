...
public class TutorialBossDirector
{
	...
	private unsafe IEnumerator DoBattleStartDirection(Action onComplete)
	{
		...
		this.StartCoroutine(WaitAndPlaySounds(new List<PlaySoundParam>
		{
			...
			new PlaySoundParam(14.7f, UITutorialOperationHelper.SE_ID_DRAGON_CALL_01, () => ((_003CDoBattleStartDirection_003Ec__Iterator1E4)/*Error near IL_0169: stateMachine*/)._003C_003Ef__this.boss.head.get_position())
		}));
