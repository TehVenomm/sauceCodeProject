...
public class QuestResultPointEvent : GameSection
{
	...
	private IEnumerator GetPointAnimation()
	{
		...
		{
			((_003CGetPointAnimation_003Ec__Iterator137)/*Error near IL_00db: stateMachine*/)._003Cwait_003E__3 = false;
		}, true, 0);
		while (wait6)
		{
			if (skipRequest)
		...
		if (boostPoint > 0)
		{
			...
			{
				((_003CGetPointAnimation_003Ec__Iterator137)/*Error near IL_01d2: stateMachine*/)._003Cwait_003E__3 = false;
			}, true, 0);
			while (wait6)
			{
				if (skipRequest)
		...
		{
			((_003CGetPointAnimation_003Ec__Iterator137)/*Error near IL_0324: stateMachine*/)._003Cwait_003E__3 = false;
		}, true, 0);
		while (wait6)
		{
			if (skipRequest)
		...
		if (currentData.pointRankingData.getReward.Count > 0)
		{
			...
			for (int k = 0; k < currentData.pointRankingData.getReward.Count; k++)
			{
				...
				{
					((_003CGetPointAnimation_003Ec__Iterator137)/*Error near IL_05ca: stateMachine*/)._003Cwait_003E__3 = false;
				}, true, 0);
				if (!skipRequest)
				{
					PlayAudio(AUDIO.CATEGORY);
		...
		if (currentData.pointRankingData.nextReward != null)
		{
			...
			PlayTween((Enum)UI.OBJ_NEXT_REWARD_ROOT, true, (EventDelegate.Callback)delegate
			{
				((_003CGetPointAnimation_003Ec__Iterator137)/*Error near IL_07b0: stateMachine*/)._003Cwait_003E__3 = false;
			}, true, 0);
			PlayAudio(AUDIO.CATEGORY);
			while (wait6)
			{
		...
		if (rewardObjects.Count > 0)
		{
			...
			{
				((_003CGetPointAnimation_003Ec__Iterator137)/*Error near IL_08d7: stateMachine*/)._003Cwait_003E__3 = false;
			}, true, 0);
	...
	{
		_003CSetNextItemIcon_003Ec__AnonStorey418 _003CSetNextItemIcon_003Ec__AnonStorey;
	...
	private unsafe void SetAllRewardItem(List<PointEventCurrentData.Reward> rewardList)
	{
		...
		_003CSetAllRewardItem_003Ec__AnonStorey419 _003CSetAllRewardItem_003Ec__AnonStorey;
	...
	private IEnumerator StartRankingAnimation()
	{
		...
		{
			((_003CStartRankingAnimation_003Ec__Iterator13B)/*Error near IL_0056: stateMachine*/)._003Cwait_003E__0 = false;
		}, true, 0);
		while (wait2)
		{
			if (skipRequest)
		...
		if (currentRank > targetRank)
		{
			...
			{
				((_003CStartRankingAnimation_003Ec__Iterator13B)/*Error near IL_039b: stateMachine*/)._003Cwait_003E__0 = false;
			}, true, 0);
			while (wait2)
			{
				if (skipRequest)
