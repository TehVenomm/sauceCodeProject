...
public class ClanNetworkManager : MonoBehaviourSingleton<ClanNetworkManager>
{
	...
	private ClanPacketReceiver packetReceiver
	{
		get;
		set;
	}

	private ChatClanConnection chatConnection
	{
		get
		{
			...
			return MonoBehaviourSingleton<ClanMatchingManager>.I.GetChatConnection();
		}
	}
	...
	public ChatClanConnection CreateChatConnection()
	{
		if (!MonoBehaviourSingleton<ClanMatchingManager>.IsValid())
		{
			return null;
	...
	public bool OnRecvRoomJoined(Lounge_Model_RoomJoined model)
	{
		...
		if (MonoBehaviourSingleton<ClanManager>.IsValid())
		{
			MonoBehaviourSingleton<ClanManager>.I.OnRecvRoomJoined(model.cid);
		}
		if (model.cid != MonoBehaviourSingleton<UserInfoManager>.I.userInfo.id && MonoBehaviourSingleton<ClanManager>.IsValid())
		{
			if (!MonoBehaviourSingleton<ClanManager>.IsValid())
			{
				return true;
			}
			if (MonoBehaviourSingleton<ClanManager>.I.IHomePeople == null)
			{
				return true;
			}
			if (MonoBehaviourSingleton<ClanManager>.I.IHomePeople.selfChara == null)
			{
				return true;
			}
	...
	public bool OnRecvRoomLeaved(Lounge_Model_RoomLeaved model)
	{
		...
		if (MonoBehaviourSingleton<ClanManager>.IsValid())
		{
			MonoBehaviourSingleton<ClanManager>.I.OnRecvRoomLeaved(model.cid);
		}
		return true;
	}
	...
	private IEnumerator ClanManagerRecvRoomPosition(int userId, Vector3 pos, int aid)
	{
		...
		while (!MonoBehaviourSingleton<ClanManager>.I.IsInitialized)
		{
			yield return null;
		}
		MonoBehaviourSingleton<ClanManager>.I.OnRecvRoomPosition(userId, pos, (LOUNGE_ACTION_TYPE)aid);
	}
	...
	public bool OnRecvRoomMove(Lounge_Model_RoomMove model)
	{
		...
		if (MonoBehaviourSingleton<ClanManager>.IsValid())
		{
			MonoBehaviourSingleton<ClanManager>.I.OnRecvRoomMove(model.cid, model.pos);
		}
		return true;
	}
	...
	public bool OnRecvRoomAction(Lounge_Model_RoomAction model)
	{
		...
		if (MonoBehaviourSingleton<ClanManager>.IsValid())
		{
			MonoBehaviourSingleton<ClanManager>.I.OnRecvRoomAction(model.cid, model.aid);
		}
		return true;
	}
	...
	public bool OnRecvRoomKick(Lounge_Model_RoomKick model)
	{
		...
		MonoBehaviourSingleton<ClanMatchingManager>.I.Kick(model.cid);
		return true;
	}
	...
	{
		if (!MonoBehaviourSingleton<ClanMatchingManager>.I.IsUserInClanBase(model.cid))
		{
			return true;
		}
		MonoBehaviourSingleton<ClanMatchingManager>.I.OnRecvMemberMoveLounge(model.cid);
		return true;
	}
	...
	public bool OnRecvMemberQuest(Lounge_Model_MemberQuest model)
	{
		...
		MonoBehaviourSingleton<ClanMatchingManager>.I.OnRecvMemberMoveQuest(model);
		return true;
	}
	...
	public bool OnRecvMemberField(Lounge_Model_MemberField model)
	{
		...
		MonoBehaviourSingleton<ClanMatchingManager>.I.OnRecvMemberMoveField(model);
		return true;
	}
	...
	public bool OnRecvMemberArena(Lounge_Model_MemberArena model)
	{
		...
		MonoBehaviourSingleton<ClanMatchingManager>.I.OnRecvMemberMoveArena(model);
		return true;
	}
	...
	public bool OnRecvChatMessage(Coop_Model_StageChatMessage model)
	{
		...
		if (!MonoBehaviourSingleton<ClanMatchingManager>.I.IsUserInClanBase(model.user_id))
		{
			return true;
		}
		...
		if (MonoBehaviourSingleton<ClanManager>.IsValid())
		{
			MonoBehaviourSingleton<ClanManager>.I.OnRecvChatMessage(model.user_id);
		}
		return true;
	}
	...
	{
		if (!MonoBehaviourSingleton<ClanMatchingManager>.I.IsUserInClanBase(after.userId))
		{
			return;
		}
		LoungeMemberStatus.MEMBER_STATUS status = after.GetStatus();
		PartyModel.SlotInfo slotInfoByUserId = MonoBehaviourSingleton<ClanMatchingManager>.I.GetSlotInfoByUserId(after.userId);
		switch (beforeStatus)
		{
