...
public class PlayerLoader : ModelLoaderBase
{
	...
	private void UpdateVoiceAudioClipIds()
	{
		if (voiceAudioClips != null && voiceAudioClips.Length > 0)
		{
			...
			for (int num = voiceAudioClips.Length; i < num; voiceAudioClipIds[i] = result, i++)
			{
				...
				if (resourceObject != null && resourceObject.obj != (UnityEngine.Object)null && resourceObject.obj.name != null)
				{
					string s = resourceObject.obj.name.Substring(resourceObject.obj.name.Length - 4);
	...
	private IEnumerator DoLoad(PlayerLoadInfo info, int layer, int anim_id, bool need_anim_event, bool need_foot_stamp, bool need_shadow, bool enable_light_probes, bool need_action_voice, bool need_high_reso_tex, bool need_res_ref_count, bool need_dev_frame_instantiate, SHADER_TYPE shader_type, OnCompleteLoad callback, bool enable_eye_blick, int use_hair_overlay)
	{
		if (info == null)
		{
		...
		if (body_name != null)
		{
			...
			if ((UnityEngine.Object)player != (UnityEngine.Object)null)
			{
				...
				if ((UnityEngine.Object)player.packetReceiver != (UnityEngine.Object)null)
				{
			...
			if ((UnityEngine.Object)player != (UnityEngine.Object)null && anim_id > -1)
			{
			...
			if ((UnityEngine.Object)player != (UnityEngine.Object)null && info.weaponEvolveId != 0)
			{
			...
			if ((UnityEngine.Object)player != (UnityEngine.Object)null)
			{
				if (need_anim_event)
				{
					...
					{
						((_003CDoLoad_003Ec__Iterator26C)/*Error near IL_0ec2: stateMachine*/)._003Cload_queue_003E__21.CacheAnimDataUseResource(load_object.loadedObjects[1].obj as AnimEventData, delegate(string effect_name)
						{
							if (effect_name[0] == '@')
							{
								return null;
						...
						((_003CDoLoad_003Ec__Iterator26C)/*Error near IL_0ec2: stateMachine*/)._003Cload_queue_003E__21.CacheAnimDataUseResourceDependPlayer(((_003CDoLoad_003Ec__Iterator26C)/*Error near IL_0ec2: stateMachine*/)._003Cplayer_003E__0, load_object.loadedObjects[1].obj as AnimEventData);
						AnimEventData animEventData = load_object.loadedObjects[1].obj as AnimEventData;
						if ((UnityEngine.Object)animEventData != (UnityEngine.Object)null && !animEventData.animations.IsNullOrEmpty())
						{
								...
								foreach (AnimEventData.EventData eventData in events)
								{
										...
										for (int num7 = eventData.stringArgs.Length; num6 < num7; num6++)
										{
											...
											if (!array.IsNullOrEmpty())
											{
												...
												for (int num9 = array.Length; num8 < num9; num8++)
												{
													...
													{
														LoadObject loadObject2 = ((_003CDoLoad_003Ec__Iterator26C)/*Error near IL_0ec2: stateMachine*/)._003Cload_queue_003E__21.Load(RESOURCE_CATEGORY.INGAME_BULLET, text2, false);
														if (loadObject2 != null && ((_003CDoLoad_003Ec__Iterator26C)/*Error near IL_0ec2: stateMachine*/)._003CanimEventBulletLoadObjTable_003E__60.Get(text2) == null)
														{
															((_003CDoLoad_003Ec__Iterator26C)/*Error near IL_0ec2: stateMachine*/)._003CanimEventBulletLoadObjTable_003E__60.Add(text2, loadObject2);
														}
													}
												}
											}
									...
									case AnimEventFormat.ID.LOAD_BULLET:
										for (int num5 = 0; num5 < eventData.stringArgs.Length; num5++)
										{
											...
											{
												LoadObject loadObject = ((_003CDoLoad_003Ec__Iterator26C)/*Error near IL_0ec2: stateMachine*/)._003Cload_queue_003E__21.Load(RESOURCE_CATEGORY.INGAME_BULLET, text, false);
												if (loadObject != null && ((_003CDoLoad_003Ec__Iterator26C)/*Error near IL_0ec2: stateMachine*/)._003CanimEventBulletLoadObjTable_003E__60.Get(text) == null)
												{
													((_003CDoLoad_003Ec__Iterator26C)/*Error near IL_0ec2: stateMachine*/)._003CanimEventBulletLoadObjTable_003E__60.Add(text, loadObject);
												}
											}
										}
										break;
									...
									case AnimEventFormat.ID.ATK_COLLIDER_CAPSULE_DEPEND_VALUE_MULTI:
									{
										...
										if (!string.IsNullOrEmpty(text3))
										{
											...
											for (int num10 = 0; num10 < namesNeededLoadAtkInfoFromAnimEvent.Length; num10++)
											{
												...
												{
													((_003CDoLoad_003Ec__Iterator26C)/*Error near IL_0ec2: stateMachine*/)._003CneedAtkInfoNames_003E__59.Add(text3);
													break;
												}
											}
										}
				...
				if (MonoBehaviourSingleton<InGameSettingsManager>.IsValid())
				{
					...
					{
						GameObject infoObj = atkInfo[i9].Realizes(_settingTransform, -1).gameObject;
						...
						{
							yield return (object)StartCoroutine(LoadNextBulletInfo(load_queue, attackInfo.attackHitInfo.nextBulletInfoName, hitInfos));
						}
						if (!string.IsNullOrEmpty(attackInfo.attackContinuationInfo.nextBulletInfoName))
						{
							yield return (object)StartCoroutine(LoadNextBulletInfo(load_queue, attackInfo.attackContinuationInfo.nextBulletInfoName, hitInfos));
						}
					}
				...
				{
					if (item != null && item.loadedObject != (UnityEngine.Object)null)
					{
						BulletData bulletData = item.loadedObject as BulletData;
						if ((UnityEngine.Object)bulletData != (UnityEngine.Object)null && (UnityEngine.Object)((_003CDoLoad_003Ec__Iterator26C)/*Error near IL_2294: stateMachine*/)._003Cplayer_003E__0.cachedBulletDataTable.Get(key) == (UnityEngine.Object)null)
						{
							((_003CDoLoad_003Ec__Iterator26C)/*Error near IL_2294: stateMachine*/)._003Cplayer_003E__0.cachedBulletDataTable.Add(key, bulletData);
							((_003CDoLoad_003Ec__Iterator26C)/*Error near IL_2294: stateMachine*/)._003Cload_queue_003E__21.CacheBulletDataUseResource(bulletData, ((_003CDoLoad_003Ec__Iterator26C)/*Error near IL_2294: stateMachine*/)._003Cplayer_003E__0);
						}
					}
				});
			...
			if (lo_arm != null && lo_arm.loadedObject != (UnityEngine.Object)null)
			{
				GameObject loadObj2 = lo_arm.loadedObject as GameObject;
				EffectPlayProcessor loadEffect2 = (!((UnityEngine.Object)loadObj2 != (UnityEngine.Object)null)) ? null : loadObj2.GetComponent<EffectPlayProcessor>();
				if ((UnityEngine.Object)loadEffect2 != (UnityEngine.Object)null && loadEffect2.effectSettings != null)
				{
					int i4 = 0;
			...
			if (lo_leg != null && lo_leg.loadedObject != (UnityEngine.Object)null)
			{
				GameObject loadObj = lo_leg.loadedObject as GameObject;
				EffectPlayProcessor loadEffect = (!((UnityEngine.Object)loadObj != (UnityEngine.Object)null)) ? null : loadObj.GetComponent<EffectPlayProcessor>();
				if ((UnityEngine.Object)loadEffect != (UnityEngine.Object)null && loadEffect.effectSettings != null)
				{
					int i3 = 0;
			...
			else
			{
				...
				{
					((_003CDoLoad_003Ec__Iterator26C)/*Error near IL_25c8: stateMachine*/)._003C_003Ef__this.body = ((GameObject)data.instantiatedObject).transform;
					((_003CDoLoad_003Ec__Iterator26C)/*Error near IL_25c8: stateMachine*/)._003C_003Ef__this.body.SetParent(((_003CDoLoad_003Ec__Iterator26C)/*Error near IL_25c8: stateMachine*/)._003C_this_003E__20, false);
					((_003CDoLoad_003Ec__Iterator26C)/*Error near IL_25c8: stateMachine*/)._003C_003Ef__this.renderersBody = ((_003CDoLoad_003Ec__Iterator26C)/*Error near IL_25c8: stateMachine*/)._003C_003Ef__this.body.GetComponentsInChildren<Renderer>();
					((_003CDoLoad_003Ec__Iterator26C)/*Error near IL_25c8: stateMachine*/)._003C_003Ef__this.SetDynamicBones_Body(((_003CDoLoad_003Ec__Iterator26C)/*Error near IL_25c8: stateMachine*/)._003C_003Ef__this.body, ((_003CDoLoad_003Ec__Iterator26C)/*Error near IL_25c8: stateMachine*/)._003CenableBone_003E__1);
					SetRenderersEnabled(((_003CDoLoad_003Ec__Iterator26C)/*Error near IL_25c8: stateMachine*/)._003C_003Ef__this.renderersBody, false);
					((_003CDoLoad_003Ec__Iterator26C)/*Error near IL_25c8: stateMachine*/)._003Cwait_003E__108 = false;
				}, false);
				while (wait8)
				{
			...
			{
				yield return (object)StartCoroutine(ItemLoader.InitRoopEffect(load_queue, body, shader_type));
				if (renderersBody != null)
				{
					if (renderersBody.Length > 0)
					{
						SkinnedMeshRenderer body_skin = renderersBody[0] as SkinnedMeshRenderer;
						if ((UnityEngine.Object)body_skin != (UnityEngine.Object)null)
						{
							body_skin.localBounds = BOUNDS;
						}
					}
					...
					if (need_foot_stamp)
					{
						if ((UnityEngine.Object)socketFootL != (UnityEngine.Object)null && (UnityEngine.Object)socketFootL.GetComponent<StampNode>() == (UnityEngine.Object)null)
						{
							StampNode node2 = socketFootL.gameObject.AddComponent<StampNode>();
							node2.offset = new Vector3(-0.08f, 0.01f, 0f);
							node2.autoBaseY = 0.1f;
						}
						if ((UnityEngine.Object)socketFootR != (UnityEngine.Object)null && (UnityEngine.Object)socketFootR.GetComponent<StampNode>() == (UnityEngine.Object)null)
						{
							StampNode node = socketFootR.gameObject.AddComponent<StampNode>();
							node.offset = new Vector3(-0.08f, 0.01f, 0f);
							node.autoBaseY = 0.1f;
						}
						CharacterStampCtrl step_ctrl = body.GetComponent<CharacterStampCtrl>();
						if ((UnityEngine.Object)step_ctrl == (UnityEngine.Object)null)
						{
							step_ctrl = body.gameObject.AddComponent<CharacterStampCtrl>();
						}
					...
					if (lo_face != null)
					{
						...
						else
						{
							...
							{
								((_003CDoLoad_003Ec__Iterator26C)/*Error near IL_2a74: stateMachine*/)._003C_003Ef__this.face = ((GameObject)data.instantiatedObject).transform;
								((_003CDoLoad_003Ec__Iterator26C)/*Error near IL_2a74: stateMachine*/)._003C_003Ef__this.face.SetParent(((_003CDoLoad_003Ec__Iterator26C)/*Error near IL_2a74: stateMachine*/)._003C_003Ef__this.socketHead, false);
								((_003CDoLoad_003Ec__Iterator26C)/*Error near IL_2a74: stateMachine*/)._003C_003Ef__this.renderersFace = ((_003CDoLoad_003Ec__Iterator26C)/*Error near IL_2a74: stateMachine*/)._003C_003Ef__this.face.GetComponentsInChildren<Renderer>();
								SetRenderersEnabled(((_003CDoLoad_003Ec__Iterator26C)/*Error near IL_2a74: stateMachine*/)._003C_003Ef__this.renderersFace, false);
								((_003CDoLoad_003Ec__Iterator26C)/*Error near IL_2a74: stateMachine*/)._003Cwait_003E__108 = false;
							}, false);
							while (wait8)
							{
								yield return (object)null;
					...
					if (lo_hair != null)
					{
						...
						else
						{
							...
							{
								((_003CDoLoad_003Ec__Iterator26C)/*Error near IL_2bde: stateMachine*/)._003C_003Ef__this.hair = ((GameObject)data.instantiatedObject).transform;
								((_003CDoLoad_003Ec__Iterator26C)/*Error near IL_2bde: stateMachine*/)._003C_003Ef__this.hair.SetParent(((_003CDoLoad_003Ec__Iterator26C)/*Error near IL_2bde: stateMachine*/)._003C_003Ef__this.socketHead, false);
								((_003CDoLoad_003Ec__Iterator26C)/*Error near IL_2bde: stateMachine*/)._003C_003Ef__this.renderersHair = ((_003CDoLoad_003Ec__Iterator26C)/*Error near IL_2bde: stateMachine*/)._003C_003Ef__this.hair.GetComponentsInChildren<Renderer>();
								((_003CDoLoad_003Ec__Iterator26C)/*Error near IL_2bde: stateMachine*/)._003C_003Ef__this.SetDynamicBones(((_003CDoLoad_003Ec__Iterator26C)/*Error near IL_2bde: stateMachine*/)._003C_003Ef__this.body, ((_003CDoLoad_003Ec__Iterator26C)/*Error near IL_2bde: stateMachine*/)._003C_003Ef__this.hair, ((_003CDoLoad_003Ec__Iterator26C)/*Error near IL_2bde: stateMachine*/)._003CenableBone_003E__1);
								SetRenderersEnabled(((_003CDoLoad_003Ec__Iterator26C)/*Error near IL_2bde: stateMachine*/)._003C_003Ef__this.renderersHair, false);
								((_003CDoLoad_003Ec__Iterator26C)/*Error near IL_2bde: stateMachine*/)._003Cwait_003E__108 = false;
							}, false);
							while (wait8)
							{
								yield return (object)null;
					...
					if (lo_head != null)
					{
						if (!div_frame_realizes)
						{
							...
							if ((UnityEngine.Object)head != (UnityEngine.Object)null)
							{
						...
						else
						{
							...
							{
								((_003CDoLoad_003Ec__Iterator26C)/*Error near IL_2d07: stateMachine*/)._003C_003Ef__this.head = ((GameObject)data.instantiatedObject).transform;
								((_003CDoLoad_003Ec__Iterator26C)/*Error near IL_2d07: stateMachine*/)._003C_003Ef__this.head.SetParent(((_003CDoLoad_003Ec__Iterator26C)/*Error near IL_2d07: stateMachine*/)._003C_003Ef__this.socketHead, false);
								((_003CDoLoad_003Ec__Iterator26C)/*Error near IL_2d07: stateMachine*/)._003C_003Ef__this.renderersHead = ((_003CDoLoad_003Ec__Iterator26C)/*Error near IL_2d07: stateMachine*/)._003C_003Ef__this.head.GetComponentsInChildren<Renderer>();
								SetRenderersEnabled(((_003CDoLoad_003Ec__Iterator26C)/*Error near IL_2d07: stateMachine*/)._003C_003Ef__this.renderersHead, false);
								((_003CDoLoad_003Ec__Iterator26C)/*Error near IL_2d07: stateMachine*/)._003Cwait_003E__108 = false;
							}, false);
							while (wait8)
							{
								yield return (object)null;
						...
						if ((UnityEngine.Object)head != (UnityEngine.Object)null)
						{
							yield return (object)StartCoroutine(ItemLoader.InitRoopEffect(load_queue, head, shader_type));
						}
					...
					if (renderersBody != null)
					{
						if (lo_arm != null)
						{
							...
							{
								arm = AddSkin(lo_arm);
								if ((UnityEngine.Object)arm != (UnityEngine.Object)null)
								{
							...
							else
							{
								...
								{
									((_003CDoLoad_003Ec__Iterator26C)/*Error near IL_2e79: stateMachine*/)._003C_003Ef__this.arm = ((GameObject)data.instantiatedObject).transform;
									((_003CDoLoad_003Ec__Iterator26C)/*Error near IL_2e79: stateMachine*/)._003C_003Ef__this.arm = ((_003CDoLoad_003Ec__Iterator26C)/*Error near IL_2e79: stateMachine*/)._003C_003Ef__this.AddSkin(((_003CDoLoad_003Ec__Iterator26C)/*Error near IL_2e79: stateMachine*/)._003C_003Ef__this.arm);
									((_003CDoLoad_003Ec__Iterator26C)/*Error near IL_2e79: stateMachine*/)._003C_003Ef__this.renderersArm = ((_003CDoLoad_003Ec__Iterator26C)/*Error near IL_2e79: stateMachine*/)._003C_003Ef__this.arm.GetComponentsInChildren<Renderer>();
									SetRenderersEnabled(((_003CDoLoad_003Ec__Iterator26C)/*Error near IL_2e79: stateMachine*/)._003C_003Ef__this.renderersArm, false);
									((_003CDoLoad_003Ec__Iterator26C)/*Error near IL_2e79: stateMachine*/)._003Cwait_003E__108 = false;
								}, false);
								while (wait8)
								{
									yield return (object)null;
						...
						if (renderersBody != null)
						{
							if (lo_leg != null)
							{
								...
								{
									leg = AddSkin(lo_leg);
									if ((UnityEngine.Object)leg != (UnityEngine.Object)null)
									{
								...
								else
								{
									...
									{
										((_003CDoLoad_003Ec__Iterator26C)/*Error near IL_2fd8: stateMachine*/)._003C_003Ef__this.leg = ((GameObject)data.instantiatedObject).transform;
										((_003CDoLoad_003Ec__Iterator26C)/*Error near IL_2fd8: stateMachine*/)._003C_003Ef__this.leg = ((_003CDoLoad_003Ec__Iterator26C)/*Error near IL_2fd8: stateMachine*/)._003C_003Ef__this.AddSkin(((_003CDoLoad_003Ec__Iterator26C)/*Error near IL_2fd8: stateMachine*/)._003C_003Ef__this.leg);
										((_003CDoLoad_003Ec__Iterator26C)/*Error near IL_2fd8: stateMachine*/)._003C_003Ef__this.renderersLeg = ((_003CDoLoad_003Ec__Iterator26C)/*Error near IL_2fd8: stateMachine*/)._003C_003Ef__this.leg.GetComponentsInChildren<Renderer>();
										SetRenderersEnabled(((_003CDoLoad_003Ec__Iterator26C)/*Error near IL_2fd8: stateMachine*/)._003C_003Ef__this.renderersLeg, false);
										((_003CDoLoad_003Ec__Iterator26C)/*Error near IL_2fd8: stateMachine*/)._003Cwait_003E__108 = false;
									}, false);
									while (wait8)
									{
										yield return (object)null;
							...
							if (lo_wepn != null)
							{
								...
								else
								{
									...
									{
										((_003CDoLoad_003Ec__Iterator26C)/*Error near IL_313f: stateMachine*/)._003Cweapon_003E__118 = ((GameObject)data.instantiatedObject).transform;
										((_003CDoLoad_003Ec__Iterator26C)/*Error near IL_313f: stateMachine*/)._003C_003Ef__this.renderersWep = ((_003CDoLoad_003Ec__Iterator26C)/*Error near IL_313f: stateMachine*/)._003Cweapon_003E__118.GetComponentsInChildren<Renderer>();
										SetRenderersEnabled(((_003CDoLoad_003Ec__Iterator26C)/*Error near IL_313f: stateMachine*/)._003C_003Ef__this.renderersWep, false);
										((_003CDoLoad_003Ec__Iterator26C)/*Error near IL_313f: stateMachine*/)._003Cwait_003E__108 = false;
									}, false);
									while (wait8)
									{
										yield return (object)null;
								...
								if ((UnityEngine.Object)weapon != (UnityEngine.Object)null)
								{
									...
									yield return (object)StartCoroutine(ItemLoader.InitRoopEffect(load_queue, weapon, shader_type));
								}
								if (renderersBody == null)
								{
									yield break;
								...
								if (renderersWep != null)
								{
									...
									{
										if (renderersWep[m].name.EndsWith("_L"))
										{
											materialL = renderersWep[m].material;
											wepL = renderersWep[m].transform;
										...
										{
											materialR = renderersWep[m].material;
											wepR = renderersWep[m].transform;
							...
							if ((UnityEngine.Object)animator != (UnityEngine.Object)null && lo_anim != null)
							{
								RuntimeAnimatorController anim_ctrl = lo_anim.loadedObjects[0].obj as RuntimeAnimatorController;
								if ((UnityEngine.Object)anim_ctrl != (UnityEngine.Object)null)
								{
									...
									if (MonoBehaviourSingleton<OutGameSettingsManager>.IsValid() && MonoBehaviourSingleton<OutGameSettingsManager>.I.statusScene.isPlaySpAttackTypeMotion)
									{
										...
										if (spType != 0)
										{
											...
											int plen = animator.parameterCount;
							...
							if (!lo_accessories.IsNullOrEmpty())
							{
								...
								for (int alen = lo_accessories.Count; aidx < alen; aidx++)
								{
									...
									else
									{
										...
										{
											((_003CDoLoad_003Ec__Iterator26C)/*Error near IL_36ea: stateMachine*/)._003CaccTrans_003E__133 = ((GameObject)data.instantiatedObject).transform;
											((_003CDoLoad_003Ec__Iterator26C)/*Error near IL_36ea: stateMachine*/)._003Cwait_003E__108 = false;
										}, false);
										while (wait8)
										{
											yield return (object)null;
									...
									if ((UnityEngine.Object)accTrans != (UnityEngine.Object)null)
									{
										...
										accTrans.localPosition = ainfo.offset;
										accTrans.localRotation = ainfo.rotation;
										accTrans.localScale = ainfo.scale;
							...
							if (need_shadow && (UnityEngine.Object)shadow == (UnityEngine.Object)null)
							{
							...
							if ((UnityEngine.Object)player != (UnityEngine.Object)null && is_self && MonoBehaviourSingleton<AudioListenerManager>.IsValid())
							{
							...
							if (is_self)
							{
								ResourceLoad loaded = player.gameObject.GetComponent<ResourceLoad>();
								if ((UnityEngine.Object)loaded != (UnityEngine.Object)null && loaded.list != null)
								{
	...
	private IEnumerator LoadNextBulletInfo(LoadingQueue loadQueue, string infoName, List<AttackInfo> hitInfos)
	{
		if (!playerLoaderLoadedAttackInfoNames.Contains(infoName))
		{
			...
			GameObject infoObj = loadObj.Realizes(MonoBehaviourSingleton<InGameSettingsManager>.I._transform, -1).gameObject;
			SplitPlayerAttackInfo attackInfo = infoObj.GetComponent<SplitPlayerAttackInfo>();
			hitInfos.Add(attackInfo.attackHitInfo);
			if (!string.IsNullOrEmpty(attackInfo.attackHitInfo.nextBulletInfoName))
			{
				yield return (object)StartCoroutine(LoadNextBulletInfo(loadQueue, attackInfo.attackHitInfo.nextBulletInfoName, hitInfos));
			}
		}
	}
	...
	{
		if ((UnityEngine.Object)wepR != (UnityEngine.Object)null)
		{
			UnityEngine.Object.DestroyImmediate(wepR.gameObject);
		}
		if ((UnityEngine.Object)wepL != (UnityEngine.Object)null)
		{
	...
	public void SetDynamicBones_Body(Transform body, bool isEnable)
	{
		if (!isEnable)
		{
			...
			body.GetComponentsInChildren(true, dynamicBones_Body);
	...
	public void SetDynamicBones(Transform body, Transform hair, bool isEnable)
	{
		...
		dynamicBones.Clear();
		hair.GetComponentsInChildren(true, dynamicBones);
		if (dynamicBones.Count > 0)
		{
			if (isEnable)
			{
				Transform transform = Utility.Find(body, "Neck");
				DynamicBoneCollider dynamicBoneCollider = transform.gameObject.AddComponent<DynamicBoneCollider>();
				...
				DynamicBoneCollider dynamicBoneCollider2 = transform2.gameObject.AddComponent<DynamicBoneCollider>();
	...
	public void ResetDynamicBones(List<DynamicBone> list)
	{
		if (list != null)
		{
			...
			for (int count = list.Count; i < count; i++)
			{
				...
				if ((UnityEngine.Object)dynamicBone != (UnityEngine.Object)null && dynamicBone.enabled)
				{
	...
	{
		if (lo.loadedObject == (UnityEngine.Object)null)
		{
			return null;
		}
	...
	public static Transform AddSkin(Transform base_model, SkinnedMeshRenderer body_skin_renderer, int layer = -1)
	{
		...
		if ((UnityEngine.Object)body_skin_renderer != (UnityEngine.Object)null && (UnityEngine.Object)componentInChildren != (UnityEngine.Object)null)
		{
			...
			if ((UnityEngine.Object)componentInChildren.rootBone != (UnityEngine.Object)null)
			{
				...
				{
					EffectPlayProcessor effectPlayProcessor = skinnedMeshRenderer.rootBone.gameObject.AddComponent<EffectPlayProcessor>();
	...
	{
		if (level != 0 && !((UnityEngine.Object)body_skin_renderer == (UnityEngine.Object)null))
		{
	...
	public static void SetLightProbes(Renderer[] renderers, bool enable_light_probes)
	{
		if (renderers != null)
		{
			...
			for (int num = renderers.Length; i < num; i++)
			{
				renderers[i].useLightProbes = enable_light_probes;
			}
		}
	}
	...
	public static void SetWeaponShader(Renderer[] renderers, Color color0, Color color1, Color color2, int effectID, float effectParam, Color effectColor)
	{
		...
		Utility.MaterialForEach(renderers, delegate(Material mtrl)
		{
			...
			if ((UnityEngine.Object)shader != (UnityEngine.Object)null && (UnityEngine.Object)mtrl.shader != (UnityEngine.Object)shader)
			{
				mtrl.shader = shader;
			}
	...
	{
		if (lo_high_reso_texs != null && flags != 0 && (!((UnityEngine.Object)mate0 == (UnityEngine.Object)null) || !((UnityEngine.Object)mate1 == (UnityEngine.Object)null)))
		{
			int num = 1;
			int num2 = 0;
			...
			while (flags != 0)
			{
				if ((flags & num) != 0)
				{
					...
					default:
					{
						...
						{
							if (flag && (UnityEngine.Object)mate0 != (UnityEngine.Object)null)
							{
								mate0.SetTexture(nameID, texture);
							}
							if (flag2 && (UnityEngine.Object)mate1 != (UnityEngine.Object)null)
							{
	...
	public static bool IsLoading(PlayerLoader[] loaders)
	{
		if (loaders != null)
		{
			...
			{
				if ((UnityEngine.Object)loaders[i] != (UnityEngine.Object)null && loaders[i].isLoading)
				{
					return true;
				}
			}
	...
	public static void DestroyModels(PlayerLoader[] loaders)
	{
		...
		for (int num = loaders.Length; i < num; i++)
		{
			if ((UnityEngine.Object)loaders[i] != (UnityEngine.Object)null)
			{
	...
	public Transform GetAccessoryModel(string name)
	{
		...
		for (int i = 0; i < accessory.Count; i++)
		{
			...
			if (!((UnityEngine.Object)transform == (UnityEngine.Object)null) && transform.name == name)
			{
				return transform;
			}
		}
	...
	public void DeleteAccessoryModel(string name)
	{
		if (!accessory.IsNullOrEmpty())
		{
			...
			{
				if (!((UnityEngine.Object)accessory[j] == (UnityEngine.Object)null))
				{
