...
namespace GooglePlayGames.Native.PInvoke
{
	internal static class Callbacks
	{
		...
		{
			_003CToIntPtr_003Ec__AnonStorey883<T, P> _003CToIntPtr_003Ec__AnonStorey;
		...
		internal unsafe static Action<T> AsOnGameThreadCallback<T>(Action<T> toInvokeOnGameThread)
		{
			return delegate
			{
				...
				{
					_003CAsOnGameThreadCallback_003Ec__AnonStorey884<T>._003CAsOnGameThreadCallback_003Ec__AnonStorey885 _003CAsOnGameThreadCallback_003Ec__AnonStorey;
		...
		{
			_003CAsOnGameThreadCallback_003Ec__AnonStorey886<T1, T2> _003CAsOnGameThreadCallback_003Ec__AnonStorey;
