...
public class UIDrawCall : MonoBehaviour
{
	...
	public int renderQueue
	{
		...
		set
		{
			...
			{
				mRenderQueue = value;
				if ((UnityEngine.Object)mDynamicMat != (UnityEngine.Object)null)
				{
	...
	public int sortingOrder
	{
		get
		{
			return ((UnityEngine.Object)mRenderer != (UnityEngine.Object)null) ? mRenderer.sortingOrder : 0;
		}
		set
		{
			if ((UnityEngine.Object)mRenderer != (UnityEngine.Object)null && mRenderer.sortingOrder != value)
			{
	...
	public int finalRenderQueue => (!((UnityEngine.Object)mDynamicMat != (UnityEngine.Object)null)) ? mRenderQueue : mDynamicMat.renderQueue;
	...
	public int triangles => ((UnityEngine.Object)mMesh != (UnityEngine.Object)null) ? mTriangles : 0;
	...
	private void CreateMaterial()
	{
		...
		string text = ((UnityEngine.Object)mShader != (UnityEngine.Object)null) ? mShader.name : ((!((UnityEngine.Object)mMaterial != (UnityEngine.Object)null)) ? "Unlit/Transparent Colored" : mMaterial.shader.name);
		...
		else if (mClipCount != 0)
		{
			...
			if ((UnityEngine.Object)shader == (UnityEngine.Object)null && mClipCount == 1)
			{
				mLegacyShader = true;
		...
		if ((UnityEngine.Object)mMaterial != (UnityEngine.Object)null && mMaterial.shader.isSupported)
		{
	...
	private Material RebuildMaterial()
	{
		...
		if ((UnityEngine.Object)mRenderer != (UnityEngine.Object)null)
		{
	...
	{
		if (mRebuildMat || (UnityEngine.Object)mDynamicMat == (UnityEngine.Object)null || mClipCount != panel.clipCount || mTextureClip != (panel.clipping == Clipping.TextureMask))
		{
			RebuildMaterial();
			mRebuildMat = false;
		}
		else if ((UnityEngine.Object)mRenderer.sharedMaterial != (UnityEngine.Object)mDynamicMat)
		{
			mRenderer.sharedMaterials = new Material[1]
			{
				mDynamicMat
	...
	public void UpdateGeometry(int widgetCount)
	{
		...
		{
			if ((UnityEngine.Object)mFilter == (UnityEngine.Object)null)
			{
			...
			if (verts.size < 65000)
			{
				...
				if ((UnityEngine.Object)mMesh == (UnityEngine.Object)null)
				{
					mMesh = new Mesh();
					mMesh.hideFlags = HideFlags.DontSave;
					mMesh.name = ((!((UnityEngine.Object)mMaterial != (UnityEngine.Object)null)) ? "[NGUI] Mesh" : ("[NGUI] " + mMaterial.name));
					mMesh.MarkDynamic();
					flag = true;
				}
				...
				{
					flag2 = ((UnityEngine.Object)mMesh == (UnityEngine.Object)null || mMesh.vertexCount != verts.buffer.Length);
				}
			...
			{
				mTriangles = 0;
				if ((UnityEngine.Object)mFilter.mesh != (UnityEngine.Object)null)
				{
					mFilter.mesh.Clear();
				}
	...
	private void OnWillRenderObject()
	{
		...
		if (!((UnityEngine.Object)mDynamicMat == (UnityEngine.Object)null) && mClipCount != 0)
		{
			if (mTextureClip)
			{
			...
			else if (!mLegacyShader)
			{
				...
				int num = 0;
				while ((UnityEngine.Object)parentPanel != (UnityEngine.Object)null)
				{
					if (parentPanel.hasClipping)
					{
						float angle = 0f;
						Vector4 drawCallClipRange2 = parentPanel.drawCallClipRange;
						if ((UnityEngine.Object)parentPanel != (UnityEngine.Object)panel)
						{
	...
	public static int Count(UIPanel panel)
	{
		...
		{
			if ((UnityEngine.Object)mActiveList[i].manager == (UnityEngine.Object)panel)
			{
				num++;
			}
		}
