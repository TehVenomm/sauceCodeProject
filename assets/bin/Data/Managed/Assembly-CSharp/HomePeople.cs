...
public class HomePeople
{
	...
	private IEnumerator GetHomePlayerCharacterList()
	{
		...
		{
			((_003CGetHomePlayerCharacterList_003Ec__IteratorA1)/*Error near IL_002d: stateMachine*/)._003Cwait_003E__0 = false;
		});
		while (wait)
		{
	...
	private IEnumerator LoadLoungeWayPoint(string wayPointName)
	{
		...
		Utility.ForEach(wayPoints, delegate(Transform o)
		{
			...
			{
				((_003CLoadLoungeWayPoint_003Ec__IteratorA4)/*Error near IL_00af: stateMachine*/)._003C_003Ef__this.centerPoint = o.GetComponent<WayPoint>();
			}
			return false;
		});
	}
