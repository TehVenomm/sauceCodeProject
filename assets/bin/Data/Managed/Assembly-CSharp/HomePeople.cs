...
public class HomePeople
{
	...
	private IEnumerator GetHomePlayerCharacterList()
	{
		...
		{
			((_003CGetHomePlayerCharacterList_003Ec__IteratorB2)/*Error near IL_002d: stateMachine*/)._003Cwait_003E__0 = false;
		});
		while (wait)
		{
	...
	private IEnumerator LoadPeopleWayPoint()
	{
		...
		Utility.ForEach(wayPoints, delegate(Transform o)
		{
			...
			{
				((_003CLoadPeopleWayPoint_003Ec__IteratorB4)/*Error near IL_00ba: stateMachine*/)._003C_003Ef__this.leafPoints.Add(o.GetComponent<WayPoint>());
			}
			else if (o.get_name() == "CENTER")
			{
				((_003CLoadPeopleWayPoint_003Ec__IteratorB4)/*Error near IL_00ba: stateMachine*/)._003C_003Ef__this.centerPoint = o.GetComponent<WayPoint>();
			}
			return false;
		});
	}
	...
	private IEnumerator LoadLoungeWayPoint(string wayPointName)
	{
		...
		Utility.ForEach(wayPoints, delegate(Transform o)
		{
			...
			{
				((_003CLoadLoungeWayPoint_003Ec__IteratorB5)/*Error near IL_00af: stateMachine*/)._003C_003Ef__this.centerPoint = o.GetComponent<WayPoint>();
			}
			return false;
		});
	}
