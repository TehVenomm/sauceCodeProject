...
public class FieldPortalGimmickObject : FieldGimmickObject
{
	...
	public override void Initialize(FieldMapTable.FieldGimmickPointTableData pointData)
	{
		...
		PortalObject.VIEW_TYPE vIEW_TYPE = (PortalObject.VIEW_TYPE)Enum.ToObject(typeof(PortalObject.VIEW_TYPE), portalId);
		EffectManager.GetEffect(MonoBehaviourSingleton<InGameSettingsManager>.I.portal.effectNames[(int)vIEW_TYPE], _transform);
	}
	...
	protected override void ParseParam(string value2)
	{
		...
		for (int i = 0; i < array.Length; i++)
		{
			...
			case "r":
				...
				break;
			case "portalId":
				int.TryParse(array2[1], out portalId);
				break;
			case "portalScale":
				float.TryParse(array2[1], out portalScale);
				break;
			}
		}
	}
	...
	public void StartReadStory()
	{
		...
		{
			num = subStoryIds[UnityEngine.Random.Range(0, subStoryIds.Count)];
			isSend = false;
		}
		if (num != 0)
		{
