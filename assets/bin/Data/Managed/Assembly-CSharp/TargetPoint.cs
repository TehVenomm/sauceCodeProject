...
public class TargetPoint : MonoBehaviour
{
	...
	public void scaledCalc()
	{
		...
		scaledMarkerZShift = markerZShift * _transform.lossyScale.z;
	}
	...
	public Quaternion GetArrowBleedLocalRotation(int show_index = 0)
	{
		...
		quaternion *= Quaternion.Euler(bleedOffsetRot.x, bleedOffsetRot.y, bleedOffsetRot.z);
		if (show_index > 0 && MonoBehaviourSingleton<InGameSettingsManager>.IsValid())
		{
			...
			if (arrowBleedOther != null)
			{
				...
				quaternion = quaternion * rhs * rhs2;
			}
		}
		return quaternion;
	}
