...
public class FriendArenaRankingLegend : FriendArenaRankingBase
{
	...
	protected unsafe override void UpdateDynamicList()
	{
		...
		SetDynamicList((Enum)UI.GRD_LIST, GetListItemName, item_num, false, null, null, new Action<int, Transform, bool>((object)_003CUpdateDynamicList_003Ec__AnonStorey31E, (IntPtr)(void*)/*OpCode not supported: LdFtn*/));
	}
	...
	protected unsafe override void SendGetList(int page, Action<bool> callback)
	{
		...
		MonoBehaviourSingleton<FriendManager>.I.SendGetLegendRanking(new Action<bool, List<ArenaLegendRankingModel.Param>>((object)_003CSendGetList_003Ec__AnonStorey31F, (IntPtr)(void*)/*OpCode not supported: LdFtn*/));
	}
