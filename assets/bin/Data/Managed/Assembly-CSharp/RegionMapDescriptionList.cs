...
public class RegionMapDescriptionList : GameSection
{
	...
	protected unsafe void UpdateTable()
	{
		...
		_003CUpdateTable_003Ec__AnonStorey4B0 _003CUpdateTable_003Ec__AnonStorey4B;
		SetTable(UI.TBL_ALL, string.Empty, num2, true, new Func<int, Transform, Transform>((object)_003CUpdateTable_003Ec__AnonStorey4B, (IntPtr)(void*)/*OpCode not supported: LdFtn*/), new Action<int, Transform, bool>((object)_003CUpdateTable_003Ec__AnonStorey4B, (IntPtr)(void*)/*OpCode not supported: LdFtn*/));
	}
	...
	private unsafe List<DeliveryDataAndUId> CreateDeliveryList(uint mapId)
	{
		...
		for (int num = deliveryList.Length; i < num; i++)
		{
			...
			_003CCreateDeliveryList_003Ec__AnonStorey4B1 _003CCreateDeliveryList_003Ec__AnonStorey4B;
			if (IsExistTargetEnemy(deliveryTableData, mapId) && (!deliveryTableData.IsEvent() || !MonoBehaviourSingleton<QuestManager>.I.bingoEventList.Any(new Func<Network.EventData, bool>((object)_003CCreateDeliveryList_003Ec__AnonStorey4B, (IntPtr)(void*)/*OpCode not supported: LdFtn*/))))
			{
	...
	private unsafe void SendDeliveryComplete(DeliveryTable.DeliveryData deliveryData, string deliveryUniqueId, bool is_enough_material)
	{
		...
		_003CSendDeliveryComplete_003Ec__AnonStorey4B3 _003CSendDeliveryComplete_003Ec__AnonStorey4B;
		MonoBehaviourSingleton<DeliveryManager>.I.SendDeliveryComplete(deliveryUniqueId, enable_clear_event, new Action<bool, DeliveryRewardList>((object)_003CSendDeliveryComplete_003Ec__AnonStorey4B, (IntPtr)(void*)/*OpCode not supported: LdFtn*/));
	}
