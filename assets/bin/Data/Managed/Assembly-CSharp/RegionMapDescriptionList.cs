...
public class RegionMapDescriptionList : GameSection
{
	...
	protected unsafe void UpdateTable()
	{
		...
		_003CUpdateTable_003Ec__AnonStorey4BA _003CUpdateTable_003Ec__AnonStorey4BA;
		SetTable(UI.TBL_ALL, string.Empty, num2, true, new Func<int, Transform, Transform>((object)_003CUpdateTable_003Ec__AnonStorey4BA, (IntPtr)(void*)/*OpCode not supported: LdFtn*/), new Action<int, Transform, bool>((object)_003CUpdateTable_003Ec__AnonStorey4BA, (IntPtr)(void*)/*OpCode not supported: LdFtn*/));
	}
	...
	private unsafe List<DeliveryDataAndUId> CreateDeliveryList(uint mapId)
	{
		...
		for (int num = deliveryList.Length; i < num; i++)
		{
			...
			_003CCreateDeliveryList_003Ec__AnonStorey4BB _003CCreateDeliveryList_003Ec__AnonStorey4BB;
			if (IsExistTargetEnemy(deliveryTableData, mapId) && (!deliveryTableData.IsEvent() || !MonoBehaviourSingleton<QuestManager>.I.bingoEventList.Any(new Func<Network.EventData, bool>((object)_003CCreateDeliveryList_003Ec__AnonStorey4BB, (IntPtr)(void*)/*OpCode not supported: LdFtn*/))))
			{
	...
	private unsafe void SendDeliveryComplete(DeliveryTable.DeliveryData deliveryData, string deliveryUniqueId, bool is_enough_material)
	{
		...
		_003CSendDeliveryComplete_003Ec__AnonStorey4BD _003CSendDeliveryComplete_003Ec__AnonStorey4BD;
		MonoBehaviourSingleton<DeliveryManager>.I.SendDeliveryComplete(deliveryUniqueId, enable_clear_event, new Action<bool, DeliveryRewardList>((object)_003CSendDeliveryComplete_003Ec__AnonStorey4BD, (IntPtr)(void*)/*OpCode not supported: LdFtn*/));
	}
