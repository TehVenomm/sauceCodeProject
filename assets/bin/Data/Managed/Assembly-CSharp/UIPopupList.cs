...
public class UIPopupList : UIWidgetContainer
{
	...
	public void Show()
	{
		if (base.enabled && NGUITools.GetActive(base.gameObject) && mChild == null && atlas != null && isValid && items.Count > 0)
		{
			...
			a = Mathf.Max(a, v.x - vector.x - (border.x + padding.x) * 2f);
			float num5 = a;
			Vector3 vector2 = new Vector3(num5 * 0.5f, (0f - num3) * 0.5f, 0f);
			Vector3 vector3 = new Vector3(num5, num3 + padding.y, 1f);
			int j = 0;
