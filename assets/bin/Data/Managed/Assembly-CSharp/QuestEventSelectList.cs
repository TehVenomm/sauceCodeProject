...
public class QuestEventSelectList : QuestSpecialSelect
{
	...
	protected unsafe virtual void UpdateTable()
	{
		...
		else
		{
			...
			_003CUpdateTable_003Ec__AnonStorey3BE _003CUpdateTable_003Ec__AnonStorey3BE;
			SetTable(UI.TBL_DELIVERY_QUEST, string.Empty, num2, isResetUI, new Func<int, Transform, Transform>((object)_003CUpdateTable_003Ec__AnonStorey3BE, (IntPtr)(void*)/*OpCode not supported: LdFtn*/), new Action<int, Transform, bool>((object)_003CUpdateTable_003Ec__AnonStorey3BE, (IntPtr)(void*)/*OpCode not supported: LdFtn*/));
	...
	protected unsafe virtual void UpdateGrid()
	{
		...
		else
		{
			...
			_003CUpdateGrid_003Ec__AnonStorey3BF _003CUpdateGrid_003Ec__AnonStorey3BF;
			SetDynamicList((Enum)UI.GRD_DELIVERY_QUEST, "QuestRequestItem", showList.Length, isResetUI, null, null, new Action<int, Transform, bool>((object)_003CUpdateGrid_003Ec__AnonStorey3BF, (IntPtr)(void*)/*OpCode not supported: LdFtn*/));
		}
	}
