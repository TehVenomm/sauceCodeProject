...
public class TradingPostTable : Singleton<TradingPostTable>, IDataTable
{
	...
	{
		itemTable = TableUtility.CreateUIntKeyTable<ItemData>(csv_text, ItemData.cb, "itemId,itemType,itemName,maxQuantity,cantSell,startDate,endDate");
		itemTable.TrimExcess();
	}

	public void AddTable(string csv_text)
	{
		TableUtility.AddUIntKeyTable(itemTable, csv_text, ItemData.cb, "itemId,itemType,itemName,maxQuantity,cantSell,startDate,endDate");
	}
