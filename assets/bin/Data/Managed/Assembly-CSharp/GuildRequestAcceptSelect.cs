...
public class GuildRequestAcceptSelect : QuestAcceptSelect
{
	...
	protected unsafe virtual void OnQuery_GuildRequestSortieMessage_YES()
	{
		...
		MonoBehaviourSingleton<GuildRequestManager>.I.SendGuildRequestStart(questInfo, !flag, delegate
		{
			...
			_003COnQuery_GuildRequestSortieMessage_YES_003Ec__AnonStorey36C _003COnQuery_GuildRequestSortieMessage_YES_003Ec__AnonStorey36C;
			SendGetChallengeInfo(new Action((object)_003COnQuery_GuildRequestSortieMessage_YES_003Ec__AnonStorey36C, (IntPtr)(void*)/*OpCode not supported: LdFtn*/), null);
		});
	}

	private unsafe void SendGetChallengeInfo(Action onFinish, Action<bool> cb)
	{
		_003CSendGetChallengeInfo_003Ec__AnonStorey36D _003CSendGetChallengeInfo_003Ec__AnonStorey36D;
		MonoBehaviourSingleton<PartyManager>.I.SendGetChallengeInfo(new Action<bool, Error>((object)_003CSendGetChallengeInfo_003Ec__AnonStorey36D, (IntPtr)(void*)/*OpCode not supported: LdFtn*/));
	}
}
