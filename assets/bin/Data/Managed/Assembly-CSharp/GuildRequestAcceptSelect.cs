...
public class GuildRequestAcceptSelect : QuestAcceptSelect
{
	...
	protected unsafe virtual void OnQuery_GuildRequestSortieMessage_YES()
	{
		...
		MonoBehaviourSingleton<GuildRequestManager>.I.SendGuildRequestStart(questInfo, !flag, delegate
		{
			...
			_003COnQuery_GuildRequestSortieMessage_YES_003Ec__AnonStorey35C _003COnQuery_GuildRequestSortieMessage_YES_003Ec__AnonStorey35C;
			SendGetChallengeInfo(new Action((object)_003COnQuery_GuildRequestSortieMessage_YES_003Ec__AnonStorey35C, (IntPtr)(void*)/*OpCode not supported: LdFtn*/), null);
		});
	}

	private unsafe void SendGetChallengeInfo(Action onFinish, Action<bool> cb)
	{
		_003CSendGetChallengeInfo_003Ec__AnonStorey35D _003CSendGetChallengeInfo_003Ec__AnonStorey35D;
		MonoBehaviourSingleton<PartyManager>.I.SendGetChallengeInfo(new Action<bool, Error>((object)_003CSendGetChallengeInfo_003Ec__AnonStorey35D, (IntPtr)(void*)/*OpCode not supported: LdFtn*/));
	}
}
