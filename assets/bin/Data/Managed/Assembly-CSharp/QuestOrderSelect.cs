	...
	private IEnumerator DoInitialize()
	{
		...
		if (MonoBehaviourSingleton<QuestManager>.I.needRequestOrderQuestList)
		{
			MonoBehaviourSingleton<QuestManager>.I.SendGetQuestList(delegate
			{
				...
				((_003CDoInitialize_003Ec__Iterator89)/*Error near IL_0075: stateMachine*/)._003Cis_recv_quest_003E__0 = true;
			});
			while (!is_recv_quest)
			{
		...
		if (!isQuestItemDirty)
		{
			...
			if (orderQuestList != null && orderQuestList.Count > 0)
			{
				...
				orderQuestList.ForEach(delegate(QuestData orderQuest)
				{
					...
					{
						((_003CCheckLimitQuestItem_003Ec__Iterator8A)/*Error near IL_007f: stateMachine*/)._003CparseRemainingSec_003E__3 = orderQuest.remainTimes[i];
						if (!(((_003CCheckLimitQuestItem_003Ec__Iterator8A)/*Error near IL_007f: stateMachine*/)._003CparseRemainingSec_003E__3 <= 0f) && ((_003CCheckLimitQuestItem_003Ec__Iterator8A)/*Error near IL_007f: stateMachine*/)._003CminRemainingSec_003E__1 > ((_003CCheckLimitQuestItem_003Ec__Iterator8A)/*Error near IL_007f: stateMachine*/)._003CparseRemainingSec_003E__3)
						{
							((_003CCheckLimitQuestItem_003Ec__Iterator8A)/*Error near IL_007f: stateMachine*/)._003CminRemainingSec_003E__1 = ((_003CCheckLimitQuestItem_003Ec__Iterator8A)/*Error near IL_007f: stateMachine*/)._003CparseRemainingSec_003E__3;
							((_003CCheckLimitQuestItem_003Ec__Iterator8A)/*Error near IL_007f: stateMachine*/)._003CquestData_003E__2 = orderQuest;
						}
					}
				});
