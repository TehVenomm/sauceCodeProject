...
public class CustomEmblem : GameSection
{
	...
	public void UpdateList()
	{
		...
		SetDynamicList((Enum)UI.GRD_LIST_1, "EmblemLayer1Item", infos.Length, false, (Func<int, bool>)null, (Func<int, Transform, Transform>)null, (Action<int, Transform, bool>)delegate(int i, Transform t, bool is_recycle)
		{
			SetListItem(i, t, is_recycle, infos[i]);
		});
		infos = GuildItemManager.I.GetEmblemLayer2Infos();
		SetDynamicList((Enum)UI.GRD_LIST_2, "EmblemLayer2Item", infos.Length, false, (Func<int, bool>)null, (Func<int, Transform, Transform>)null, (Action<int, Transform, bool>)delegate(int i, Transform t, bool is_recycle)
		{
			SetListItem(i, t, is_recycle, infos[i]);
		});
		infos = GuildItemManager.I.GetEmblemLayer3Infos();
		SetDynamicList((Enum)UI.GRD_LIST_3, "EmblemLayer3Item", infos.Length, false, (Func<int, bool>)null, (Func<int, Transform, Transform>)null, (Action<int, Transform, bool>)delegate(int i, Transform t, bool is_recycle)
		{
			SetListItem(i, t, is_recycle, infos[i]);
		});
	}
