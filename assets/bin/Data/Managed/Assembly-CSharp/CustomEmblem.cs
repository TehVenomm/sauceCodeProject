...
public class CustomEmblem : GameSection
{
	...
	public void UpdateList()
	{
		...
		SetDynamicList(UI.GRD_LIST_1, "EmblemLayer1Item", infos.Length, reset: false, null, null, delegate(int i, Transform t, bool is_recycle)
		{
			SetListItem(i, t, is_recycle, infos[i]);
		});
		infos = GuildItemManager.I.GetEmblemLayer2Infos();
		SetDynamicList(UI.GRD_LIST_2, "EmblemLayer2Item", infos.Length, reset: false, null, null, delegate(int i, Transform t, bool is_recycle)
		{
			SetListItem(i, t, is_recycle, infos[i]);
		});
		infos = GuildItemManager.I.GetEmblemLayer3Infos();
		SetDynamicList(UI.GRD_LIST_3, "EmblemLayer3Item", infos.Length, reset: false, null, null, delegate(int i, Transform t, bool is_recycle)
		{
			SetListItem(i, t, is_recycle, infos[i]);
		});
	}
