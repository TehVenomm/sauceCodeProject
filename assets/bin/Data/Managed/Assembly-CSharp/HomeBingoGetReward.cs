...
public class HomeBingoGetReward : GameSection
{
	...
	private unsafe void UpdateRewardIcon(DeliveryRewardTable.DeliveryRewardData[] rewards)
	{
		...
		{
			int exp = 0;
			_003CUpdateRewardIcon_003Ec__AnonStorey38F _003CUpdateRewardIcon_003Ec__AnonStorey38F;
			SetGrid(UI.GRD_REWARD, string.Empty, rewards.Length, false, new Action<int, Transform, bool>((object)_003CUpdateRewardIcon_003Ec__AnonStorey38F, (IntPtr)(void*)/*OpCode not supported: LdFtn*/));
		}
	}
