...
public class GuildDonateMaterialSelectDialog : GameSection
{
	...
	{
		if (_003CCRSendDonateRequest_003Ec__Iterator53._003C_003Ef__am_0024cacheB == null)
		{
			_003CCRSendDonateRequest_003Ec__Iterator53._003C_003Ef__am_0024cacheB = new Func<bool>((object)null, (IntPtr)(void*)/*OpCode not supported: LdFtn*/);
		}
		yield return (object)new WaitUntil(_003CCRSendDonateRequest_003Ec__Iterator53._003C_003Ef__am_0024cacheB);
		...
		MonoBehaviourSingleton<GuildManager>.I.SendDonateRequest(itemID, itemName, request, numRequest, delegate(bool success)
		{
			...
			if (success)
			{
				((_003CCRSendDonateRequest_003Ec__Iterator53)/*Error near IL_0077: stateMachine*/)._003C_003Ef__this.backSection = true;
			}
		});
	}
