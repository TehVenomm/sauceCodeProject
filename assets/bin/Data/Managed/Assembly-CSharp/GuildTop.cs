...
public class GuildTop : HomeBase
{
	...
	private IEnumerator DDoInitialize()
	{
		...
		{
			((_003CDDoInitialize_003Ec__Iterator79)/*Error near IL_002d: stateMachine*/)._003Cis_finish_003E__0 = true;
			if (success)
			{
				MonoBehaviourSingleton<ChatManager>.I.clanChat.onLeave += ((_003CDDoInitialize_003Ec__Iterator79)/*Error near IL_002d: stateMachine*/)._003C_003Ef__this._OnLeave;
			}
		});
		while (!is_finish)
		{
	...
	protected override IEnumerator SendHomeInfo()
	{
		...
		{
			((_003CSendHomeInfo_003Ec__Iterator7A)/*Error near IL_002d: stateMachine*/)._003Cis_finish_003E__0 = true;
		});
		while (!is_finish)
		{
			yield return (object)null;
