...
public class CoopStage
{
	...
	public unsafe void GoUpCharacterFromUnderGround(Enemy enemy, Action OnEndAction)
	{
		...
		_003CGoUpCharacterFromUnderGround_003Ec__AnonStorey4C6 _003CGoUpCharacterFromUnderGround_003Ec__AnonStorey4C;
		this.StartCoroutine(SimpleMoveCharacterY(enemy, -10f, StageManager.GetHeight(enemy._transform.get_position()), time, new Action((object)_003CGoUpCharacterFromUnderGround_003Ec__AnonStorey4C, (IntPtr)(void*)/*OpCode not supported: LdFtn*/)));
	}
	...
	public unsafe void GoDownCharacterToUnderGround(Enemy enemy, Action OnEndAction)
	{
		...
		_003CGoDownCharacterToUnderGround_003Ec__AnonStorey4C7 _003CGoDownCharacterToUnderGround_003Ec__AnonStorey4C;
		this.StartCoroutine(SimpleMoveCharacterY(enemy2, position.y, -10f, 3f, new Action((object)_003CGoDownCharacterToUnderGround_003Ec__AnonStorey4C, (IntPtr)(void*)/*OpCode not supported: LdFtn*/)));
	}
