		...
		if (loaded_num < load_num && cache.objectCaches != null && cache.systemCaches != null && object_cache_category != null)
		{
			...
			for (int n2 = load_num; i2 < n2; i2++)
			{
				if (load_objects[i2] == null)
				{
					...
					if (load_objects[i2] == null)
					{
						load_objects[i2] = cache.systemCaches.Find((ResourceObject o) => o.obj.get_name() == ((_003CDoLoad_003Ec__Iterator291)/*Error near IL_04da: stateMachine*/)._003Cres_name_003E__19);
					}
					if (load_objects[i2] != null)
					{
					...
					if (load_objects[i7] == null)
					{
						if (!request.internalMode && request.category != RESOURCE_CATEGORY.UI)
						{
							...
							Coroutine c = this.StartCoroutine(LoadDirect(request, sub_path + request.resourceNames[i7], delegate(Object o)
							{
								if (o != null)
								{
									((_003CDoLoad_003Ec__Iterator291)/*Error near IL_17bc: stateMachine*/)._003Cload_objects_003E__9[((_003CDoLoad_003Ec__Iterator291)/*Error near IL_17bc: stateMachine*/)._003Ci_003E__45] = ResourceObject.Get(((_003CDoLoad_003Ec__Iterator291)/*Error near IL_17bc: stateMachine*/).request.category, ((_003CDoLoad_003Ec__Iterator291)/*Error near IL_17bc: stateMachine*/).request.resourceNames[((_003CDoLoad_003Ec__Iterator291)/*Error near IL_17bc: stateMachine*/)._003Ci_003E__45], o);
								}
							}));
		...
		else
		{
			...
			for (int i = paths.Length; j < i; j++)
			{
				...
				else if (onAsyncLoadQuery.Invoke() || request.downloadOnly)
				{
					...
					{
						((_003CLoadDirect_003Ec__Iterator293)/*Error near IL_01c2: stateMachine*/).request.progressObject = progress;
					}, (Action<Object>)delegate(Object asset)
					{
						((_003CLoadDirect_003Ec__Iterator293)/*Error near IL_01ce: stateMachine*/).request.progressObject = PROGRESS_COMPLATE;
						((_003CLoadDirect_003Ec__Iterator293)/*Error near IL_01ce: stateMachine*/)._003Cload_object_003E__1 = asset;
					});
				}
				else
				{
