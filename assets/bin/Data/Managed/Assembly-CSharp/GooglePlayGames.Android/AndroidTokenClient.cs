...
namespace GooglePlayGames.Android
{
	internal class AndroidTokenClient : TokenClient
	{
		...
		public unsafe void FetchTokens(Action callback)
		{
			...
			_003CFetchTokens_003Ec__AnonStorey80A _003CFetchTokens_003Ec__AnonStorey80A;
			PlayGamesHelperObject.RunOnGameThread(new Action((object)_003CFetchTokens_003Ec__AnonStorey80A, (IntPtr)(void*)/*OpCode not supported: LdFtn*/));
		}
			...
			try
			{
				...
				try
				{
					...
					try
					{
						...
						_003CDoFetchToken_003Ec__AnonStorey80B _003CDoFetchToken_003Ec__AnonStorey80B;
						pendingResult.setResultCallback(new TokenResultCallback(new Action<int, string, string, string>((object)_003CDoFetchToken_003Ec__AnonStorey80B, (IntPtr)(void*)/*OpCode not supported: LdFtn*/)));
					}
					finally
					{
