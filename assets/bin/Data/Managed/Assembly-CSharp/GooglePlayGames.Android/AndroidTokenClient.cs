...
namespace GooglePlayGames.Android
{
	internal class AndroidTokenClient : TokenClient
	{
		...
		public unsafe void FetchTokens(Action callback)
		{
			...
			_003CFetchTokens_003Ec__AnonStorey7E4 _003CFetchTokens_003Ec__AnonStorey7E;
			PlayGamesHelperObject.RunOnGameThread(new Action((object)_003CFetchTokens_003Ec__AnonStorey7E, (IntPtr)(void*)/*OpCode not supported: LdFtn*/));
		}
			...
			try
			{
				...
				try
				{
					...
					try
					{
						...
						_003CDoFetchToken_003Ec__AnonStorey7E5 _003CDoFetchToken_003Ec__AnonStorey7E;
						pendingResult.setResultCallback(new TokenResultCallback(new Action<int, string, string, string>((object)_003CDoFetchToken_003Ec__AnonStorey7E, (IntPtr)(void*)/*OpCode not supported: LdFtn*/)));
					}
					finally
					{
