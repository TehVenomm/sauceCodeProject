...
public class TheaterMode : GameSection
{
	...
	private IEnumerator DoInitialize()
	{
		...
		{
			if (!((_003CDoInitialize_003Ec__Iterator108)/*Error near IL_00d8: stateMachine*/)._003CcheckList_003E__0.ContainsKey(data.script_id) && !((_003CDoInitialize_003Ec__Iterator108)/*Error near IL_00d8: stateMachine*/)._003CidList_003E__1.ContainsKey(data.script_id))
			{
				((_003CDoInitialize_003Ec__Iterator108)/*Error near IL_00d8: stateMachine*/)._003CcheckList_003E__0.Add(data.script_id, 0);
				((_003CDoInitialize_003Ec__Iterator108)/*Error near IL_00d8: stateMachine*/)._003CidList_003E__1.Add(data.script_id, data.story_id);
				((_003CDoInitialize_003Ec__Iterator108)/*Error near IL_00d8: stateMachine*/)._003CrevIdList_003E__2.Add(data.story_id, data.script_id);
			}
		});
		...
		if (Singleton<QuestTable>.IsValid() && MonoBehaviourSingleton<QuestManager>.IsValid())
		{
			...
			{
				if (data.storyId != 0 && ((_003CDoInitialize_003Ec__Iterator108)/*Error near IL_014e: stateMachine*/)._003CcheckList_003E__0.ContainsKey(data.storyId))
				{
					if (((_003CDoInitialize_003Ec__Iterator108)/*Error near IL_014e: stateMachine*/)._003CcheckList_003E__0[data.storyId] == 0)
					{
						((_003CDoInitialize_003Ec__Iterator108)/*Error near IL_014e: stateMachine*/)._003CcheckList_003E__0[data.storyId] = -1;
					}
					((_003CDoInitialize_003Ec__Iterator108)/*Error near IL_014e: stateMachine*/)._003CquestList_003E__3.Add(data.questID, data.storyId);
		...
		Singleton<DeliveryTable>.I.AllDeliveryData(delegate(DeliveryTable.DeliveryData data)
		{
			if (data.clearEventID != 0)
			{
				...
				if (((_003CDoInitialize_003Ec__Iterator108)/*Error near IL_0164: stateMachine*/)._003CcheckList_003E__0.ContainsKey(clearEventID))
				{
					if (((_003CDoInitialize_003Ec__Iterator108)/*Error near IL_0164: stateMachine*/)._003CcheckList_003E__0[clearEventID] == 0)
					{
						((_003CDoInitialize_003Ec__Iterator108)/*Error near IL_0164: stateMachine*/)._003CcheckList_003E__0[clearEventID] = -1;
					}
					((_003CDoInitialize_003Ec__Iterator108)/*Error near IL_0164: stateMachine*/)._003C_003Ef__this.AddDeliveryList(((_003CDoInitialize_003Ec__Iterator108)/*Error near IL_0164: stateMachine*/)._003CdeliveryList_003E__4, data.id, clearEventID);
			...
			if (data.readScriptId != 0)
			{
				...
				if (((_003CDoInitialize_003Ec__Iterator108)/*Error near IL_0164: stateMachine*/)._003CcheckList_003E__0.ContainsKey(readScriptId))
				{
					if (((_003CDoInitialize_003Ec__Iterator108)/*Error near IL_0164: stateMachine*/)._003CcheckList_003E__0[readScriptId] == 0)
					{
						((_003CDoInitialize_003Ec__Iterator108)/*Error near IL_0164: stateMachine*/)._003CcheckList_003E__0[readScriptId] = -1;
					}
					((_003CDoInitialize_003Ec__Iterator108)/*Error near IL_0164: stateMachine*/)._003C_003Ef__this.AddDeliveryList(((_003CDoInitialize_003Ec__Iterator108)/*Error near IL_0164: stateMachine*/)._003CdeliveryList_003E__4, data.id, readScriptId);
		...
		if (s_connectCache == null)
		{
			...
			Protocol.Send(TheaterModeModel.URL, send_form, delegate(TheaterModeModel ret)
			{
				...
				((_003CDoInitialize_003Ec__Iterator108)/*Error near IL_0362: stateMachine*/)._003CisEndConnection_003E__15 = true;
			}, string.Empty);
	...
	private IEnumerator InitTables()
	{
		...
		{
			if (!((_003CInitTables_003Ec__Iterator10A)/*Error near IL_00df: stateMachine*/)._003CcheckList_003E__0.ContainsKey(data.script_id) && !((_003CInitTables_003Ec__Iterator10A)/*Error near IL_00df: stateMachine*/)._003CidList_003E__1.ContainsKey(data.script_id))
			{
				((_003CInitTables_003Ec__Iterator10A)/*Error near IL_00df: stateMachine*/)._003CcheckList_003E__0.Add(data.script_id, 0);
				((_003CInitTables_003Ec__Iterator10A)/*Error near IL_00df: stateMachine*/)._003CstateList_003E__5.Add(data.script_id, data.state_id);
				((_003CInitTables_003Ec__Iterator10A)/*Error near IL_00df: stateMachine*/)._003CidList_003E__1.Add(data.script_id, data.story_id);
				((_003CInitTables_003Ec__Iterator10A)/*Error near IL_00df: stateMachine*/)._003CrevIdList_003E__2.Add(data.story_id, data.script_id);
			}
		});
	...
	private IEnumerator RequestPrologueStoryStatusAPI(Dictionary<int, int> _checkList, Dictionary<uint, List<int>> _deliveryList, Dictionary<int, uint> _idList)
	{
		if (s_connectCache == null)
		{
			...
			Protocol.Send(TheaterModeModel.URL, send_form, delegate(TheaterModeModel ret)
			{
				...
				((_003CRequestPrologueStoryStatusAPI_003Ec__Iterator10B)/*Error near IL_0212: stateMachine*/)._003CisEndConnection_003E__10 = true;
			}, string.Empty);
			while (!isEndConnection)
			{
				yield return (object)null;
